...
use ILAB\MediaCloud\Utilities\Misc\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass;
use ILAB\MediaCloud\Utilities\Misc\Symfony\Component\DependencyInjection\ContainerBuilder;
use ILAB\MediaCloud\Utilities\Misc\Symfony\Component\DependencyInjection\Definition;
use ILAB\MediaCloud\Utilities\Misc\Symfony\Component\DependencyInjection\Reference;
use ILAB\MediaCloud\Utilities\Misc\Symfony\Component\DependencyInjection\ServiceLocator;
/**
 * @author Yonel Ceruto <yonelceruto@gmail.com>
 */
class TranslatorPathsPass extends \ILAB\MediaCloud\Utilities\Misc\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    ...
    {
        if ($value instanceof \ILAB\MediaCloud\Utilities\Misc\Symfony\Component\DependencyInjection\Reference) {
            if ((string) $value === $this->translatorServiceId) {
                for ($i = $this->level - 1; $i >= 0; --$i) {
                    $class = $this->definitions[$i]->getClass();
                    if (\ILAB\MediaCloud\Utilities\Misc\Symfony\Component\DependencyInjection\ServiceLocator::class === $class) {
        ...
        if ($value instanceof \ILAB\MediaCloud\Utilities\Misc\Symfony\Component\DependencyInjection\Definition) {
    ...
    private function findControllerArguments(\ILAB\MediaCloud\Utilities\Misc\Symfony\Component\DependencyInjection\ContainerBuilder $container) : array
    {
        if ($container->hasDefinition($this->resolverServiceId)) {
            $argument = $container->getDefinition($this->resolverServiceId)->getArgument(0);
            if ($argument instanceof \ILAB\MediaCloud\Utilities\Misc\Symfony\Component\DependencyInjection\Reference) {
