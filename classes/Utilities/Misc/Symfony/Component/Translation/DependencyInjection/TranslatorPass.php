...
use ILAB\MediaCloud\Utilities\Misc\Symfony\Component\DependencyInjection\Compiler\ServiceLocatorTagPass;
...
class TranslatorPass implements \ILAB\MediaCloud\Utilities\Misc\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    ...
    public function process(\ILAB\MediaCloud\Utilities\Misc\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        foreach ($container->findTaggedServiceIds($this->loaderTag, \true) as $id => $attributes) {
            $loaderRefs[$id] = new \ILAB\MediaCloud\Utilities\Misc\Symfony\Component\DependencyInjection\Reference($id);
        ...
        $container->findDefinition($this->translatorServiceId)->replaceArgument(0, \ILAB\MediaCloud\Utilities\Misc\Symfony\Component\DependencyInjection\Compiler\ServiceLocatorTagPass::register($container, $loaderRefs))->replaceArgument(3, $loaders);
