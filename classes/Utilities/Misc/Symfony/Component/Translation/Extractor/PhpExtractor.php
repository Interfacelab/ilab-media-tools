 ...
 */
namespace ILAB\MediaCloud\Utilities\Misc\Symfony\Component\Translation\Extractor;
 ...
 */
class PhpExtractor extends \ILAB\MediaCloud\Utilities\Misc\Symfony\Component\Translation\Extractor\AbstractFileExtractor implements \ILAB\MediaCloud\Utilities\Misc\Symfony\Component\Translation\Extractor\ExtractorInterface
{
     ...
     * {@inheritdoc}
     */
    public function extract($resource, \ILAB\MediaCloud\Utilities\Misc\Symfony\Component\Translation\MessageCatalogue $catalog)
    {
        ...
        for (; $tokenIterator->valid(); $tokenIterator->next()) {
            ...
            switch ($t[0]) {
                ...
                case \T_CONSTANT_ENCAPSED_STRING:
                    if ('' === $docToken) {
                        $message .= \ILAB\MediaCloud\Utilities\Misc\Symfony\Component\Translation\Extractor\PhpStringTokenParser::parse($t[1]);
                    } else {
                        $docPart = $t[1];
                    }
                    break;
                case \T_END_HEREDOC:
                    $message .= \ILAB\MediaCloud\Utilities\Misc\Symfony\Component\Translation\Extractor\PhpStringTokenParser::parseDocString($docToken, $docPart);
                    $docToken = '';
                    $docPart = '';
                    break;
                case \T_WHITESPACE:
