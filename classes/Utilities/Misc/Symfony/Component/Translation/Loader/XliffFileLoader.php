...
class XliffFileLoader implements \ILAB\MediaCloud\Utilities\Misc\Symfony\Component\Translation\Loader\LoaderInterface
{
    ...
    private function extract($resource, \ILAB\MediaCloud\Utilities\Misc\Symfony\Component\Translation\MessageCatalogue $catalogue, $domain)
    {
        try {
     ...
     */
    private function extractXliff1(\DOMDocument $dom, \ILAB\MediaCloud\Utilities\Misc\Symfony\Component\Translation\MessageCatalogue $catalogue, $domain)
    {
     ...
     * @param string $domain
     */
    private function extractXliff2(\DOMDocument $dom, \ILAB\MediaCloud\Utilities\Misc\Symfony\Component\Translation\MessageCatalogue $catalogue, $domain)
    {
        $xml = \simplexml_import_dom($dom);
        $encoding = \strtoupper($dom->encoding);
    ...
    private function validateSchema($file, \DOMDocument $dom, $schema)
    {
        ...
        if (!@$dom->schemaValidateSource($schema)) {
            ...
            throw new \ILAB\MediaCloud\Utilities\Misc\Symfony\Component\Translation\Exception\InvalidResourceException(\sprintf('Invalid resource provided: "%s"; Errors: %s', $file, \implode("\n", $this->getXmlErrors($internalErrors))));
        }
        \libxml_disable_entity_loader($disableEntities);
