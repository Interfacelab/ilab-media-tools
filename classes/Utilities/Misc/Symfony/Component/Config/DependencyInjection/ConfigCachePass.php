 ...
 */
namespace ILAB\MediaCloud\Utilities\Misc\Symfony\Component\Config\DependencyInjection;

@\trigger_error(\sprintf('The %s class is deprecated since Symfony 3.4 and will be removed in 4.0. Use tagged iterator arguments instead.', \ILAB\MediaCloud\Utilities\Misc\Symfony\Component\Config\DependencyInjection\ConfigCachePass::class), \E_USER_DEPRECATED);
use ILAB\MediaCloud\Utilities\Misc\Symfony\Component\DependencyInjection\Argument\IteratorArgument;
use ILAB\MediaCloud\Utilities\Misc\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface;
use ILAB\MediaCloud\Utilities\Misc\Symfony\Component\DependencyInjection\Compiler\PriorityTaggedServiceTrait;
 ...
 */
class ConfigCachePass implements \ILAB\MediaCloud\Utilities\Misc\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    ...
    public function process(\ILAB\MediaCloud\Utilities\Misc\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        $container->getDefinition($this->factoryServiceId)->replaceArgument(0, new \ILAB\MediaCloud\Utilities\Misc\Symfony\Component\DependencyInjection\Argument\IteratorArgument($resourceCheckers));
    }
}
