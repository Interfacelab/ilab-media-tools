...
use ILAB\MediaCloud\Utilities\Misc\Symfony\Component\Filesystem\Filesystem;
/**
 ...
 */
class ResourceCheckerConfigCache implements \ILAB\MediaCloud\Utilities\Misc\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write($content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \ILAB\MediaCloud\Utilities\Misc\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\ILAB\MediaCloud\Utilities\Misc\Symfony\Component\Filesystem\Exception\IOException $e) {
