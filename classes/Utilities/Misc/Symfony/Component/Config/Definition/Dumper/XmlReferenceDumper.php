...
{
    private $reference;
    public function dump(\ILAB\MediaCloud\Utilities\Misc\Symfony\Component\Config\Definition\ConfigurationInterface $configuration, $namespace = null)
    {
        return $this->dumpNode($configuration->getConfigTreeBuilder()->buildTree(), $namespace);
    }
    public function dumpNode(\ILAB\MediaCloud\Utilities\Misc\Symfony\Component\Config\Definition\NodeInterface $node, $namespace = null)
    {
        $this->reference = '';
     ...
     */
    private function writeNode(\ILAB\MediaCloud\Utilities\Misc\Symfony\Component\Config\Definition\NodeInterface $node, $depth = 0, $root = \false, $namespace = null)
    {
        ...
        if ($node instanceof \ILAB\MediaCloud\Utilities\Misc\Symfony\Component\Config\Definition\ArrayNode) {
            ...
            if ($node instanceof \ILAB\MediaCloud\Utilities\Misc\Symfony\Component\Config\Definition\PrototypedArrayNode) {
                ...
                if ($prototype instanceof \ILAB\MediaCloud\Utilities\Misc\Symfony\Component\Config\Definition\PrototypedArrayNode) {
                    $prototype->setName($key);
                    $children = [$key => $prototype];
                } elseif ($prototype instanceof \ILAB\MediaCloud\Utilities\Misc\Symfony\Component\Config\Definition\ArrayNode) {
            ...
            foreach ($children as $child) {
                if (!$child instanceof \ILAB\MediaCloud\Utilities\Misc\Symfony\Component\Config\Definition\ArrayNode) {
                    // get attributes
                    // metadata
                    ...
                    if ($child instanceof \ILAB\MediaCloud\Utilities\Misc\Symfony\Component\Config\Definition\EnumNode) {
