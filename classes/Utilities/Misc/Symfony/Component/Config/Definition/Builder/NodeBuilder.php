 ...
 */
class NodeBuilder implements \ILAB\MediaCloud\Utilities\Misc\Symfony\Component\Config\Definition\Builder\NodeParentInterface
{
    protected $parent;
     ...
     * @return $this
     */
    public function setParent(\ILAB\MediaCloud\Utilities\Misc\Symfony\Component\Config\Definition\Builder\ParentNodeDefinitionInterface $parent = null)
    {
        $this->parent = $parent;
        return $this;
    }
    ...
    {
        if ($node instanceof \ILAB\MediaCloud\Utilities\Misc\Symfony\Component\Config\Definition\Builder\ParentNodeDefinitionInterface) {
            $builder = clone $this;
