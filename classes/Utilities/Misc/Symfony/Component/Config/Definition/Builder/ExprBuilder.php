...
class ExprBuilder
{
    ...
    public $ifPart;
    public $thenPart;
    public function __construct(\ILAB\MediaCloud\Utilities\Misc\Symfony\Component\Config\Definition\Builder\NodeDefinition $node)
    {
        $this->node = $node;
    }
    /**
    ...
    {
        $this->thenPart = function ($v) {
            throw new \ILAB\MediaCloud\Utilities\Misc\Symfony\Component\Config\Definition\Exception\UnsetKeyException('Unsetting key');
        };
        return $this;
    }
    /**
