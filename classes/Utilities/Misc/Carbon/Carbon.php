...
use ILAB\MediaCloud\Utilities\Misc\Carbon\Exceptions\InvalidDateException;
use Closure;
use DateInterval;
use DatePeriod;
use DateTime;
...
class Carbon extends \DateTime implements \JsonSerializable
{
    ...
    public static function createSafe($year = null, $month = null, $day = null, $hour = null, $minute = null, $second = null, $tz = null)
    {
        ...
        foreach ($fields as $field => $range) {
            if (${$field} !== null && (!\is_int(${$field}) || ${$field} < $range[0] || ${$field} > $range[1])) {
                throw new \ILAB\MediaCloud\Utilities\Misc\Carbon\Exceptions\InvalidDateException($field, ${$field});
            }
        }
    ...
    protected static function translator()
    {
        if (static::$translator === null) {
            static::$translator = \ILAB\MediaCloud\Utilities\Misc\Carbon\Translator::get();
        }
     ...
     * @return void
     */
    public static function setTranslator(\ILAB\MediaCloud\Utilities\Misc\Symfony\Component\Translation\TranslatorInterface $translator)
    {
    ...
    {
        return static::executeWithLocale($locale, function ($newLocale, \ILAB\MediaCloud\Utilities\Misc\Symfony\Component\Translation\TranslatorInterface $translator) {
    ...
    public static function getAvailableLocales()
    {
        ...
        $locales = array();
        if ($translator instanceof \ILAB\MediaCloud\Utilities\Misc\Carbon\Translator) {
    ...
    {
        $diff = \ILAB\MediaCloud\Utilities\Misc\Carbon\CarbonInterval::instance($diff, $trimMicroseconds);
        // @codeCoverageIgnoreStart
    ...
    {
        return $this->diffFiltered(\ILAB\MediaCloud\Utilities\Misc\Carbon\CarbonInterval::day(), $callback, $date, $absolute);
    }
    /**
    ...
    {
        return $this->diffFiltered(\ILAB\MediaCloud\Utilities\Misc\Carbon\CarbonInterval::hour(), $callback, $date, $absolute);
    }
    /**
     ...
     * @return int
     */
    public function diffFiltered(\ILAB\MediaCloud\Utilities\Misc\Carbon\CarbonInterval $ci, \Closure $callback, $date = null, $absolute = \true)
    {
        $start = $this;
        ...
        $values = \array_filter(\iterator_to_array($period), function ($date) use($callback) {
            return \call_user_func($callback, \ILAB\MediaCloud\Utilities\Misc\Carbon\Carbon::instance($date));
        });
        $diff = \count($values);
    ...
    {
        return $this->diffInDaysFiltered(function (\ILAB\MediaCloud\Utilities\Misc\Carbon\Carbon $date) {
