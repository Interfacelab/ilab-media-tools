 ...
 * @property string $privacyImages
 * @property string $privacyVideo
 * @property string $privacyAudio
 * @property string $privacyDocs
 ...
 * @property bool $queuedDeletes
 * @property bool $deleteFromStorage
 * @property int $expireMinutes
 * @property string|null $expires
 * @property string[] $ignoredMimeTypes
 * @property string|null $cdn
 * @property string|null $docCdn
 * @property string|null $signedCDN
...
class StorageToolSettings extends ToolSettings {
	...
	protected $settingsMap = [
		...
		"privacyImages" => ['mcloud-storage-privacy-images', null, "inherit"],
		"privacyAudio" => ['mcloud-storage-privacy-audio', null, "inherit"],
		"privacyVideo" => ['mcloud-storage-privacy-video', null, "inherit"],
		"privacyDocs" => ['mcloud-storage-privacy-docs', null, "inherit"],
	...
	public function __isset($name) {
		if (in_array($name, ['expires', 'privacy', 'ignoredMimeTypes', 'cdn', 'docCdn', 'signedCDN'])) {
			return true;
		}
