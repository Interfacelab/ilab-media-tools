...
namespace MediaCloud\Vendor\Rize\UriTemplate\Node;
use MediaCloud\Vendor\Rize\UriTemplate\Parser;
...
class Expression extends Abstraction
{
    ...
    public function match(Parser $parser, $uri, $params = array(), $strict = false)
    {
        ...
        foreach($this->sortVariables($this->variables) as $var) {
            /** @var \MediaCloud\Vendor\Rize\UriTemplate\Node\Variable $regex */
