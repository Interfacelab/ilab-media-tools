...
namespace MediaCloud\Vendor\JmesPath;
...
class TreeCompiler
{
    ...
    public function visit(array $ast, $fnName, $expr)
    {
        ...
        $this->write("<?php\n")
            ->write('use MediaCloud\\Vendor\\JmesPath\\TreeInterpreter as Ti;')
            ->write('use MediaCloud\\Vendor\\JmesPath\\FnDispatcher as Fd;')
            ->write('use MediaCloud\\Vendor\\JmesPath\\Utils;')
            ->write('')
