...
// Warm up the runner \MediaCloud\Vendor\JmesPath\Env::search('foo', []);
...
{
    $best = 99999;
    $runtime = \MediaCloud\Vendor\JmesPath\Env::createRuntime();
    ...
    for ($i = 0; $i < 100; $i++) {
        ...
        if (!getenv('CACHE')) {
            ...
            if ($runtime instanceof \MediaCloud\Vendor\JmesPath\CompilerRuntime) {
