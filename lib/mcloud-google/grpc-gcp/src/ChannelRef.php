...
class ChannelRef
{
    // $opts has all information except Credentials for creating a MediaCloud\Vendor\Grpc\Channel.
    private $opts;
    ...
    public function getRealChannel($credentials)
    {
        ...
        // \MediaCloud\Vendor\Grpc\Channel is implemented(issue https://github.com/grpc/grpc/issues/15870).
        ...
        // thus needs to be recreated becasue MediaCloud\Vendor\Grpc\Channel don't have serialize and
        // deserialize handler.
        ...
        $real_channel = new \MediaCloud\Vendor\Grpc\Channel($this->target, $this->opts);
