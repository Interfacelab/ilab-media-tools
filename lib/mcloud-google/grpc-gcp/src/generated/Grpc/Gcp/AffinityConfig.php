 ...
 */
class AffinityConfig extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \MediaCloud\Vendor\Grpc\Gcp\AffinityConfig_Command::class);
        $this->command = $var;
