 ...
 */
class Api extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *           The fully qualified name of this interface, including package name
     *           followed by the interface's simple name.
     *     @type \MediaCloud\Vendor\Google\Protobuf\Method[]|\Google\Protobuf\Internal\RepeatedField $methods
     *           The methods of this interface, in unspecified order.
     ...
     *           Source context for the protocol buffer service represented by this
     *           message.
     *     @type \MediaCloud\Vendor\Google\Protobuf\Mixin[]|\Google\Protobuf\Internal\RepeatedField $mixins
     *           Included interfaces. See [Mixin][].
     *     @type int $syntax
     *           The source syntax of the service.
     * }
     */
    public function __construct($data = NULL) { \MediaCloud\Vendor\GPBMetadata\Google\Protobuf\Api::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.protobuf.Method methods = 2;</code>
     * @param \MediaCloud\Vendor\Google\Protobuf\Method[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setMethods($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \MediaCloud\Vendor\Google\Protobuf\Method::class);
        $this->methods = $arr;
     ...
     *
     * Generated from protobuf field <code>repeated .google.protobuf.Mixin mixins = 6;</code>
     * @param \MediaCloud\Vendor\Google\Protobuf\Mixin[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setMixins($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \MediaCloud\Vendor\Google\Protobuf\Mixin::class);
        $this->mixins = $arr;
