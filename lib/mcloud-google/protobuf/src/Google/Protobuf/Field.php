 ...
 */
class Field extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     * The field type.
     *
    ...
    {
        GPBUtil::checkEnum($var, \MediaCloud\Vendor\Google\Protobuf\Field\Kind::class);
        $this->kind = $var;
    ...
    {
        GPBUtil::checkEnum($var, \MediaCloud\Vendor\Google\Protobuf\Field\Cardinality::class);
