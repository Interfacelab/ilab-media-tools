...
class Field extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \MediaCloud\Vendor\Google\Protobuf\Field_Kind::class);
        $this->kind = $var;
    ...
    {
        GPBUtil::checkEnum($var, \MediaCloud\Vendor\Google\Protobuf\Field_Cardinality::class);
