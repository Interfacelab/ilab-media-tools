 ...
 */
class SourceContext extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     * }
     */
    public function __construct($data = NULL) { \MediaCloud\Vendor\GPBMetadata\Google\Protobuf\SourceContext::initOnce();
