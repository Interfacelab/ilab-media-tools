 ...
 */
class Duration extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     * }
     */
    public function __construct($data = NULL) { \MediaCloud\Vendor\GPBMetadata\Google\Protobuf\Duration::initOnce();
