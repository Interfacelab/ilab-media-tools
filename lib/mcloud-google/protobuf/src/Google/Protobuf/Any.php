 ...
 */
class Any extends \MediaCloud\Vendor\Google\Protobuf\Internal\AnyBase
{
    /**
     ...
     * }
     */
    public function __construct($data = NULL) { \MediaCloud\Vendor\GPBMetadata\Google\Protobuf\Any::initOnce();
