 ...
 */
class FileOptions extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \MediaCloud\Vendor\Google\Protobuf\Internal\FileOptions\OptimizeMode::class);
