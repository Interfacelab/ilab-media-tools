 ...
 */
class MethodOptions extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \MediaCloud\Vendor\Google\Protobuf\Internal\MethodOptions\IdempotencyLevel::class);
