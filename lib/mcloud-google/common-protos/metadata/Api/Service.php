...
namespace MediaCloud\Vendor\GPBMetadata\Google\Api;
...
class Service
{
    ...
    public static function initOnce() {
        ...
        if (static::$is_initialized == true) {
          return;
        } \MediaCloud\Vendor\GPBMetadata\Google\Api\Annotations::initOnce(); \MediaCloud\Vendor\GPBMetadata\Google\Api\Auth::initOnce(); \MediaCloud\Vendor\GPBMetadata\Google\Api\Backend::initOnce(); \MediaCloud\Vendor\GPBMetadata\Google\Api\Billing::initOnce(); \MediaCloud\Vendor\GPBMetadata\Google\Api\Context::initOnce(); \MediaCloud\Vendor\GPBMetadata\Google\Api\Control::initOnce(); \MediaCloud\Vendor\GPBMetadata\Google\Api\Documentation::initOnce(); \MediaCloud\Vendor\GPBMetadata\Google\Api\Endpoint::initOnce(); \MediaCloud\Vendor\GPBMetadata\Google\Api\Http::initOnce(); \MediaCloud\Vendor\GPBMetadata\Google\Api\Log::initOnce(); \MediaCloud\Vendor\GPBMetadata\Google\Api\Logging::initOnce(); \MediaCloud\Vendor\GPBMetadata\Google\Api\Metric::initOnce(); \MediaCloud\Vendor\GPBMetadata\Google\Api\MonitoredResource::initOnce(); \MediaCloud\Vendor\GPBMetadata\Google\Api\Monitoring::initOnce(); \MediaCloud\Vendor\GPBMetadata\Google\Api\Quota::initOnce(); \MediaCloud\Vendor\GPBMetadata\Google\Api\SourceInfo::initOnce(); \MediaCloud\Vendor\GPBMetadata\Google\Api\SystemParameter::initOnce(); \MediaCloud\Vendor\GPBMetadata\Google\Api\Usage::initOnce(); \MediaCloud\Vendor\GPBMetadata\Google\Protobuf\Api::initOnce(); \MediaCloud\Vendor\GPBMetadata\Google\Protobuf\Type::initOnce(); \MediaCloud\Vendor\GPBMetadata\Google\Protobuf\Wrappers::initOnce();
