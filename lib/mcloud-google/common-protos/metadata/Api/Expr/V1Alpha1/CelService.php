...
namespace MediaCloud\Vendor\GPBMetadata\Google\Api\Expr\V1Alpha1;
...
class CelService
{
    ...
    public static function initOnce() {
        ...
        if (static::$is_initialized == true) {
          return;
        } \MediaCloud\Vendor\GPBMetadata\Google\Api\Client::initOnce(); \MediaCloud\Vendor\GPBMetadata\Google\Api\Expr\V1Alpha1\ConformanceService::initOnce();
