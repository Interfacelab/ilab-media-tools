...
namespace MediaCloud\Vendor\GPBMetadata\Google\Api\Servicecontrol\V1;
...
class LogEntry
{
    ...
    public static function initOnce() {
        ...
        if (static::$is_initialized == true) {
          return;
        } \MediaCloud\Vendor\GPBMetadata\Google\Api\Annotations::initOnce(); \MediaCloud\Vendor\GPBMetadata\Google\Logging\Type\LogSeverity::initOnce(); \MediaCloud\Vendor\GPBMetadata\Google\Protobuf\Any::initOnce(); \MediaCloud\Vendor\GPBMetadata\Google\Protobuf\Struct::initOnce(); \MediaCloud\Vendor\GPBMetadata\Google\Protobuf\Timestamp::initOnce();
