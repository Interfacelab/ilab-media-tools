...
namespace MediaCloud\Vendor\GPBMetadata\Google\Iam\V1\Logging;
...
class AuditData
{
    ...
    public static function initOnce() {
        ...
        if (static::$is_initialized == true) {
          return;
        } \MediaCloud\Vendor\GPBMetadata\Google\Api\Annotations::initOnce(); \MediaCloud\Vendor\GPBMetadata\Google\Iam\V1\Policy::initOnce();
