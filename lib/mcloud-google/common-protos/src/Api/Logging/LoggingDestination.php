...
namespace MediaCloud\Vendor\Google\Api\Logging;
 ...
 */
class LoggingDestination extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     * }
     */
    public function __construct($data = NULL) { \MediaCloud\Vendor\GPBMetadata\Google\Api\Logging::initOnce();
...
class_alias(LoggingDestination::class, \MediaCloud\Vendor\Google\Api\Logging_LoggingDestination::class);
