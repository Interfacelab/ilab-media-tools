 ...
 */
class Property extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \MediaCloud\Vendor\Google\Api\Property_PropertyType::class);
        $this->type = $var;
