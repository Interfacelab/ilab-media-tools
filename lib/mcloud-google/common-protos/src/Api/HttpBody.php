 ...
 */
class HttpBody extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *     @type string $data
     *           HTTP body binary data.
     *     @type \MediaCloud\Vendor\Google\Protobuf\Any[]|\Google\Protobuf\Internal\RepeatedField $extensions
     *           Application specific response metadata. Must be set in the first response
     *           for streaming APIs.
     * }
     */
    public function __construct($data = NULL) { \MediaCloud\Vendor\GPBMetadata\Google\Api\Httpbody::initOnce();
