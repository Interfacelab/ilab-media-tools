 ...
 */
class LabelDescriptor extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     * The label key.
     *
     ...
     * }
     */
    public function __construct($data = NULL) { \MediaCloud\Vendor\GPBMetadata\Google\Api\Label::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \MediaCloud\Vendor\Google\Api\LabelDescriptor_ValueType::class);
        $this->value_type = $var;
