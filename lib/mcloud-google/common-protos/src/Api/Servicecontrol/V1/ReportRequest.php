 ...
 */
class ReportRequest extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *           [google.api.Service](https://cloud.google.com/service-management/reference/rpc/google.api#google.api.Service)
     *           for the definition of a service name.
     *     @type \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\Operation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Operations to be reported.
     *           Typically the service should report one operation per request.
     *           Putting multiple operations into a single request is allowed, but should
     *           be used only when multiple operations are natually available at the time
     ...
     *
     * Generated from protobuf field <code>repeated .google.api.servicecontrol.v1.Operation operations = 2;</code>
     * @param \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\Operation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\Operation::class);
        $this->operations = $arr;
