 ...
 */
class LinearBuckets extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
...
class_alias(LinearBuckets::class, \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\Distribution_LinearBuckets::class);
