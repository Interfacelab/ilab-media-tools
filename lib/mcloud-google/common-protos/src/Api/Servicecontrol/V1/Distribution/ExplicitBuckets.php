 ...
 */
class ExplicitBuckets extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
...
class_alias(ExplicitBuckets::class, \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\Distribution_ExplicitBuckets::class);
