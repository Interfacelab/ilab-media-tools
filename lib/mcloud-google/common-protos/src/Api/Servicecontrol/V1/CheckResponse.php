...
class CheckResponse extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
     ...
     *           The current service rollout id used to process the request.
     *     @type \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\CheckError[]|\Google\Protobuf\Internal\RepeatedField $check_errors
     *           Indicate the decision of the check.
     *           If no check errors are present, the service should process the operation.
     *           Otherwise the service should use the list of errors to determine the
     *           appropriate action.
     ...
     *           The actual config id used to process the request.
     *     @type \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\CheckResponse\CheckInfo $check_info
     *           Feedback data returned from the server during processing a Check request.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.api.servicecontrol.v1.CheckError check_errors = 2;</code>
     * @param \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\CheckError[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setCheckErrors($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\CheckError::class);
     ...
     *
     * Generated from protobuf field <code>.google.api.servicecontrol.v1.CheckResponse.CheckInfo check_info = 6;</code>
     * @return \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\CheckResponse\CheckInfo
     */
     ...
     *
     * Generated from protobuf field <code>.google.api.servicecontrol.v1.CheckResponse.CheckInfo check_info = 6;</code>
     * @param \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\CheckResponse\CheckInfo $var
     * @return $this
     */
    public function setCheckInfo($var)
    {
        GPBUtil::checkMessage($var, \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\CheckResponse_CheckInfo::class);
        $this->check_info = $var;
