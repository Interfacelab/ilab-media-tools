 ...
 */
class ConsumerInfo extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
...
class_alias(ConsumerInfo::class, \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\CheckResponse_ConsumerInfo::class);
