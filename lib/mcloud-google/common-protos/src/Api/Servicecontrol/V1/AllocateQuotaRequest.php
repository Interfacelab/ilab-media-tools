 ...
 */
class AllocateQuotaRequest extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *           See [google.api.Service][google.api.Service] for the definition of a
     *           service name.
     *     @type \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\QuotaOperation $allocate_operation
     *           Operation that describes the quota allocation.
     ...
     *
     * Generated from protobuf field <code>.google.api.servicecontrol.v1.QuotaOperation allocate_operation = 2;</code>
     * @return \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\QuotaOperation
     */
     ...
     *
     * Generated from protobuf field <code>.google.api.servicecontrol.v1.QuotaOperation allocate_operation = 2;</code>
     * @param \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\QuotaOperation $var
     * @return $this
     */
    public function setAllocateOperation($var)
    {
        GPBUtil::checkMessage($var, \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\QuotaOperation::class);
