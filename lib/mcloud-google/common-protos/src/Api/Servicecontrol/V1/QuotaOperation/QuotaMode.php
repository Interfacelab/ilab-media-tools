...
namespace MediaCloud\Vendor\Google\Api\Servicecontrol\V1\QuotaOperation;
...
class_alias(QuotaMode::class, \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\QuotaOperation_QuotaMode::class);
