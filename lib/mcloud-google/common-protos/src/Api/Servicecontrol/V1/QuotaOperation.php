 ...
 */
class QuotaOperation extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\QuotaOperation_QuotaMode::class);
        $this->quota_mode = $var;
