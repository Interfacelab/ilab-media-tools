 ...
 */
class Operation extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *               - `servicecontrol.googleapis.com/platform` describing the platform
     *                  where the API is served (e.g. GAE, GCE, GKE).
     *     @type \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\MetricValueSet[]|\Google\Protobuf\Internal\RepeatedField $metric_value_sets
     *           Represents information about this operation. Each MetricValueSet
     *           corresponds to a metric defined in the service configuration.
     *           The data type used in the MetricValueSet must agree with
     *           the data type specified in the metric definition.
     ...
     *           instances, the entire request is rejected with
     *           an invalid argument error.
     *     @type \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\LogEntry[]|\Google\Protobuf\Internal\RepeatedField $log_entries
     *           Represents information to be logged.
     *     @type int $importance
     *           DO NOT USE. This is an experimental field.
     * }
     */
    public function __construct($data = NULL) { \MediaCloud\Vendor\GPBMetadata\Google\Api\Servicecontrol\V1\Operation::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.api.servicecontrol.v1.MetricValueSet metric_value_sets = 7;</code>
     * @param \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\MetricValueSet[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setMetricValueSets($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\MetricValueSet::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.api.servicecontrol.v1.LogEntry log_entries = 8;</code>
     * @param \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\LogEntry[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setLogEntries($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\LogEntry::class);
    ...
    {
        GPBUtil::checkEnum($var, \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\Operation_Importance::class);
        $this->importance = $var;
