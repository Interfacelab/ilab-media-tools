...
namespace MediaCloud\Vendor\Google\Api\Servicecontrol\V1\CheckError;
...
class_alias(Code::class, \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\CheckError_Code::class);
