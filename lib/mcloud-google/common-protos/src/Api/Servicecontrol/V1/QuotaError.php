 ...
 */
class QuotaError extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     * Error code.
     *
    ...
    {
        GPBUtil::checkEnum($var, \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\QuotaError_Code::class);
        $this->code = $var;
