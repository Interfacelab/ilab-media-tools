 ...
 */
class CheckError extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     * The error code.
     *
     ...
     * }
     */
    public function __construct($data = NULL) { \MediaCloud\Vendor\GPBMetadata\Google\Api\Servicecontrol\V1\CheckError::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\CheckError_Code::class);
        $this->code = $var;
