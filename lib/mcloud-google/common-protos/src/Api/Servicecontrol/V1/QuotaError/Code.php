...
namespace MediaCloud\Vendor\Google\Api\Servicecontrol\V1\QuotaError;
...
class_alias(Code::class, \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\QuotaError_Code::class);
