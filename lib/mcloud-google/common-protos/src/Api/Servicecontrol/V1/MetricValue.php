 ...
 */
class MetricValue extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *           A text string value.
     *     @type \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\Distribution $distribution_value
     ...
     * @return \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\Distribution
     */
     ...
     *
     * Generated from protobuf field <code>.google.api.servicecontrol.v1.Distribution distribution_value = 8;</code>
     * @param \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\Distribution $var
     * @return $this
     */
    public function setDistributionValue($var)
    {
        GPBUtil::checkMessage($var, \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\Distribution::class);
