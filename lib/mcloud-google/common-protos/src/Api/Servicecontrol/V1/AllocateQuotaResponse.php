 ...
 */
class AllocateQuotaResponse extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *           The same operation_id value used in the AllocateQuotaRequest. Used for
     *           logging and diagnostics purposes.
     *     @type \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\QuotaError[]|\Google\Protobuf\Internal\RepeatedField $allocate_errors
     *           Indicates the decision of the allocate.
     *     @type \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\MetricValueSet[]|\Google\Protobuf\Internal\RepeatedField $quota_metrics
     *           Quota metrics to indicate the result of allocation. Depending on the
     *           request, one or more of the following metrics will be included:
     *           1. Per quota group or per quota metric incremental usage will be specified
     *           using the following delta metric :
     ...
     * }
     */
    public function __construct($data = NULL) { \MediaCloud\Vendor\GPBMetadata\Google\Api\Servicecontrol\V1\QuotaController::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.api.servicecontrol.v1.QuotaError allocate_errors = 2;</code>
     * @param \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\QuotaError[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setAllocateErrors($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \MediaCloud\Vendor\Google\Api\Servicecontrol\V1\QuotaError::class);
