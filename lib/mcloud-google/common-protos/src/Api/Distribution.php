...
class Distribution extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
     ...
     *           describes Welford's method for accumulating this sum in one pass.
     *           If `count` is zero then this field must be zero.
     *     @type \MediaCloud\Vendor\Google\Api\Distribution\Range $range
     *           If specified, contains the range of the population values. The field
     *           must not be present if the `count` is zero.
     *     @type \MediaCloud\Vendor\Google\Api\Distribution\BucketOptions $bucket_options
     *           Defines the histogram bucket boundaries. If the distribution does not
     *           contain a histogram, then omit this field.
     ...
     *           counts for the finite buckets (number 1 through N-2). The N'th value in
     *           `bucket_counts` is the count for the overflow bucket (number N-1).
     *     @type \MediaCloud\Vendor\Google\Api\Distribution\Exemplar[]|\Google\Protobuf\Internal\RepeatedField $exemplars
     *           Must be in increasing order of `value` field.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.api.Distribution.Range range = 4;</code>
     * @return \MediaCloud\Vendor\Google\Api\Distribution\Range
     */
     ...
     *
     * Generated from protobuf field <code>.google.api.Distribution.Range range = 4;</code>
     * @param \MediaCloud\Vendor\Google\Api\Distribution\Range $var
     * @return $this
     */
    public function setRange($var)
    {
        GPBUtil::checkMessage($var, \MediaCloud\Vendor\Google\Api\Distribution_Range::class);
        $this->range = $var;
     ...
     *
     * Generated from protobuf field <code>.google.api.Distribution.BucketOptions bucket_options = 6;</code>
     * @return \MediaCloud\Vendor\Google\Api\Distribution\BucketOptions
     */
     ...
     *
     * Generated from protobuf field <code>.google.api.Distribution.BucketOptions bucket_options = 6;</code>
     * @param \MediaCloud\Vendor\Google\Api\Distribution\BucketOptions $var
     * @return $this
     */
    public function setBucketOptions($var)
    {
        GPBUtil::checkMessage($var, \MediaCloud\Vendor\Google\Api\Distribution_BucketOptions::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.api.Distribution.Exemplar exemplars = 10;</code>
     * @param \MediaCloud\Vendor\Google\Api\Distribution\Exemplar[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setExemplars($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \MediaCloud\Vendor\Google\Api\Distribution\Exemplar::class);
        $this->exemplars = $arr;
