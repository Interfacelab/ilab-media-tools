 ...
 */
class QuotaLimit extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkMapField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::STRING, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::INT64);
        $this->values = $arr;
