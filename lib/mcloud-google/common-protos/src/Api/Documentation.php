 ...
 */
class Documentation extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *           A short summary of what the service does. Can only be provided by
     *           plain text.
     *     @type \MediaCloud\Vendor\Google\Api\Page[]|\Google\Protobuf\Internal\RepeatedField $pages
     *           The top level pages for the documentation set.
     *     @type \MediaCloud\Vendor\Google\Api\DocumentationRule[]|\Google\Protobuf\Internal\RepeatedField $rules
     *           A list of documentation rules that apply to individual API elements.
     *           **NOTE:** All service configuration rules follow "last one wins" order.
     ...
     * }
     */
    public function __construct($data = NULL) { \MediaCloud\Vendor\GPBMetadata\Google\Api\Documentation::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.api.Page pages = 5;</code>
     * @param \MediaCloud\Vendor\Google\Api\Page[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setPages($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \MediaCloud\Vendor\Google\Api\Page::class);
        $this->pages = $arr;
     ...
     *
     * Generated from protobuf field <code>repeated .google.api.DocumentationRule rules = 3;</code>
     * @param \MediaCloud\Vendor\Google\Api\DocumentationRule[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setRules($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \MediaCloud\Vendor\Google\Api\DocumentationRule::class);
        $this->rules = $arr;
