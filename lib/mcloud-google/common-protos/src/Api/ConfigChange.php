 ...
 */
class ConfigChange extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *           The type for this change, either ADDED, REMOVED, or MODIFIED.
     *     @type \MediaCloud\Vendor\Google\Api\Advice[]|\Google\Protobuf\Internal\RepeatedField $advices
     *           Collection of advice provided for this change, useful for determining the
     *           possible impact of this change.
     * }
     */
    ...
    {
        GPBUtil::checkEnum($var, \MediaCloud\Vendor\Google\Api\ChangeType::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.api.Advice advices = 5;</code>
     * @param \MediaCloud\Vendor\Google\Api\Advice[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setAdvices($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \MediaCloud\Vendor\Google\Api\Advice::class);
        $this->advices = $arr;
