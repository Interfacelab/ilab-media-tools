...
class SourceInfo extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
     ...
     * }
     */
    public function __construct($data = NULL) { \MediaCloud\Vendor\GPBMetadata\Google\Api\Expr\V1Beta1\Source::initOnce();
    ...
    {
        $arr = GPBUtil::checkMapField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::INT32, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::INT32);
        $this->positions = $arr;
