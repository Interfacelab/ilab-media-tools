 ...
 */
class DeclType extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *     @type string $type
     *           The type name, e.g. 'int', 'my.type.Type' or 'T'
     *     @type \MediaCloud\Vendor\Google\Api\Expr\V1beta1\DeclType[]|\Google\Protobuf\Internal\RepeatedField $type_params
     *           An ordered list of type parameters, e.g. `<string, int>`.
     *           Only applies to a subset of types, e.g. `map`, `list`.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.api.expr.v1beta1.DeclType type_params = 4;</code>
     * @param \MediaCloud\Vendor\Google\Api\Expr\V1beta1\DeclType[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setTypeParams($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \MediaCloud\Vendor\Google\Api\Expr\V1beta1\DeclType::class);
