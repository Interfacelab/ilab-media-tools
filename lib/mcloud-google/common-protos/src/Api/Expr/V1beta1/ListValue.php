...
class ListValue extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \MediaCloud\Vendor\Google\Api\Expr\V1beta1\Value[]|\Google\Protobuf\Internal\RepeatedField $values
     *           The ordered values in the list.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.api.expr.v1beta1.Value values = 1;</code>
     * @param \MediaCloud\Vendor\Google\Api\Expr\V1beta1\Value[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setValues($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \MediaCloud\Vendor\Google\Api\Expr\V1beta1\Value::class);
        $this->values = $arr;
