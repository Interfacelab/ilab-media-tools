...
namespace MediaCloud\Vendor\Google\Api\Expr\V1beta1\MapValue;
...
class Entry extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \MediaCloud\Vendor\Google\Api\Expr\V1beta1\Value $key
     *           The key.
     *           Must be unique with in the map.
     *           Currently only boolean, int, uint, and string values can be keys.
...
class_alias(Entry::class, \MediaCloud\Vendor\Google\Api\Expr\V1beta1\MapValue_Entry::class);
