...
namespace MediaCloud\Vendor\Google\Api\Expr\V1beta1\Expr\CreateStruct;
...
class Entry extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
     ...
     *     @type \MediaCloud\Vendor\Google\Api\Expr\V1beta1\Expr $map_key
...
class_alias(Entry::class, \MediaCloud\Vendor\Google\Api\Expr\V1beta1\Expr_CreateStruct_Entry::class);
