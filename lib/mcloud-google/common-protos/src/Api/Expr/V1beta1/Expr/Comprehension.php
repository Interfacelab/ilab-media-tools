 ...
 */
class Comprehension extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *           The name of the iteration variable.
     *     @type \MediaCloud\Vendor\Google\Api\Expr\V1beta1\Expr $iter_range
     *           The range over which var iterates.
     *     @type string $accu_var
     *           The name of the variable used for accumulation of the result.
     *     @type \MediaCloud\Vendor\Google\Api\Expr\V1beta1\Expr $accu_init
     *           The initial value of the accumulator.
     *     @type \MediaCloud\Vendor\Google\Api\Expr\V1beta1\Expr $loop_condition
     *           An expression which can contain iter_var and accu_var.
     *           Returns false when the result has been computed and may be used as
     *           a hint to short-circuit the remainder of the comprehension.
     *     @type \MediaCloud\Vendor\Google\Api\Expr\V1beta1\Expr $loop_step
     *           An expression which can contain iter_var and accu_var.
     *           Computes the next value of accu_var.
     *     @type \MediaCloud\Vendor\Google\Api\Expr\V1beta1\Expr $result
     *           An expression which can contain accu_var.
     *           Computes the result.
     * }
     */
...
class_alias(Comprehension::class, \MediaCloud\Vendor\Google\Api\Expr\V1beta1\Expr_Comprehension::class);
