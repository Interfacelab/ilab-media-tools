...
namespace MediaCloud\Vendor\Google\Api\Expr\V1alpha1\Explain;
 ...
 */
class ExprStep extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
...
class_alias(ExprStep::class, \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\Explain_ExprStep::class);
