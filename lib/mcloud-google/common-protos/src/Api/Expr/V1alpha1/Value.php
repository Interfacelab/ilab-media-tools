...
class Value extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
     ...
     *           Byte string value.
     *     @type \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\EnumValue $enum_value
     *           An enum value.
     *     @type \MediaCloud\Vendor\Google\Protobuf\Any $object_value
     *           The proto message backing an object value.
     *     @type \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\MapValue $map_value
     *           Map value.
     *     @type \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\ListValue $list_value
     *           List value.
     ...
     * @return \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\EnumValue
     */
     ...
     *
     * Generated from protobuf field <code>.google.api.expr.v1alpha1.EnumValue enum_value = 9;</code>
     * @param \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\EnumValue $var
     * @return $this
     */
    public function setEnumValue($var)
    {
        GPBUtil::checkMessage($var, \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\EnumValue::class);
     ...
     * @return \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\MapValue
     */
     ...
     *
     * Generated from protobuf field <code>.google.api.expr.v1alpha1.MapValue map_value = 11;</code>
     * @param \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\MapValue $var
     * @return $this
     */
    public function setMapValue($var)
    {
        GPBUtil::checkMessage($var, \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\MapValue::class);
     ...
     * @return \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\ListValue
     */
     ...
     *
     * Generated from protobuf field <code>.google.api.expr.v1alpha1.ListValue list_value = 12;</code>
     * @param \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\ListValue $var
     * @return $this
     */
    public function setListValue($var)
    {
        GPBUtil::checkMessage($var, \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\ListValue::class);
