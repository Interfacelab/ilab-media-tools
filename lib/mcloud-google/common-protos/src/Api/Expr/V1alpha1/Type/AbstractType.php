 ...
 */
class AbstractType extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *     @type string $name
     *           The fully qualified name of this abstract type.
     *     @type \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\Type[]|\Google\Protobuf\Internal\RepeatedField $parameter_types
     *           Parameter types for this abstract type.
     * }
     */
...
class_alias(AbstractType::class, \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\Type_AbstractType::class);
