...
class IdentDecl extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
     ...
     *           Required. The type of the identifier.
     *     @type \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\Constant $value
     *           The constant value of the identifier. If not specified, the identifier
     *           must be supplied at evaluation time.
     *     @type string $doc
     *           Documentation string for the identifier.
...
class_alias(IdentDecl::class, \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\Decl_IdentDecl::class);
