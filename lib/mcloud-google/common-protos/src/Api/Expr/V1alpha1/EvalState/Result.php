...
namespace MediaCloud\Vendor\Google\Api\Expr\V1alpha1\EvalState;
...
class_alias(Result::class, \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\EvalState_Result::class);
