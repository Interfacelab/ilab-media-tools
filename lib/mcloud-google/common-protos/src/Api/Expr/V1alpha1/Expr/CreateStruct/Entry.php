...
namespace MediaCloud\Vendor\Google\Api\Expr\V1alpha1\Expr\CreateStruct;
...
class Entry extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
     ...
     *     @type \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\Expr $map_key
     *           The key expression for a map creation statement.
     *     @type \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\Expr $value
     *           Required. The value assigned to the key.
     * }
     */
...
class_alias(Entry::class, \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\Expr_CreateStruct_Entry::class);
