 ...
 */
class CreateStruct extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *           The type name of the message to be created, empty when creating map
     *           literals.
     *     @type \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\Expr\CreateStruct\Entry[]|\Google\Protobuf\Internal\RepeatedField $entries
     *           The entries in the creation expression.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.api.expr.v1alpha1.Expr.CreateStruct.Entry entries = 2;</code>
     * @param \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\Expr\CreateStruct\Entry[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setEntries($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\Expr\CreateStruct\Entry::class);
        $this->entries = $arr;
...
class_alias(CreateStruct::class, \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\Expr_CreateStruct::class);
