...
class SourceInfo extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkMapField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::INT64, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::INT32);
        $this->positions = $arr;
    ...
    {
        $arr = GPBUtil::checkMapField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::INT64, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\Expr::class);
