 ...
 */
class EvalRequest extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkMapField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::STRING, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\ExprValue::class);
        $this->bindings = $arr;
