 ...
 */
class CheckRequest extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     *     @type \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\ParsedExpr $parsed_expr
     *           Required. The parsed representation of the CEL program.
     *     @type \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\Decl[]|\Google\Protobuf\Internal\RepeatedField $type_env
     *           Declarations of types for external variables and functions.
     *           Required if program uses external variables or functions
     *           not in the default environment.
     ...
     *
     * Generated from protobuf field <code>.google.api.expr.v1alpha1.ParsedExpr parsed_expr = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\ParsedExpr
     */
     ...
     *
     * Generated from protobuf field <code>.google.api.expr.v1alpha1.ParsedExpr parsed_expr = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\ParsedExpr $var
     * @return $this
     */
    public function setParsedExpr($var)
    {
        GPBUtil::checkMessage($var, \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\ParsedExpr::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.api.expr.v1alpha1.Decl type_env = 2;</code>
     * @param \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\Decl[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setTypeEnv($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\Decl::class);
        $this->type_env = $arr;
