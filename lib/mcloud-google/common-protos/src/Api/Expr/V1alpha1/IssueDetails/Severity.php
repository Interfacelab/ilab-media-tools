...
namespace MediaCloud\Vendor\Google\Api\Expr\V1alpha1\IssueDetails;
...
class_alias(Severity::class, \MediaCloud\Vendor\Google\Api\Expr\V1alpha1\IssueDetails_Severity::class);
