 ...
 */
class Linear extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
...
class_alias(Linear::class, \MediaCloud\Vendor\Google\Api\Distribution_BucketOptions_Linear::class);
