 ...
 */
class MetricDescriptor extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *               "external.googleapis.com/prometheus/up"
     *               "appengine.googleapis.com/http/server/response_latencies"
     *     @type \MediaCloud\Vendor\Google\Api\LabelDescriptor[]|\Google\Protobuf\Internal\RepeatedField $labels
     *           The set of labels that can be used to describe a specific
     *           instance of this metric type. For example, the
     *           `appengine.googleapis.com/http/server/response_latencies` metric
     *           type has a label for the HTTP response code, `response_code`, so
     ...
     *           This field is optional but it is recommended to be set for any metrics
     *           associated with user-visible concepts, such as Quota.
     *     @type \MediaCloud\Vendor\Google\Api\MetricDescriptor\MetricDescriptorMetadata $metadata
     *           Optional. Metadata which can be used to guide usage of the metric.
     ...
     *
     * Generated from protobuf field <code>repeated .google.api.LabelDescriptor labels = 2;</code>
     * @param \MediaCloud\Vendor\Google\Api\LabelDescriptor[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setLabels($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \MediaCloud\Vendor\Google\Api\LabelDescriptor::class);
        $this->labels = $arr;
    ...
    {
        GPBUtil::checkEnum($var, \MediaCloud\Vendor\Google\Api\MetricDescriptor_MetricKind::class);
    ...
    {
        GPBUtil::checkEnum($var, \MediaCloud\Vendor\Google\Api\MetricDescriptor_ValueType::class);
        $this->value_type = $var;
     ...
     *
     * Generated from protobuf field <code>.google.api.MetricDescriptor.MetricDescriptorMetadata metadata = 10;</code>
     * @return \MediaCloud\Vendor\Google\Api\MetricDescriptor\MetricDescriptorMetadata
     */
     ...
     *
     * Generated from protobuf field <code>.google.api.MetricDescriptor.MetricDescriptorMetadata metadata = 10;</code>
     * @param \MediaCloud\Vendor\Google\Api\MetricDescriptor\MetricDescriptorMetadata $var
     * @return $this
     */
    public function setMetadata($var)
    {
        GPBUtil::checkMessage($var, \MediaCloud\Vendor\Google\Api\MetricDescriptor_MetricDescriptorMetadata::class);
        $this->metadata = $var;
