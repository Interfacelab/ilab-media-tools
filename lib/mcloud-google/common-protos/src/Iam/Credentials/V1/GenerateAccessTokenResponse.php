...
namespace MediaCloud\Vendor\Google\Iam\Credentials\V1;
 ...
 */
class GenerateAccessTokenResponse extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *           The OAuth 2.0 access token.
     *     @type \MediaCloud\Vendor\Google\Protobuf\Timestamp $expire_time
     *           Token expiration time.
     *           The expiration time is always set.
     * }
     */
    public function __construct($data = NULL) { \MediaCloud\Vendor\GPBMetadata\Google\Iam\Credentials\V1\Common::initOnce();
