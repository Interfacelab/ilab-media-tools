...
namespace MediaCloud\Vendor\Google\Iam\Admin\V1\Permission;
...
class_alias(CustomRolesSupportLevel::class, \MediaCloud\Vendor\Google\Iam\Admin\V1\Permission_CustomRolesSupportLevel::class);
