 ...
 */
class CreateServiceAccountRequest extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *           must be 6-30 characters long, and match the regular expression
     *           `[a-z]([-a-z0-9]*[a-z0-9])` to comply with RFC1035.
     *     @type \MediaCloud\Vendor\Google\Iam\Admin\V1\ServiceAccount $service_account
     *           The [ServiceAccount][google.iam.admin.v1.ServiceAccount] resource to
     *           create. Currently, only the following values are user assignable:
     *           `display_name` and `description`.
     * }
     ...
     *
     * Generated from protobuf field <code>.google.iam.admin.v1.ServiceAccount service_account = 3;</code>
     * @return \MediaCloud\Vendor\Google\Iam\Admin\V1\ServiceAccount
     */
     ...
     *
     * Generated from protobuf field <code>.google.iam.admin.v1.ServiceAccount service_account = 3;</code>
     * @param \MediaCloud\Vendor\Google\Iam\Admin\V1\ServiceAccount $var
     * @return $this
     */
    public function setServiceAccount($var)
    {
        GPBUtil::checkMessage($var, \MediaCloud\Vendor\Google\Iam\Admin\V1\ServiceAccount::class);
