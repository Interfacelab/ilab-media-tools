 ...
 */
class ListServiceAccountKeysRequest extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::ENUM, \MediaCloud\Vendor\Google\Iam\Admin\V1\ListServiceAccountKeysRequest\KeyType::class);
        $this->key_types = $arr;
