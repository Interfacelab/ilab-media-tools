 ...
 */
class QueryGrantableRolesRequest extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \MediaCloud\Vendor\Google\Iam\Admin\V1\RoleView::class);
        $this->view = $var;
