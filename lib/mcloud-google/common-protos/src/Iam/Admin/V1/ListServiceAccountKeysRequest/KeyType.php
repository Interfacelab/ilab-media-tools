...
namespace MediaCloud\Vendor\Google\Iam\Admin\V1\ListServiceAccountKeysRequest;
...
class_alias(KeyType::class, \MediaCloud\Vendor\Google\Iam\Admin\V1\ListServiceAccountKeysRequest_KeyType::class);
