 ...
 */
class Role extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \MediaCloud\Vendor\Google\Iam\Admin\V1\Role_RoleLaunchStage::class);
        $this->stage = $var;
