 ...
 */
class ServiceAccountKey extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *           The public key data. Only provided in `GetServiceAccountKey` responses.
     *     @type \MediaCloud\Vendor\Google\Protobuf\Timestamp $valid_after_time
     *           The key can be used after this timestamp.
     *     @type \MediaCloud\Vendor\Google\Protobuf\Timestamp $valid_before_time
     *           The key can be used before this timestamp.
     *           For system-managed key pairs, this timestamp is the end time for the
     *           private key signing operation. The public key could still be used
     *           for verification for a few hours after this time.
    ...
    {
        GPBUtil::checkEnum($var, \MediaCloud\Vendor\Google\Iam\Admin\V1\ServiceAccountPrivateKeyType::class);
    ...
    {
        GPBUtil::checkEnum($var, \MediaCloud\Vendor\Google\Iam\Admin\V1\ServiceAccountKeyAlgorithm::class);
