 ...
 */
class ListServiceAccountsResponse extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     *     @type \MediaCloud\Vendor\Google\Iam\Admin\V1\ServiceAccount[]|\Google\Protobuf\Internal\RepeatedField $accounts
     *           The list of matching service accounts.
     ...
     *
     * Generated from protobuf field <code>repeated .google.iam.admin.v1.ServiceAccount accounts = 1;</code>
     * @param \MediaCloud\Vendor\Google\Iam\Admin\V1\ServiceAccount[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setAccounts($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \MediaCloud\Vendor\Google\Iam\Admin\V1\ServiceAccount::class);
        $this->accounts = $arr;
