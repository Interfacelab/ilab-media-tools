...
namespace MediaCloud\Vendor\Google\Iam\Admin\V1\Role;
...
class_alias(RoleLaunchStage::class, \MediaCloud\Vendor\Google\Iam\Admin\V1\Role_RoleLaunchStage::class);
