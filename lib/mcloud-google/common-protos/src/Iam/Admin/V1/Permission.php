 ...
 */
class Permission extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \MediaCloud\Vendor\Google\Iam\Admin\V1\Permission_PermissionLaunchStage::class);
        $this->stage = $var;
    ...
    {
        GPBUtil::checkEnum($var, \MediaCloud\Vendor\Google\Iam\Admin\V1\Permission_CustomRolesSupportLevel::class);
