 ...
 */
class HttpRequest extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *           The referer URL of the request, as defined in
     *           [HTTP/1.1 Header Field Definitions](http://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html).
     *     @type \MediaCloud\Vendor\Google\Protobuf\Duration $latency
     *           The request processing latency on the server, from the time the request was
     *           received until the response was sent.
     ...
     * }
     */
    public function __construct($data = NULL) { \MediaCloud\Vendor\GPBMetadata\Google\Logging\Type\HttpRequest::initOnce();
