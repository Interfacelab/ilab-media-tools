 ...
 */
class ConfigSource extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *           by the client for tracking purpose. If empty, the server may choose to
     *           generate one instead.
     *     @type \MediaCloud\Vendor\Google\Cloud\ServiceManagement\V1\ConfigFile[]|\Google\Protobuf\Internal\RepeatedField $files
     *           Set of source configuration files that are used to generate a service
     *           configuration (`google.api.Service`).
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.api.servicemanagement.v1.ConfigFile files = 2;</code>
     * @param \MediaCloud\Vendor\Google\Cloud\ServiceManagement\V1\ConfigFile[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setFiles($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \MediaCloud\Vendor\Google\Cloud\ServiceManagement\V1\ConfigFile::class);
        $this->files = $arr;
