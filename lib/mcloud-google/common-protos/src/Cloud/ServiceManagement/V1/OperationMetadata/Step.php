...
namespace MediaCloud\Vendor\Google\Cloud\ServiceManagement\V1\OperationMetadata;
 ...
 */
class Step extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \MediaCloud\Vendor\Google\Cloud\ServiceManagement\V1\OperationMetadata_Status::class);
        $this->status = $var;
...
class_alias(Step::class, \MediaCloud\Vendor\Google\Cloud\ServiceManagement\V1\OperationMetadata_Step::class);
