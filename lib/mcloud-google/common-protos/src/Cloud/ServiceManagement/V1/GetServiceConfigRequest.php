 ...
 */
class GetServiceConfigRequest extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \MediaCloud\Vendor\Google\Cloud\ServiceManagement\V1\GetServiceConfigRequest_ConfigView::class);
        $this->view = $var;
