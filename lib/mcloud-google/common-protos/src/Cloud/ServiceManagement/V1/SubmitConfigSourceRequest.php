 ...
 */
class SubmitConfigSourceRequest extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *           Required. The name of the service.  See the [overview](/service-management/overview)
     *           for naming requirements.  For example: `example.googleapis.com`.
     *     @type \MediaCloud\Vendor\Google\Cloud\ServiceManagement\V1\ConfigSource $config_source
     *           Required. The source configuration for the service.
     ...
     *
     * Generated from protobuf field <code>.google.api.servicemanagement.v1.ConfigSource config_source = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \MediaCloud\Vendor\Google\Cloud\ServiceManagement\V1\ConfigSource
     */
     ...
     *
     * Generated from protobuf field <code>.google.api.servicemanagement.v1.ConfigSource config_source = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \MediaCloud\Vendor\Google\Cloud\ServiceManagement\V1\ConfigSource $var
     * @return $this
     */
    public function setConfigSource($var)
    {
        GPBUtil::checkMessage($var, \MediaCloud\Vendor\Google\Cloud\ServiceManagement\V1\ConfigSource::class);
