 ...
 */
class Diagnostic extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \MediaCloud\Vendor\Google\Cloud\ServiceManagement\V1\Diagnostic_Kind::class);
        $this->kind = $var;
