 ...
 */
class GenerateConfigReportResponse extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *     @type string $id
     *           ID of the service configuration this report belongs to.
     *     @type \MediaCloud\Vendor\Google\Cloud\ServiceManagement\V1\ChangeReport[]|\Google\Protobuf\Internal\RepeatedField $change_reports
     *           list of ChangeReport, each corresponding to comparison between two
     *           service configurations.
     *     @type \MediaCloud\Vendor\Google\Cloud\ServiceManagement\V1\Diagnostic[]|\Google\Protobuf\Internal\RepeatedField $diagnostics
     *           Errors / Linter warnings associated with the service definition this
     *           report
     *           belongs to.
     * }
     ...
     *
     * Generated from protobuf field <code>repeated .google.api.servicemanagement.v1.ChangeReport change_reports = 3;</code>
     * @param \MediaCloud\Vendor\Google\Cloud\ServiceManagement\V1\ChangeReport[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setChangeReports($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \MediaCloud\Vendor\Google\Cloud\ServiceManagement\V1\ChangeReport::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.api.servicemanagement.v1.Diagnostic diagnostics = 4;</code>
     * @param \MediaCloud\Vendor\Google\Cloud\ServiceManagement\V1\Diagnostic[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setDiagnostics($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \MediaCloud\Vendor\Google\Cloud\ServiceManagement\V1\Diagnostic::class);
