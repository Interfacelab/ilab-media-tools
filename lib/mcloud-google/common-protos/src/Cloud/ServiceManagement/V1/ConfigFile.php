 ...
 */
class ConfigFile extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \MediaCloud\Vendor\Google\Cloud\ServiceManagement\V1\ConfigFile_FileType::class);
        $this->file_type = $var;
