 ...
 */
class Rollout extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *           positive number that is reset every day for each service.
     *           An example of the generated rollout_id is '2016-02-16r1'
     *     @type \MediaCloud\Vendor\Google\Protobuf\Timestamp $create_time
     *           Creation time of the rollout. Readonly.
     ...
     *           the system will automatically rollback to the current Rollout
     *           version. Readonly.
     *     @type \MediaCloud\Vendor\Google\Cloud\ServiceManagement\V1\Rollout\TrafficPercentStrategy $traffic_percent_strategy
     *           Google Service Control selects service configurations based on
     *           traffic percentage.
     *     @type \MediaCloud\Vendor\Google\Cloud\ServiceManagement\V1\Rollout\DeleteServiceStrategy $delete_service_strategy
    ...
    {
        GPBUtil::checkEnum($var, \MediaCloud\Vendor\Google\Cloud\ServiceManagement\V1\Rollout_RolloutStatus::class);
        $this->status = $var;
     ...
     * @return \MediaCloud\Vendor\Google\Cloud\ServiceManagement\V1\Rollout\TrafficPercentStrategy
     */
     ...
     *
     * Generated from protobuf field <code>.google.api.servicemanagement.v1.Rollout.TrafficPercentStrategy traffic_percent_strategy = 5;</code>
     * @param \MediaCloud\Vendor\Google\Cloud\ServiceManagement\V1\Rollout\TrafficPercentStrategy $var
     * @return $this
     */
    public function setTrafficPercentStrategy($var)
    {
        GPBUtil::checkMessage($var, \MediaCloud\Vendor\Google\Cloud\ServiceManagement\V1\Rollout_TrafficPercentStrategy::class);
     ...
     * @return \MediaCloud\Vendor\Google\Cloud\ServiceManagement\V1\Rollout\DeleteServiceStrategy
     */
     ...
     *
     * Generated from protobuf field <code>.google.api.servicemanagement.v1.Rollout.DeleteServiceStrategy delete_service_strategy = 200;</code>
     * @param \MediaCloud\Vendor\Google\Cloud\ServiceManagement\V1\Rollout\DeleteServiceStrategy $var
     * @return $this
     */
    public function setDeleteServiceStrategy($var)
    {
        GPBUtil::checkMessage($var, \MediaCloud\Vendor\Google\Cloud\ServiceManagement\V1\Rollout_DeleteServiceStrategy::class);
