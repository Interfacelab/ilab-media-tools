 ...
 */
class GetIamPolicyRequest extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *           REQUIRED: The resource for which the policy is being requested.
     *           See the operation documentation for the appropriate value for this field.
     *     @type \MediaCloud\Vendor\Google\Cloud\Iam\V1\GetPolicyOptions $options
     *           OPTIONAL: A `GetPolicyOptions` object for specifying options to
     *           `GetIamPolicy`. This field is only used by Cloud IAM.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.iam.v1.GetPolicyOptions options = 2;</code>
     * @return \MediaCloud\Vendor\Google\Cloud\Iam\V1\GetPolicyOptions
     */
     ...
     *
     * Generated from protobuf field <code>.google.iam.v1.GetPolicyOptions options = 2;</code>
     * @param \MediaCloud\Vendor\Google\Cloud\Iam\V1\GetPolicyOptions $var
     * @return $this
     */
    public function setOptions($var)
    {
        GPBUtil::checkMessage($var, \MediaCloud\Vendor\Google\Cloud\Iam\V1\GetPolicyOptions::class);
        $this->options = $var;
