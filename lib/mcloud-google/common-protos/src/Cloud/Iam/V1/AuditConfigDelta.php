 ...
 */
class AuditConfigDelta extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \MediaCloud\Vendor\Google\Cloud\Iam\V1\AuditConfigDelta_Action::class);
        $this->action = $var;
