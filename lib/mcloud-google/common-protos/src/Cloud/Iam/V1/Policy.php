 ...
 */
class Policy extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *           If no etag is provided in the call to `setIamPolicy`, version compliance
     *           checks against the stored policy is skipped.
     *     @type \MediaCloud\Vendor\Google\Cloud\Iam\V1\Binding[]|\Google\Protobuf\Internal\RepeatedField $bindings
     *           Associates a list of `members` to a `role`. Optionally may specify a
     *           `condition` that determines when binding is in effect.
     *           `bindings` with no members will result in an error.
     *     @type string $etag
     ...
     *
     * Generated from protobuf field <code>repeated .google.iam.v1.Binding bindings = 4;</code>
     * @param \MediaCloud\Vendor\Google\Cloud\Iam\V1\Binding[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setBindings($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \MediaCloud\Vendor\Google\Cloud\Iam\V1\Binding::class);
        $this->bindings = $arr;
