...
namespace MediaCloud\Vendor\Google\Cloud\Iam\V1\AuditConfigDelta;
...
class_alias(Action::class, \MediaCloud\Vendor\Google\Cloud\Iam\V1\AuditConfigDelta_Action::class);
