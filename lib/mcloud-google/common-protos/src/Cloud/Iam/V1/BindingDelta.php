 ...
 */
class BindingDelta extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *           Follows the same format of Binding.members.
     *           Required
     *     @type \MediaCloud\Vendor\Google\Type\Expr $condition
     *           The condition that is associated with this binding.
     * }
     */
    ...
    {
        GPBUtil::checkEnum($var, \MediaCloud\Vendor\Google\Cloud\Iam\V1\BindingDelta_Action::class);
        $this->action = $var;
     ...
     *
     * Generated from protobuf field <code>.google.type.Expr condition = 4;</code>
     * @return \MediaCloud\Vendor\Google\Type\Expr
     */
     ...
     *
     * Generated from protobuf field <code>.google.type.Expr condition = 4;</code>
     * @param \MediaCloud\Vendor\Google\Type\Expr $var
     * @return $this
     */
    public function setCondition($var)
    {
        GPBUtil::checkMessage($var, \MediaCloud\Vendor\Google\Type\Expr::class);
        $this->condition = $var;
