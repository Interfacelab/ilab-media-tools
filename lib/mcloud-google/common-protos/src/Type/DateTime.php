 ...
 */
class DateTime extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *           Required. Fractions of seconds in nanoseconds. Must be from 0 to
     *           999,999,999.
     *     @type \MediaCloud\Vendor\Google\Protobuf\Duration $utc_offset
     *           UTC offset. Must be whole seconds, between -18 hours and +18 hours.
     *           For example, a UTC offset of -4:00 would be represented as
     *           { seconds: -14400 }.
     *     @type \MediaCloud\Vendor\Google\Type\TimeZone $time_zone
     *           Time zone.
     * }
     */
    public function __construct($data = NULL) { \MediaCloud\Vendor\GPBMetadata\Google\Type\Datetime::initOnce();
     ...
     * @return \MediaCloud\Vendor\Google\Type\TimeZone
     */
     ...
     *
     * Generated from protobuf field <code>.google.type.TimeZone time_zone = 9;</code>
     * @param \MediaCloud\Vendor\Google\Type\TimeZone $var
     * @return $this
     */
    public function setTimeZone($var)
    {
        GPBUtil::checkMessage($var, \MediaCloud\Vendor\Google\Type\TimeZone::class);
