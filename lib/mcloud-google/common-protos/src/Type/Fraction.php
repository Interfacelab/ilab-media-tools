 ...
 */
class Fraction extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     * }
     */
    public function __construct($data = NULL) { \MediaCloud\Vendor\GPBMetadata\Google\Type\Fraction::initOnce();
