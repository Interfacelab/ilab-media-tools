 ...
 */
class Color extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *     @type float $blue
     *           The amount of blue in the color as a value in the interval [0, 1].
     *     @type \MediaCloud\Vendor\Google\Protobuf\FloatValue $alpha
     *           The fraction of this color that should be applied to the pixel. That is,
     *           the final pixel color is defined by the equation:
     *             pixel color = alpha * (this color) + (1.0 - alpha) * (background color)
     *           This means that a value of 1.0 corresponds to a solid color, whereas
     ...
     * }
     */
    public function __construct($data = NULL) { \MediaCloud\Vendor\GPBMetadata\Google\Type\Color::initOnce();
     ...
     *
     * Generated from protobuf field <code>.google.protobuf.FloatValue alpha = 4;</code>
     * @return \MediaCloud\Vendor\Google\Protobuf\FloatValue
     */
     ...
     *
     * Generated from protobuf field <code>.google.protobuf.FloatValue alpha = 4;</code>
     * @param \MediaCloud\Vendor\Google\Protobuf\FloatValue $var
     * @return $this
     */
    public function setAlpha($var)
    {
        GPBUtil::checkMessage($var, \MediaCloud\Vendor\Google\Protobuf\FloatValue::class);
        $this->alpha = $var;
    ...
    /**
     * Sets the field by wrapping a primitive type in a MediaCloud\Vendor\Google\Protobuf\FloatValue object.
    ...
    {
        $wrappedVar = is_null($var) ? null : new \MediaCloud\Vendor\Google\Protobuf\FloatValue(['value' => $var]);
