 ...
 */
class TimeOfDay extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     * }
     */
    public function __construct($data = NULL) { \MediaCloud\Vendor\GPBMetadata\Google\Type\Timeofday::initOnce();
