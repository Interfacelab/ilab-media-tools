...
namespace MediaCloud\Vendor\Google\Rpc\PreconditionFailure;
...
class_alias(Violation::class, \MediaCloud\Vendor\Google\Rpc\PreconditionFailure_Violation::class);
