...
namespace MediaCloud\Vendor\Google\Rpc\Help;
 ...
 */
class Link extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
...
class_alias(Link::class, \MediaCloud\Vendor\Google\Rpc\Help_Link::class);
