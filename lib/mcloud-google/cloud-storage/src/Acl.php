...
class Acl
{
    ...
    /**
     * Delete access controls on a {@see MediaCloud\Vendor\Google\Cloud\Storage\Bucket} or
     * {@see MediaCloud\Vendor\Google\Cloud\Storage\StorageObject} for a specified entity.
     *
     * Example:
     * ```
    ...
    /**
     * Get access controls on a {@see MediaCloud\Vendor\Google\Cloud\Storage\Bucket} or
     * {@see MediaCloud\Vendor\Google\Cloud\Storage\StorageObject}. By default this will return all available
    ...
    /**
     * Add access controls on a {@see MediaCloud\Vendor\Google\Cloud\Storage\Bucket} or
    ...
    /**
     * Update access controls on a {@see MediaCloud\Vendor\Google\Cloud\Storage\Bucket} or
     * {@see MediaCloud\Vendor\Google\Cloud\Storage\StorageObject}.
     *
     * Example:
     * ```
