...
namespace MediaCloud\Vendor\Google\Cloud\Storage\Connection;
use MediaCloud\Vendor\Google\Cloud\Core\RequestBuilder;
use MediaCloud\Vendor\Google\Cloud\Core\RequestWrapper;
use MediaCloud\Vendor\Google\Cloud\Core\RestTrait;
use MediaCloud\Vendor\Google\Cloud\Core\Upload\AbstractUploader;
use MediaCloud\Vendor\Google\Cloud\Core\Upload\MultipartUploader;
...
use MediaCloud\Vendor\Google\CRC32\Builtin;
use MediaCloud\Vendor\Google\CRC32\CRC32;
