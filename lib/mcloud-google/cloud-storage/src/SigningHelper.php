...
class SigningHelper
{
     ...
     *        {@see \MediaCloud\Vendor\Google\Cloud\Storage\StorageObject::signedUrl()} for
     *        details.
     * @return string
     ...
     *        leading slash.
     * @param array $options Configuration options. See
     *        {@see \MediaCloud\Vendor\Google\Cloud\Storage\Bucket::generateSignedPostPolicyV4()} for details.
