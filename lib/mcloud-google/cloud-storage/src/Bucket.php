...
namespace MediaCloud\Vendor\Google\Cloud\Storage;
use MediaCloud\Vendor\Google\Cloud\Core\ArrayTrait;
use MediaCloud\Vendor\Google\Cloud\Core\Exception\GoogleException;
use MediaCloud\Vendor\Google\Cloud\Core\Exception\NotFoundException;
use MediaCloud\Vendor\Google\Cloud\Core\Exception\ServiceException;
use MediaCloud\Vendor\Google\Cloud\Core\Iam\Iam;
use MediaCloud\Vendor\Google\Cloud\Core\Iterator\ItemIterator;
use MediaCloud\Vendor\Google\Cloud\Core\Iterator\PageIterator;
...
class Bucket
{
     ...
     * see {@see MediaCloud\Vendor\Google\Cloud\Storage\StorageObject}.
     *
     * Example:
     * ```
     ...
     * please see {@see MediaCloud\Vendor\Google\Cloud\Storage\Notification}.
     *
     * Example:
     * ```
     ...
     *           {@see \MediaCloud\Vendor\Google\Cloud\Storage\Bucket::lockRetentionPolicy()}.
     ...
     * {@see \MediaCloud\Vendor\Google\Cloud\Storage\StorageClient::createBucket()} and
     * {@see \MediaCloud\Vendor\Google\Cloud\Storage\Bucket::update()}.
     *
     * Example:
     * ```
     ...
     * case when using {@see \MediaCloud\Vendor\Google\Cloud\Storage\Bucket::lifecycle()}.
     *
     * This builder is intended to be used in tandem with
     * {@see \MediaCloud\Vendor\Google\Cloud\Storage\StorageClient::createBucket()} and
     * {@see \MediaCloud\Vendor\Google\Cloud\Storage\Bucket::update()}.
     ...
     * {@see \MediaCloud\Vendor\Google\Cloud\Storage\Bucket::reload()} or
     * {@see \MediaCloud\Vendor\Google\Cloud\Storage\Bucket::info()}, for example).
     *
     * Example:
     * ```
     ...
     *        will expire. May provide an instance of {@see MediaCloud\Vendor\Google\Cloud\Core\Timestamp},
