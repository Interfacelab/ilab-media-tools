...
trait ValueMapperTrait
{
     ...
     *
     * @deprecated Use methods on {@see MediaCloud\Vendor\Google\Cloud\Core\TimeTrait}.
     *
     ...
     *        must provide a constructor compatible with {@see MediaCloud\Vendor\Google\Cloud\Core\Timestamp}.
