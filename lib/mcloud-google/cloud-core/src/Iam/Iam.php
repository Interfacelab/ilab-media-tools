...
namespace MediaCloud\Vendor\Google\Cloud\Core\Iam;
 ...
 *
 * Policies can be created using the {@see MediaCloud\Vendor\Google\Cloud\Core\Iam\PolicyBuilder}
...
class Iam
{
     ...
     * {@see \MediaCloud\Vendor\Google\Cloud\Core\Iam\Iam::reload()}.
     *
     * Example:
     * ```
     * $policy = $iam->policy();
     ...
     *         instance of {@see MediaCloud\Vendor\Google\Cloud\Core\Iam\PolicyBuilder}.
     * @param  array $options Configuration Options
     * @return array An array of policy data
