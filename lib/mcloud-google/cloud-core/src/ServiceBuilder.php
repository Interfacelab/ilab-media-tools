...
use MediaCloud\Vendor\Google\Cloud\BigQuery\BigQueryClient;
use MediaCloud\Vendor\Google\Cloud\Datastore\DatastoreClient;
use MediaCloud\Vendor\Google\Cloud\Firestore\FirestoreClient;
use MediaCloud\Vendor\Google\Cloud\Language\LanguageClient;
use MediaCloud\Vendor\Google\Cloud\Logging\LoggingClient;
use MediaCloud\Vendor\Google\Cloud\PubSub\PubSubClient;
use MediaCloud\Vendor\Google\Cloud\Spanner\SpannerClient;
use MediaCloud\Vendor\Google\Cloud\Speech\SpeechClient;
use MediaCloud\Vendor\Google\Cloud\Storage\StorageClient;
use MediaCloud\Vendor\Google\Cloud\Trace\TraceClient;
use MediaCloud\Vendor\Google\Cloud\Translate\V2\TranslateClient;
...
class ServiceBuilder
{
     ...
     * Example:
     * ```
     * use MediaCloud\Vendor\Google\Cloud\Core\ServiceBuilder;
     *
     ...
     *     {@see \MediaCloud\Vendor\Google\Cloud\Core\ServiceBuilder::__construct()} for the other available options.
     *
     *     @type bool $returnInt64AsObject If true, 64 bit integers will be
     *           returned as a {@see MediaCloud\Vendor\Google\Cloud\Core\Int64} object for 32 bit
     ...
     *        {@see \MediaCloud\Vendor\Google\Cloud\Core\ServiceBuilder::__construct()} for the available options.
