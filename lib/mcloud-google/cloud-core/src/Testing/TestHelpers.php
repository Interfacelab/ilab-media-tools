...
use MediaCloud\Vendor\Google\Cloud\Core\Testing\RegexFileFilter;
use MediaCloud\Vendor\Google\Cloud\Core\Testing\Snippet\Container;
use MediaCloud\Vendor\Google\Cloud\Core\Testing\Snippet\Coverage\Coverage;
use MediaCloud\Vendor\Google\Cloud\Core\Testing\Snippet\Coverage\Scanner;
use MediaCloud\Vendor\Google\Cloud\Core\Testing\Snippet\Parser\Parser;
use MediaCloud\Vendor\Google\Cloud\Core\Testing\System\SystemTestCase;
...
class TestHelpers
{
    ...
    public static function stub($extends, array $args = [], array $props = [])
    {
        ...
        $tpl = 'class %s extends %s {private $___props = \'%s\'; use \MediaCloud\Vendor\Google\Cloud\Core\Testing\StubTrait; }';
    ...
    public static function impl($trait, array $props = [])
    {
        ...
        $tpl = 'class %s {
            use %s;
            use \MediaCloud\Vendor\Google\Cloud\Core\Testing\StubTrait;
            private $___props = \'%s\';
            %s
    ...
    {
        putenv('GOOGLE_APPLICATION_CREDENTIALS='. \MediaCloud\Vendor\Google\Cloud\Core\Testing\Snippet\Fixtures::KEYFILE_STUB_FIXTURE());
