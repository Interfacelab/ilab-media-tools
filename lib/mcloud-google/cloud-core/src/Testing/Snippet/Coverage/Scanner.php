...
namespace MediaCloud\Vendor\Google\Cloud\Core\Testing\Snippet\Coverage;
use MediaCloud\Vendor\Google\Cloud\Core\Testing\FileListFilterIterator;
...
class Scanner implements ScannerInterface
{
     ...
     *
     * @return \MediaCloud\Vendor\Google\Cloud\Core\Testing\Snippet\Parser\Snippet[]
     *
     * @experimental
     * @internal
