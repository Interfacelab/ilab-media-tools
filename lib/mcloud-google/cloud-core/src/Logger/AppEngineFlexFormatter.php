...
namespace MediaCloud\Vendor\Google\Cloud\Core\Logger;
 ...
 *
 * If you are using Monolog 2.x, use {@see \MediaCloud\Vendor\Google\Cloud\Core\Logger\AppEngineFlexFormatterV2} instead.
 */
