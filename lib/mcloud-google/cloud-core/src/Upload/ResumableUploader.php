...
use MediaCloud\Vendor\Google\Cloud\Core\Exception\UploadException;
...
class ResumableUploader extends AbstractUploader
{
     ...
     * included in {@see \MediaCloud\Vendor\Google\Cloud\Core\Upload\ResumableUploader::upload()}
     * and {@see MediaCloud\Vendor\Google\Cloud\Core\Upload\ResumableUploader::createResumeUri{}}.
     *
     * @var array
     */
    protected $headers = [];
     ...
     * and may be obtained via {@see \MediaCloud\Vendor\Google\Cloud\Core\Exception\ServiceException::getMetadata()}.
     *
     * @return array
