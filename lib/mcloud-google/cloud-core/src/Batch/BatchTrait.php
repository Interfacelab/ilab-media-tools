...
namespace MediaCloud\Vendor\Google\Cloud\Core\Batch;
...
trait BatchTrait
{
     ...
     *           {@see \MediaCloud\Vendor\Google\Cloud\Core\Batch\BatchJob::__construct()} for
     *           more details.
     ...
     *           {@see MediaCloud\Vendor\Google\Cloud\Core\Batch\OpisClosureSerializer} if the
