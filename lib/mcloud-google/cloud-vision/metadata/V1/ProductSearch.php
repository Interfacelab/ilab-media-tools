...
class ProductSearch
{
    ...
    public static function initOnce() {
        ...
        if (static::$is_initialized == true) {
          return;
        } \MediaCloud\Vendor\GPBMetadata\Google\Api\Resource::initOnce(); \MediaCloud\Vendor\GPBMetadata\Google\Cloud\Vision\V1\Geometry::initOnce(); \MediaCloud\Vendor\GPBMetadata\Google\Cloud\Vision\V1\ProductSearchService::initOnce(); \MediaCloud\Vendor\GPBMetadata\Google\Protobuf\Timestamp::initOnce(); \MediaCloud\Vendor\GPBMetadata\Google\Api\Annotations::initOnce();
