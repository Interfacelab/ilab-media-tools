 ...
 */
class ListProductSetsResponse extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     * List of ProductSets.
     *
     ...
     *
     *     @type \MediaCloud\Vendor\Google\Cloud\Vision\V1\ProductSet[]|\Google\Protobuf\Internal\RepeatedField $product_sets
     *           List of ProductSets.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.vision.v1.ProductSet product_sets = 1;</code>
     * @param \MediaCloud\Vendor\Google\Cloud\Vision\V1\ProductSet[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setProductSets($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \MediaCloud\Vendor\Google\Cloud\Vision\V1\ProductSet::class);
