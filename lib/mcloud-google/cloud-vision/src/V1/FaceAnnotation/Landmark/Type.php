...
namespace MediaCloud\Vendor\Google\Cloud\Vision\V1\FaceAnnotation\Landmark;
...
class_alias(Type::class, \MediaCloud\Vendor\Google\Cloud\Vision\V1\FaceAnnotation_Landmark_Type::class);
