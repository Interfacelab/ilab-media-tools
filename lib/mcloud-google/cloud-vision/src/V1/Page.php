...
class Page extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
     ...
     *           Page height. For PDFs the unit is points. For images (including
     *           TIFFs) the unit is pixels.
     *     @type \MediaCloud\Vendor\Google\Cloud\Vision\V1\Block[]|\Google\Protobuf\Internal\RepeatedField $blocks
     *           List of blocks of text, images etc on this page.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.vision.v1.Block blocks = 4;</code>
     * @param \MediaCloud\Vendor\Google\Cloud\Vision\V1\Block[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setBlocks($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \MediaCloud\Vendor\Google\Cloud\Vision\V1\Block::class);
        $this->blocks = $arr;
