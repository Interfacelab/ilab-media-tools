 ...
 */
class PurgeProductsRequest extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     *     @type \MediaCloud\Vendor\Google\Cloud\Vision\V1\ProductSetPurgeConfig $product_set_purge_config
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1.ProductSetPurgeConfig product_set_purge_config = 2;</code>
     * @param \MediaCloud\Vendor\Google\Cloud\Vision\V1\ProductSetPurgeConfig $var
     * @return $this
     */
    public function setProductSetPurgeConfig($var)
    {
        GPBUtil::checkMessage($var, \MediaCloud\Vendor\Google\Cloud\Vision\V1\ProductSetPurgeConfig::class);
