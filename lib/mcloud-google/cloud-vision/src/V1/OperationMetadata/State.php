...
namespace MediaCloud\Vendor\Google\Cloud\Vision\V1\OperationMetadata;
...
class_alias(State::class, \MediaCloud\Vendor\Google\Cloud\Vision\V1\OperationMetadata_State::class);
