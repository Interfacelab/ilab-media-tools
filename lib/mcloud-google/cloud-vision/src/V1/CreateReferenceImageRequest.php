 ...
 */
class CreateReferenceImageRequest extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *           Format is
     *           `projects/PROJECT_ID/locations/LOC_ID/products/PRODUCT_ID`.
     *     @type \MediaCloud\Vendor\Google\Cloud\Vision\V1\ReferenceImage $reference_image
     *           Required. The reference image to create.
     *           If an image ID is specified, it is ignored.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1.ReferenceImage reference_image = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \MediaCloud\Vendor\Google\Cloud\Vision\V1\ReferenceImage $var
     * @return $this
     */
    public function setReferenceImage($var)
    {
        GPBUtil::checkMessage($var, \MediaCloud\Vendor\Google\Cloud\Vision\V1\ReferenceImage::class);
