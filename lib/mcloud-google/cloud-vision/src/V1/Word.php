 ...
 */
class Word extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *                1----0
     *             and the vertex order will still be (0, 1, 2, 3).
     *     @type \MediaCloud\Vendor\Google\Cloud\Vision\V1\Symbol[]|\Google\Protobuf\Internal\RepeatedField $symbols
     *           List of symbols in the word.
     *           The order of the symbols follows the natural reading order.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.vision.v1.Symbol symbols = 3;</code>
     * @param \MediaCloud\Vendor\Google\Cloud\Vision\V1\Symbol[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setSymbols($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \MediaCloud\Vendor\Google\Cloud\Vision\V1\Symbol::class);
        $this->symbols = $arr;
