 ...
 */
class WebPage extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
...
class_alias(WebPage::class, \MediaCloud\Vendor\Google\Cloud\Vision\V1\WebDetection_WebPage::class);
