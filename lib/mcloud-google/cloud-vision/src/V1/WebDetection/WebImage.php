 ...
 */
class WebImage extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
...
class_alias(WebImage::class, \MediaCloud\Vendor\Google\Cloud\Vision\V1\WebDetection_WebImage::class);
