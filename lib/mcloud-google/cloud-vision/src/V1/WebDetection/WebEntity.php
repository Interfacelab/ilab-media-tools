 ...
 */
class WebEntity extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     * Opaque entity ID.
     *
...
class_alias(WebEntity::class, \MediaCloud\Vendor\Google\Cloud\Vision\V1\WebDetection_WebEntity::class);
