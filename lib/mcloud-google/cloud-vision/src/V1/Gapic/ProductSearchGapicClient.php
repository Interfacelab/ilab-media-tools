...
namespace MediaCloud\Vendor\Google\Cloud\Vision\V1\Gapic;
use MediaCloud\Vendor\Google\ApiCore\ApiException;
use MediaCloud\Vendor\Google\ApiCore\CredentialsWrapper;
use MediaCloud\Vendor\Google\ApiCore\GapicClientTrait;
use MediaCloud\Vendor\Google\ApiCore\LongRunning\OperationsClient;
use MediaCloud\Vendor\Google\ApiCore\OperationResponse;
use MediaCloud\Vendor\Google\ApiCore\PathTemplate;
...
use MediaCloud\Vendor\Google\Cloud\Vision\V1\AddProductToProductSetRequest;
use MediaCloud\Vendor\Google\Cloud\Vision\V1\BatchOperationMetadata;
use MediaCloud\Vendor\Google\Cloud\Vision\V1\CreateProductRequest;
use MediaCloud\Vendor\Google\Cloud\Vision\V1\CreateProductSetRequest;
use MediaCloud\Vendor\Google\Cloud\Vision\V1\CreateReferenceImageRequest;
use MediaCloud\Vendor\Google\Cloud\Vision\V1\DeleteProductRequest;
use MediaCloud\Vendor\Google\Cloud\Vision\V1\DeleteProductSetRequest;
use MediaCloud\Vendor\Google\Cloud\Vision\V1\DeleteReferenceImageRequest;
use MediaCloud\Vendor\Google\Cloud\Vision\V1\GetProductRequest;
use MediaCloud\Vendor\Google\Cloud\Vision\V1\GetProductSetRequest;
use MediaCloud\Vendor\Google\Cloud\Vision\V1\GetReferenceImageRequest;
use MediaCloud\Vendor\Google\Cloud\Vision\V1\ImportProductSetsInputConfig;
use MediaCloud\Vendor\Google\Cloud\Vision\V1\ImportProductSetsRequest;
use MediaCloud\Vendor\Google\Cloud\Vision\V1\ImportProductSetsResponse;
use MediaCloud\Vendor\Google\Cloud\Vision\V1\ListProductSetsRequest;
use MediaCloud\Vendor\Google\Cloud\Vision\V1\ListProductSetsResponse;
use MediaCloud\Vendor\Google\Cloud\Vision\V1\ListProductsInProductSetRequest;
use MediaCloud\Vendor\Google\Cloud\Vision\V1\ListProductsInProductSetResponse;
use MediaCloud\Vendor\Google\Cloud\Vision\V1\ListProductsRequest;
use MediaCloud\Vendor\Google\Cloud\Vision\V1\ListProductsResponse;
use MediaCloud\Vendor\Google\Cloud\Vision\V1\ListReferenceImagesRequest;
use MediaCloud\Vendor\Google\Cloud\Vision\V1\ListReferenceImagesResponse;
use MediaCloud\Vendor\Google\Cloud\Vision\V1\Product;
use MediaCloud\Vendor\Google\Cloud\Vision\V1\ProductSet;
use MediaCloud\Vendor\Google\Cloud\Vision\V1\ProductSetPurgeConfig;
use MediaCloud\Vendor\Google\Cloud\Vision\V1\PurgeProductsRequest;
use MediaCloud\Vendor\Google\Cloud\Vision\V1\ReferenceImage;
use MediaCloud\Vendor\Google\Cloud\Vision\V1\RemoveProductFromProductSetRequest;
use MediaCloud\Vendor\Google\Cloud\Vision\V1\UpdateProductRequest;
use MediaCloud\Vendor\Google\Cloud\Vision\V1\UpdateProductSetRequest;
use MediaCloud\Vendor\Google\LongRunning\Operation;
use MediaCloud\Vendor\Google\Protobuf\FieldMask;
use MediaCloud\Vendor\Google\Protobuf\GPBEmpty;
...
class ProductSearchGapicClient
{
     ...
     *           {@see \MediaCloud\Vendor\Google\Auth\FetchAuthTokenInterface} object or
     *           {@see \MediaCloud\Vendor\Google\ApiCore\CredentialsWrapper} object. Note that when one of these
     *           objects are provided, any settings in $credentialsConfig will be ignored.
     *     @type array $credentialsConfig
     *           Options used to configure credentials, including auth token caching, for the client.
     *           For a full list of supporting configuration options, see
     *           {@see \MediaCloud\Vendor\Google\ApiCore\CredentialsWrapper::build()}.
     ...
     *           {@see \MediaCloud\Vendor\Google\ApiCore\Transport\TransportInterface} object. Note that when this
     ...
     *               'rest' => [...]
     *           ];
     *           See the {@see \MediaCloud\Vendor\Google\ApiCore\Transport\GrpcTransport::build()} and
     *           {@see \MediaCloud\Vendor\Google\ApiCore\Transport\RestTransport::build()} methods for the
     *           supported options.
     * }
     *
     ...
     *          {@see MediaCloud\Vendor\Google\ApiCore\RetrySettings} object, or an associative array
     *          of retry settings parameters. See the documentation on
     *          {@see MediaCloud\Vendor\Google\ApiCore\RetrySettings} for example usage.
     * }
     *
     * @return \MediaCloud\Vendor\Google\ApiCore\OperationResponse
     *
     ...
     * }
     *
     * @return \MediaCloud\Vendor\Google\ApiCore\PagedListResponse
     *
     * @throws ApiException if the remote call fails
     */
