 ...
 */
class OutputConfig extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     *     @type \MediaCloud\Vendor\Google\Cloud\Vision\V1\GcsDestination $gcs_destination
     *           The Google Cloud Storage location to write the output(s) to.
     *     @type int $batch_size
     *           The max number of response protos to put into each output JSON file on
     *           Google Cloud Storage.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1.GcsDestination gcs_destination = 1;</code>
     * @param \MediaCloud\Vendor\Google\Cloud\Vision\V1\GcsDestination $var
     * @return $this
     */
    public function setGcsDestination($var)
    {
        GPBUtil::checkMessage($var, \MediaCloud\Vendor\Google\Cloud\Vision\V1\GcsDestination::class);
