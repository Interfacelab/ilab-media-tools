...
class BatchAnnotateFilesRequest extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \MediaCloud\Vendor\Google\Cloud\Vision\V1\AnnotateFileRequest::class);
        $this->requests = $arr;
