...
namespace MediaCloud\Vendor\Google\Cloud\Vision\V1\BatchOperationMetadata;
...
class_alias(State::class, \MediaCloud\Vendor\Google\Cloud\Vision\V1\BatchOperationMetadata_State::class);
