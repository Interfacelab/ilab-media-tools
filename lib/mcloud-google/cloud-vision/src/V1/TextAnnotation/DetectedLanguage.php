 ...
 */
class DetectedLanguage extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
...
class_alias(DetectedLanguage::class, \MediaCloud\Vendor\Google\Cloud\Vision\V1\TextAnnotation_DetectedLanguage::class);
