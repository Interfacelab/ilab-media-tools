 ...
 */
class DetectedBreak extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     * Detected break type.
     *
...
class_alias(DetectedBreak::class, \MediaCloud\Vendor\Google\Cloud\Vision\V1\TextAnnotation_DetectedBreak::class);
