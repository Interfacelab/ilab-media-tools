 ...
 */
class ObjectAnnotation extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
...
class_alias(ObjectAnnotation::class, \MediaCloud\Vendor\Google\Cloud\Vision\V1\ProductSearchResults_ObjectAnnotation::class);
