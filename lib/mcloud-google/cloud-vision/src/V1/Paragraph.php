 ...
 */
class Paragraph extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *                1----0
     *             and the vertex order will still be (0, 1, 2, 3).
     *     @type \MediaCloud\Vendor\Google\Cloud\Vision\V1\Word[]|\Google\Protobuf\Internal\RepeatedField $words
     *           List of all words in this paragraph.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.vision.v1.Word words = 3;</code>
     * @param \MediaCloud\Vendor\Google\Cloud\Vision\V1\Word[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setWords($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \MediaCloud\Vendor\Google\Cloud\Vision\V1\Word::class);
        $this->words = $arr;
