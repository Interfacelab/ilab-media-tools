...
use MediaCloud\Vendor\Google\ApiCore\ArrayTrait;
use MediaCloud\Vendor\Google\ApiCore\RetrySettings;
use MediaCloud\Vendor\Google\Cloud\Vision\VisionHelpersTrait;
use MediaCloud\Vendor\Google\Cloud\Vision\V1\Feature\Type;
use MediaCloud\Vendor\Google\Cloud\Vision\V1\Gapic\ImageAnnotatorGapicClient;
...
class ImageAnnotatorClient extends ImageAnnotatorGapicClient
{
     ...
     * Example:
     * ```
     * use MediaCloud\Vendor\Google\Cloud\Vision\V1\Feature;
     * use MediaCloud\Vendor\Google\Cloud\Vision\V1\Feature\Type;
     *
     * $imageResource = fopen('path/to/image.jpg', 'r');
     ...
     * Example:
     * ```
     * use MediaCloud\Vendor\Google\Cloud\Vision\V1\ProductSearchClient;
     * use MediaCloud\Vendor\Google\Cloud\Vision\V1\ProductSearchParams;
     *
     * $imageContent = file_get_contents('path/to/image.jpg');
     ...
     *                              value will override the {@see MediaCloud\Vendor\Google\Cloud\Vision\V1\ProductSearchParams} in the
     *                              {@see MediaCloud\Vendor\Google\Cloud\Vision\V1\ImageContext} instance if provided.
     * @param array $optionalArgs   {
     *     Configuration Options.
     *
     *     @type ImageContext        $imageContext  Additional context that may accompany the image.
