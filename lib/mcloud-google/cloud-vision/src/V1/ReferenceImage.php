 ...
 */
class ReferenceImage extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *           Required. The Google Cloud Storage URI of the reference image.
     *           The URI must start with `gs://`.
     *     @type \MediaCloud\Vendor\Google\Cloud\Vision\V1\BoundingPoly[]|\Google\Protobuf\Internal\RepeatedField $bounding_polys
     *           Optional. Bounding polygons around the areas of interest in the reference image.
     *           If this field is empty, the system will try to detect regions of
     *           interest. At most 10 bounding polygons will be used.
     *           The provided shape is converted into a non-rotated rectangle. Once
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.vision.v1.BoundingPoly bounding_polys = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \MediaCloud\Vendor\Google\Cloud\Vision\V1\BoundingPoly[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setBoundingPolys($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \MediaCloud\Vendor\Google\Cloud\Vision\V1\BoundingPoly::class);
