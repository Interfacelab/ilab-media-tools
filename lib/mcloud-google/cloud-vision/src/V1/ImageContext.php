 ...
 */
class ImageContext extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     * Not used.
     *
     ...
     *
     *     @type \MediaCloud\Vendor\Google\Cloud\Vision\V1\LatLongRect $lat_long_rect
     *           Not used.
     ...
     *           error if one or more of the specified languages is not one of the
     *           [supported languages](https://cloud.google.com/vision/docs/languages).
     *     @type \MediaCloud\Vendor\Google\Cloud\Vision\V1\CropHintsParams $crop_hints_params
     *           Parameters for crop hints annotation request.
     *     @type \MediaCloud\Vendor\Google\Cloud\Vision\V1\ProductSearchParams $product_search_params
     *           Parameters for product search.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1.LatLongRect lat_long_rect = 1;</code>
     * @param \MediaCloud\Vendor\Google\Cloud\Vision\V1\LatLongRect $var
     * @return $this
     */
    public function setLatLongRect($var)
    {
        GPBUtil::checkMessage($var, \MediaCloud\Vendor\Google\Cloud\Vision\V1\LatLongRect::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1.CropHintsParams crop_hints_params = 4;</code>
     * @param \MediaCloud\Vendor\Google\Cloud\Vision\V1\CropHintsParams $var
     * @return $this
     */
    public function setCropHintsParams($var)
    {
        GPBUtil::checkMessage($var, \MediaCloud\Vendor\Google\Cloud\Vision\V1\CropHintsParams::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1.ProductSearchParams product_search_params = 5;</code>
     * @param \MediaCloud\Vendor\Google\Cloud\Vision\V1\ProductSearchParams $var
     * @return $this
     */
    public function setProductSearchParams($var)
    {
        GPBUtil::checkMessage($var, \MediaCloud\Vendor\Google\Cloud\Vision\V1\ProductSearchParams::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1.WebDetectionParams web_detection_params = 6;</code>
     * @param \MediaCloud\Vendor\Google\Cloud\Vision\V1\WebDetectionParams $var
     * @return $this
     */
