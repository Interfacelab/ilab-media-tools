 ...
 */
class ImportProductSetsRequest extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *           Required. The project in which the ProductSets should be imported.
     *           Format is `projects/PROJECT_ID/locations/LOC_ID`.
     *     @type \MediaCloud\Vendor\Google\Cloud\Vision\V1\ImportProductSetsInputConfig $input_config
     *           Required. The input content for the list of requests.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1.ImportProductSetsInputConfig input_config = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \MediaCloud\Vendor\Google\Cloud\Vision\V1\ImportProductSetsInputConfig $var
     * @return $this
     */
    public function setInputConfig($var)
    {
        GPBUtil::checkMessage($var, \MediaCloud\Vendor\Google\Cloud\Vision\V1\ImportProductSetsInputConfig::class);
