 ...
 */
class ImageAnnotatorGrpcClient extends \MediaCloud\Vendor\Grpc\BaseStub {
    ...
    public function BatchAnnotateImages(\MediaCloud\Vendor\Google\Cloud\Vision\V1\BatchAnnotateImagesRequest $argument,
      $metadata = [], $options = []) {
        ...
        $argument,
        ['\MediaCloud\Vendor\Google\Cloud\Vision\V1\BatchAnnotateImagesResponse', 'decode'],
        $metadata, $options);
    }
    ...
    public function BatchAnnotateFiles(\MediaCloud\Vendor\Google\Cloud\Vision\V1\BatchAnnotateFilesRequest $argument,
      $metadata = [], $options = []) {
        ...
        $argument,
        ['\MediaCloud\Vendor\Google\Cloud\Vision\V1\BatchAnnotateFilesResponse', 'decode'],
        $metadata, $options);
    }
