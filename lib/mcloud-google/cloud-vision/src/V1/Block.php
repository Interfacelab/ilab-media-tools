 ...
 */
class Block extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *                   1----0
     *             and the vertex order will still be (0, 1, 2, 3).
     *     @type \MediaCloud\Vendor\Google\Cloud\Vision\V1\Paragraph[]|\Google\Protobuf\Internal\RepeatedField $paragraphs
     *           List of paragraphs in this block (if this blocks is of type text).
     *     @type int $block_type
     *           Detected block type (text, image etc) for this block.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.vision.v1.Paragraph paragraphs = 3;</code>
     * @param \MediaCloud\Vendor\Google\Cloud\Vision\V1\Paragraph[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setParagraphs($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \MediaCloud\Vendor\Google\Cloud\Vision\V1\Paragraph::class);
        $this->paragraphs = $arr;
