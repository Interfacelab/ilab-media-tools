 ...
 */
class ProductSearchGrpcClient extends \MediaCloud\Vendor\Grpc\BaseStub {

    /**
     * @param string $hostname hostname
     * @param array $opts channel options
     * @param \MediaCloud\Vendor\Grpc\Channel $channel (optional) re-use channel object
     */
    ...
    public function CreateProductSet(\MediaCloud\Vendor\Google\Cloud\Vision\V1\CreateProductSetRequest $argument,
      $metadata = [], $options = []) {
        ...
        $argument,
        ['\MediaCloud\Vendor\Google\Cloud\Vision\V1\ProductSet', 'decode'],
        $metadata, $options);
    }
    ...
    public function ListProductSets(\MediaCloud\Vendor\Google\Cloud\Vision\V1\ListProductSetsRequest $argument,
      $metadata = [], $options = []) {
        ...
        $argument,
        ['\MediaCloud\Vendor\Google\Cloud\Vision\V1\ListProductSetsResponse', 'decode'],
        $metadata, $options);
    }
    ...
    public function DeleteProductSet(\MediaCloud\Vendor\Google\Cloud\Vision\V1\DeleteProductSetRequest $argument,
      $metadata = [], $options = []) {
        ...
        $argument,
        ['\MediaCloud\Vendor\Google\Protobuf\GPBEmpty', 'decode'],
        $metadata, $options);
    }
    ...
    public function CreateProduct(\MediaCloud\Vendor\Google\Cloud\Vision\V1\CreateProductRequest $argument,
      $metadata = [], $options = []) {
        ...
        $argument,
        ['\MediaCloud\Vendor\Google\Cloud\Vision\V1\Product', 'decode'],
        $metadata, $options);
    }
    ...
    public function ListProducts(\MediaCloud\Vendor\Google\Cloud\Vision\V1\ListProductsRequest $argument,
      $metadata = [], $options = []) {
        ...
        $argument,
        ['\MediaCloud\Vendor\Google\Cloud\Vision\V1\ListProductsResponse', 'decode'],
        $metadata, $options);
    }
    ...
    public function CreateReferenceImage(\MediaCloud\Vendor\Google\Cloud\Vision\V1\CreateReferenceImageRequest $argument,
      $metadata = [], $options = []) {
        ...
        $argument,
        ['\MediaCloud\Vendor\Google\Cloud\Vision\V1\ReferenceImage', 'decode'],
        $metadata, $options);
    }
    ...
    public function ListReferenceImages(\MediaCloud\Vendor\Google\Cloud\Vision\V1\ListReferenceImagesRequest $argument,
      $metadata = [], $options = []) {
        ...
        $argument,
        ['\MediaCloud\Vendor\Google\Cloud\Vision\V1\ListReferenceImagesResponse', 'decode'],
        $metadata, $options);
    }
    ...
    public function ListProductsInProductSet(\MediaCloud\Vendor\Google\Cloud\Vision\V1\ListProductsInProductSetRequest $argument,
      $metadata = [], $options = []) {
        ...
        $argument,
        ['\MediaCloud\Vendor\Google\Cloud\Vision\V1\ListProductsInProductSetResponse', 'decode'],
        $metadata, $options);
    }
    ...
    public function ImportProductSets(\MediaCloud\Vendor\Google\Cloud\Vision\V1\ImportProductSetsRequest $argument,
      $metadata = [], $options = []) {
        ...
        $argument,
        ['\MediaCloud\Vendor\Google\LongRunning\Operation', 'decode'],
        $metadata, $options);
    }
