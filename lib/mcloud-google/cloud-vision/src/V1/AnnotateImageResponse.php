 ...
 */
class AnnotateImageResponse extends \MediaCloud\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     *     @type \MediaCloud\Vendor\Google\Cloud\Vision\V1\FaceAnnotation[]|\Google\Protobuf\Internal\RepeatedField $face_annotations
     *           If present, face detection has completed successfully.
     *     @type \MediaCloud\Vendor\Google\Cloud\Vision\V1\EntityAnnotation[]|\Google\Protobuf\Internal\RepeatedField $landmark_annotations
     *           If present, landmark detection has completed successfully.
     *     @type \MediaCloud\Vendor\Google\Cloud\Vision\V1\EntityAnnotation[]|\Google\Protobuf\Internal\RepeatedField $logo_annotations
     *           If present, logo detection has completed successfully.
     *     @type \MediaCloud\Vendor\Google\Cloud\Vision\V1\EntityAnnotation[]|\Google\Protobuf\Internal\RepeatedField $label_annotations
     *           If present, label detection has completed successfully.
     *     @type \MediaCloud\Vendor\Google\Cloud\Vision\V1\LocalizedObjectAnnotation[]|\Google\Protobuf\Internal\RepeatedField $localized_object_annotations
     *           If present, localized object detection has completed successfully.
     *           This will be sorted descending by confidence score.
     *     @type \MediaCloud\Vendor\Google\Cloud\Vision\V1\EntityAnnotation[]|\Google\Protobuf\Internal\RepeatedField $text_annotations
     *           If present, text (OCR) detection has completed successfully.
     *     @type \MediaCloud\Vendor\Google\Cloud\Vision\V1\TextAnnotation $full_text_annotation
     *           If present, text (OCR) detection or document (OCR) text detection has
     *           completed successfully.
     *           This annotation provides the structural hierarchy for the OCR detected
     *           text.
     *     @type \MediaCloud\Vendor\Google\Cloud\Vision\V1\SafeSearchAnnotation $safe_search_annotation
     *           If present, safe-search annotation has completed successfully.
     *     @type \MediaCloud\Vendor\Google\Cloud\Vision\V1\ImageProperties $image_properties_annotation
     *           If present, image properties were extracted successfully.
     *     @type \MediaCloud\Vendor\Google\Cloud\Vision\V1\CropHintsAnnotation $crop_hints_annotation
     *           If present, crop hints have completed successfully.
     *     @type \MediaCloud\Vendor\Google\Cloud\Vision\V1\WebDetection $web_detection
     *           If present, web detection has completed successfully.
     *     @type \MediaCloud\Vendor\Google\Cloud\Vision\V1\ProductSearchResults $product_search_results
     *           If present, product search has completed successfully.
     *     @type \MediaCloud\Vendor\Google\Rpc\Status $error
     *           If set, represents the error message for the operation.
     *           Note that filled-in image annotations are guaranteed to be
     *           correct, even when `error` is set.
     *     @type \MediaCloud\Vendor\Google\Cloud\Vision\V1\ImageAnnotationContext $context
     *           If present, contextual information is needed to understand where this image
     *           comes from.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.vision.v1.FaceAnnotation face_annotations = 1;</code>
     * @param \MediaCloud\Vendor\Google\Cloud\Vision\V1\FaceAnnotation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setFaceAnnotations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \MediaCloud\Vendor\Google\Cloud\Vision\V1\FaceAnnotation::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.vision.v1.EntityAnnotation landmark_annotations = 2;</code>
     * @param \MediaCloud\Vendor\Google\Cloud\Vision\V1\EntityAnnotation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setLandmarkAnnotations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \MediaCloud\Vendor\Google\Cloud\Vision\V1\EntityAnnotation::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.vision.v1.LocalizedObjectAnnotation localized_object_annotations = 22;</code>
     * @param \MediaCloud\Vendor\Google\Cloud\Vision\V1\LocalizedObjectAnnotation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setLocalizedObjectAnnotations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \MediaCloud\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \MediaCloud\Vendor\Google\Cloud\Vision\V1\LocalizedObjectAnnotation::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1.TextAnnotation full_text_annotation = 12;</code>
     * @param \MediaCloud\Vendor\Google\Cloud\Vision\V1\TextAnnotation $var
     * @return $this
     */
    public function setFullTextAnnotation($var)
    {
        GPBUtil::checkMessage($var, \MediaCloud\Vendor\Google\Cloud\Vision\V1\TextAnnotation::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1.SafeSearchAnnotation safe_search_annotation = 6;</code>
     * @param \MediaCloud\Vendor\Google\Cloud\Vision\V1\SafeSearchAnnotation $var
     * @return $this
     */
    public function setSafeSearchAnnotation($var)
    {
        GPBUtil::checkMessage($var, \MediaCloud\Vendor\Google\Cloud\Vision\V1\SafeSearchAnnotation::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1.ImageProperties image_properties_annotation = 8;</code>
     * @param \MediaCloud\Vendor\Google\Cloud\Vision\V1\ImageProperties $var
     * @return $this
     */
    public function setImagePropertiesAnnotation($var)
    {
        GPBUtil::checkMessage($var, \MediaCloud\Vendor\Google\Cloud\Vision\V1\ImageProperties::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1.CropHintsAnnotation crop_hints_annotation = 11;</code>
     * @param \MediaCloud\Vendor\Google\Cloud\Vision\V1\CropHintsAnnotation $var
     * @return $this
     */
    public function setCropHintsAnnotation($var)
    {
        GPBUtil::checkMessage($var, \MediaCloud\Vendor\Google\Cloud\Vision\V1\CropHintsAnnotation::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1.WebDetection web_detection = 13;</code>
     * @param \MediaCloud\Vendor\Google\Cloud\Vision\V1\WebDetection $var
     * @return $this
     */
    public function setWebDetection($var)
    {
        GPBUtil::checkMessage($var, \MediaCloud\Vendor\Google\Cloud\Vision\V1\WebDetection::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1.ProductSearchResults product_search_results = 14;</code>
     * @param \MediaCloud\Vendor\Google\Cloud\Vision\V1\ProductSearchResults $var
     * @return $this
     */
    public function setProductSearchResults($var)
    {
        GPBUtil::checkMessage($var, \MediaCloud\Vendor\Google\Cloud\Vision\V1\ProductSearchResults::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1.ImageAnnotationContext context = 21;</code>
     * @param \MediaCloud\Vendor\Google\Cloud\Vision\V1\ImageAnnotationContext $var
     * @return $this
     */
    public function setContext($var)
    {
        GPBUtil::checkMessage($var, \MediaCloud\Vendor\Google\Cloud\Vision\V1\ImageAnnotationContext::class);
        $this->context = $var;
