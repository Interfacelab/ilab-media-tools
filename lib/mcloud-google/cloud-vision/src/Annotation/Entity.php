...
namespace MediaCloud\Vendor\Google\Cloud\Vision\Annotation;
use MediaCloud\Vendor\Google\Cloud\Core\CallTrait;
...
class Entity extends AbstractFeature
{
     ...
     *
     * This class is created internally by {@see MediaCloud\Vendor\Google\Cloud\Vision\Annotation} and is used to represent various
     * annotation feature results.
     *
     * This class should not be instantiated externally.
     *
     * Entities are returned by {@see \MediaCloud\Vendor\Google\Cloud\Vision\Annotation::landmarks()},
     * {@see \MediaCloud\Vendor\Google\Cloud\Vision\Annotation::logos()},
     * {@see \MediaCloud\Vendor\Google\Cloud\Vision\Annotation::labels()} and
     * {@see \MediaCloud\Vendor\Google\Cloud\Vision\Annotation::text()}.
     *
