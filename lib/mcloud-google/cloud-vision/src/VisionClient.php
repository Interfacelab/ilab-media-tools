...
namespace MediaCloud\Vendor\Google\Cloud\Vision;
use MediaCloud\Vendor\Google\Auth\FetchAuthTokenInterface;
use MediaCloud\Vendor\Google\Cloud\Core\ClientTrait;
use MediaCloud\Vendor\Google\Cloud\Core\ValidateTrait;
use MediaCloud\Vendor\Google\Cloud\Storage\StorageObject;
use MediaCloud\Vendor\Google\Cloud\Vision\Connection\Rest;
 ...
 * the time to familiarize yourself with {@see MediaCloud\Vendor\Google\Cloud\Vision\V1\ImageAnnotatorClient}.
 *
 * Example:
 * ```
 * use MediaCloud\Vendor\Google\Cloud\Vision\VisionClient;
 *
...
class VisionClient
{
     ...
     * }
     * @throws MediaCloud\Vendor\Google\Cloud\Core\Exception\GoogleException
     */
    ...
    /**
     * Create an instance of {@see MediaCloud\Vendor\Google\Cloud\Vision\Image} with required features and options.
     *
     ...
     * {@see \MediaCloud\Vendor\Google\Cloud\Vision\VisionClient::images()} may be quicker and
     * simpler to use.
     *
     * This method will not perform any service requests, and is meant to be
     * used to configure a request prior to calling
     * {@see \MediaCloud\Vendor\Google\Cloud\Vision\VisionClient::annotate()}.
     *
     * For more information, including best practices and examples detailing
     * other usage such as `$imageContext`, see {@see \MediaCloud\Vendor\Google\Cloud\Vision\Image::__construct()}.
     *
     * Example:
     * ```
     ...
     *         web location, or an instance of {@see MediaCloud\Vendor\Google\Cloud\Storage\StorageObject}.
     ...
     * @param  array $options See {@see \MediaCloud\Vendor\Google\Cloud\Vision\Image::__construct()} for
    ...
    /**
     * Create an array of type {@see MediaCloud\Vendor\Google\Cloud\Vision\Image} with required features and options set for
     ...
     * {@see \MediaCloud\Vendor\Google\Cloud\Vision\VisionClient::image()} is a better choice.
     *
     * This method will not perform any service requests, and is meant to be
     * used to configure a request prior to calling
     * {@see \MediaCloud\Vendor\Google\Cloud\Vision\VisionClient::annotateBatch()}.
     *
     * For more information, including best practices and examples detailing
     * other usage such as `$imageContext`, see {@see \MediaCloud\Vendor\Google\Cloud\Vision\Image::__construct()}.
     *
     ...
     *         {@see MediaCloud\Vendor\Google\Cloud\Storage\StorageObject}.
     ...
     *         {@see MediaCloud\Vendor\Google\Cloud\Vision\Image}.
     * @param  array $options Configuration Options
     * @return Annotation[]
     */
