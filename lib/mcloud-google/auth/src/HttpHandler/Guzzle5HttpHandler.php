...
namespace MediaCloud\Vendor\Google\Auth\HttpHandler;

use Exception;
use MediaCloud\Vendor\GuzzleHttp\ClientInterface;
use MediaCloud\Vendor\GuzzleHttp\Message\ResponseInterface as Guzzle5ResponseInterface;
...
class Guzzle5HttpHandler
{
    ...
    {
        if (!class_exists('MediaCloud\Vendor\GuzzleHttp\Promise\Promise')) {
