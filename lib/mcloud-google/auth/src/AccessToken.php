...
use DateTime;
use Exception;
use MediaCloud\Vendor\Firebase\JWT\ExpiredException;
use MediaCloud\Vendor\Firebase\JWT\JWT;
use MediaCloud\Vendor\Firebase\JWT\SignatureInvalidException;
use MediaCloud\Vendor\Google\Auth\Cache\MemoryCacheItemPool;
...
class AccessToken
{
    ...
    private function checkAndInitializePhpsec()
    {
        ...
        if (!class_exists('MediaCloud\Vendor\phpseclib\Crypt\RSA')) {
    ...
    {
        $class = class_exists('MediaCloud\Vendor\Firebase\JWT\JWT')
