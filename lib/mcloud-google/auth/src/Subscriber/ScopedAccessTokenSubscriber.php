...
namespace MediaCloud\Vendor\Google\Auth\Subscriber;
use MediaCloud\Vendor\Google\Auth\CacheTrait;
use MediaCloud\Vendor\GuzzleHttp\Event\BeforeEvent;
use MediaCloud\Vendor\GuzzleHttp\Event\RequestEvents;
use MediaCloud\Vendor\GuzzleHttp\Event\SubscriberInterface;
...
class ScopedAccessTokenSubscriber implements SubscriberInterface
{
     ...
     * use MediaCloud\Vendor\Google\Auth\Subscriber\ScopedAccessTokenSubscriber;
     ...
     *     $scope,
     *     ['prefix' => 'MediaCloud\Vendor\Google\Auth\ScopedAccessToken::'],
     *     $cache = new Memcache()
     * );
     *
     * $client = new Client([
