...
use MediaCloud\Vendor\Google\Auth\Credentials\InsecureCredentials;
    ...
    UpdateMetadataInterface
{
    ...
    {
        if (defined('MediaCloud\Vendor\GuzzleHttp\ClientInterface::MAJOR_VERSION')) {
     ...
     * @return \MediaCloud\Vendor\GuzzleHttp\Client
     */
    public static function makeHttpClient(
        ...
        if (self::getGuzzleMajorVersion() === 5) {
            $client = new \MediaCloud\Vendor\GuzzleHttp\Client($httpClientOptions);
        ...
        $stack = \MediaCloud\Vendor\GuzzleHttp\HandlerStack::create();
        $stack->push($middleware);

        return new \MediaCloud\Vendor\GuzzleHttp\Client([
            'handler' => $stack,
            'auth' => 'google_auth',
        ] + $httpClientOptions);
    }
