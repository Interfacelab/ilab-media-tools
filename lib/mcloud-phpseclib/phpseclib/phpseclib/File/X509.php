...
namespace MediaCloud\Vendor\phpseclib\File;
use MediaCloud\Vendor\phpseclib\Crypt\Hash;
use MediaCloud\Vendor\phpseclib\Crypt\Random;
use MediaCloud\Vendor\phpseclib\Crypt\RSA;
use MediaCloud\Vendor\phpseclib\File\ASN1\Element;
use MediaCloud\Vendor\phpseclib\Math\BigInteger;
use DateTime;
use DateTimeZone;
...
class X509
{
    ...
    /**#@+
     * @access public
     * @see \MediaCloud\Vendor\phpseclib\File\X509::getDN()
    */
    /**
    ...
    /**#@+
     * @access public
     * @see \MediaCloud\Vendor\phpseclib\File\X509::saveX509()
     * @see \MediaCloud\Vendor\phpseclib\File\X509::saveCSR()
     * @see \MediaCloud\Vendor\phpseclib\File\X509::saveCRL()
    */
    /**
     * Save as PEM
     *
     ...
     *
     * There's no guarantee \MediaCloud\Vendor\phpseclib\File\X509 is going to re-encode an X.509 cert in the same way it was originally
     ...
     * Default Constructor.
     *
     * @return \MediaCloud\Vendor\phpseclib\File\X509
     * @access public
     */
    function __construct()
    {
        ...
        */
        ...
        $AdministrationDomainName = array(
            'type'     => ASN1::TYPE_CHOICE,
            // if class isn't present it's assumed to be \MediaCloud\Vendor\phpseclib\File\ASN1::CLASS_UNIVERSAL or
            // (if constant is present) \MediaCloud\Vendor\phpseclib\File\ASN1::CLASS_CONTEXT_SPECIFIC
        ...
        $EDIPartyName = array(
            ...
            'children' => array(
                 ...
                 // partyName is technically required but \MediaCloud\Vendor\phpseclib\File\ASN1 doesn't currently support non-optional constants and
    ...
    function saveX509($cert, $format = self::FORMAT_PEM)
    {
        ...
        /* in the case of policyQualifiers/qualifier, the type has to be \MediaCloud\Vendor\phpseclib\File\ASN1::TYPE_IA5_STRING. \MediaCloud\Vendor\phpseclib\File\ASN1::TYPE_PRINTABLE_STRING will cause OpenSSL's X.509 parser to spit out random
           characters.
         */
                    ...
                    case 'id-ce-certificatePolicies':
                        for ($j = 0; $j < count($value); $j++) {
                            ...
                            for ($k = 0; $k < count($value[$j]['policyQualifiers']); $k++) {
                                ...
                                $subvalue = &$value[$j]['policyQualifiers'][$k]['qualifier'];
                                if ($map !== false) {
                                    // by default \MediaCloud\Vendor\phpseclib\File\ASN1 will try to render qualifier as a \MediaCloud\Vendor\phpseclib\File\ASN1::TYPE_IA5_STRING since it's
                                    // actual type is \MediaCloud\Vendor\phpseclib\File\ASN1::TYPE_ANY
    ...
    {
        if (!is_string($extnId)) { // eg. if it's a \MediaCloud\Vendor\phpseclib\File\ASN1\Element object
            return true;
        }
     ...
     * Set public key
     *
     * Key needs to be a \MediaCloud\Vendor\phpseclib\Crypt\RSA object
     *
     * @param object $key
     * @access public
     * @return bool
     ...
     * Gets the public key
     *
     * Returns a \MediaCloud\Vendor\phpseclib\Crypt\RSA object or a false.
     *
     * @access public
     * @return mixed
     */
     ...
     *
     * @param \MediaCloud\Vendor\phpseclib\File\X509 $issuer
     * @param \MediaCloud\Vendor\phpseclib\File\X509 $subject
    ...
    function sign($issuer, $subject, $signatureAlgorithm = 'sha1WithRSAEncryption')
    {
        ...
        if (isset($subject->domains) && count($subject->domains)) {
            $altName = array_map(array('\MediaCloud\Vendor\phpseclib\File\X509', '_dnsName'), $subject->domains);
        }
        ...
        // save $tbsCertificate in case there are any \MediaCloud\Vendor\phpseclib\File\ASN1\Element objects in it
    ...
    function signCSR($signatureAlgorithm = 'sha1WithRSAEncryption')
    {
        ...
        // resync $this->signatureSubject
        // save $certificationRequestInfo in case there are any \MediaCloud\Vendor\phpseclib\File\ASN1\Element objects in it
    ...
    function signSPKAC($signatureAlgorithm = 'sha1WithRSAEncryption')
    {
        ...
        // resync $this->signatureSubject
        // save $publicKeyAndChallenge in case there are any \MediaCloud\Vendor\phpseclib\File\ASN1\Element objects in it
     ...
     *
     * @param \MediaCloud\Vendor\phpseclib\File\X509 $issuer
     * @param \MediaCloud\Vendor\phpseclib\File\X509 $crl
     * @param string $signatureAlgorithm optional
     * @access public
     * @return mixed
     */
    function signCRL($issuer, $crl, $signatureAlgorithm = 'sha1WithRSAEncryption')
    {
        ...
        // resync $this->signatureSubject
        // save $tbsCertList in case there are any \MediaCloud\Vendor\phpseclib\File\ASN1\Element objects in it
        $tbsCertList = $this->currentCert['tbsCertList'];
     ...
     *
     * @param \MediaCloud\Vendor\phpseclib\File\X509 $key
     * @param string $signatureAlgorithm
     * @access public
     * @return mixed
     */
     ...
     * - Key object
     * - \MediaCloud\Vendor\phpseclib\File\X509 object with public or private key defined
     * - Certificate or CSR array
     * - \MediaCloud\Vendor\phpseclib\File\ASN1\Element object
     * - PEM or DER string
     *
    ...
    function computeKeyIdentifier($key = null, $method = 1)
    {
        ...
        switch (true) {
            ...
            case $key instanceof X509:
                ...
                return false;
            default: // Should be a key object (i.e.: \MediaCloud\Vendor\phpseclib\Crypt\RSA).
