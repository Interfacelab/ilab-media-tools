 ...
 *
 *    $sftp = new \MediaCloud\Vendor\phpseclib\Net\SFTP('www.domain.tld');
...
class SFTP extends SSH2
{
     ...
     *
     * \MediaCloud\Vendor\phpseclib\Net\SSH2::exec() uses 0 and \MediaCloud\Vendor\phpseclib\Net\SSH2::read() / \MediaCloud\Vendor\phpseclib\Net\SSH2::write() use 1.
     *
    ...
    /**#@+
     * @access public
     * @see \MediaCloud\Vendor\phpseclib\Net\SFTP::put()
    */
    /**
     ...
     * @param int $port
     * @param int $timeout
     * @return \MediaCloud\Vendor\phpseclib\Net\SFTP
     * @access public
     */
    function __construct($host, $port = 22, $timeout = 10)
    {
        ...
        // the order, in this case, matters quite a lot - see \MediaCloud\Vendor\phpseclib\Net\SFTP::_parseAttributes() to understand why
        ...
        // see \MediaCloud\Vendor\phpseclib\Net\SFTP::_parseLongname() for an explanation
    ...
    function _init_sftp_connection()
    {
        ...
        /*
         ...
         in draft-ietf-secsh-filexfer-13 would be quite impossible.  As such, what \MediaCloud\Vendor\phpseclib\Net\SFTP would do is close the
    ...
    function chdir($dir)
    {
        ...
        // see \MediaCloud\Vendor\phpseclib\Net\SFTP::nlist() for a more thorough explanation of the following
        $response = $this->_get_sftp_packet();
        switch ($this->packet_type) {
     ...
     * Returns general information about a file or symbolic link
     *
     * Determines information without calling \MediaCloud\Vendor\phpseclib\Net\SFTP::realpath().
     ...
     *
     * By default, \MediaCloud\Vendor\phpseclib\Net\SFTP::put() does not read from the local filesystem.  $data is dumped directly into $remote_file.
     * So, for example, if you set $data to 'filename.ext' and then do \MediaCloud\Vendor\phpseclib\Net\SFTP::get(), you will get a file, twelve bytes
     ...
     * @return bool
     * @access public
     * @internal ASCII mode for SFTPv4/5/6 can be supported by adding a new function - \MediaCloud\Vendor\phpseclib\Net\SFTP::setMode().
     */
