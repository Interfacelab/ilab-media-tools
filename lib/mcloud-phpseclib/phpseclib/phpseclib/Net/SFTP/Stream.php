...
namespace MediaCloud\Vendor\phpseclib\Net\SFTP;
use MediaCloud\Vendor\phpseclib\Crypt\RSA;
use MediaCloud\Vendor\phpseclib\Net\SFTP;
...
class Stream
{
    ...
    function _parse_path($path)
    {
        ...
        if ($host[0] == '$') {
            ...
            // casting $pass to a string is necessary in the event that it's a \MediaCloud\Vendor\phpseclib\Crypt\RSA object
     ...
     * If newname exists, it will be overwritten.  This is a departure from what \MediaCloud\Vendor\phpseclib\Net\SFTP
     * does.
     *
     ...
     * Flushes the output
     *
     * See <http://php.net/fflush>. Always returns true because \MediaCloud\Vendor\phpseclib\Net\SFTP doesn't cache stuff before writing
     *
     * @return bool
     * @access public
     */
     ...
     *
     * Ignores the STREAM_URL_STAT_QUIET flag because the entirety of \MediaCloud\Vendor\phpseclib\Net\SFTP\Stream is quiet by default
     ...
     * The other two aren't supported because of limitations in \MediaCloud\Vendor\phpseclib\Net\SFTP.
     *
     * @param int $option
     * @param int $arg1
     * @param int $arg2
