 ...
 *
 *    $ssh = new \MediaCloud\Vendor\phpseclib\Net\SSH2('www.domain.tld');
 ...
 *    include 'vendor/autoload.php';
 *
 *    $key = new \MediaCloud\Vendor\phpseclib\Crypt\RSA();
...
namespace MediaCloud\Vendor\phpseclib\Net;
use MediaCloud\Vendor\phpseclib\Crypt\Base;
use MediaCloud\Vendor\phpseclib\Crypt\Blowfish;
use MediaCloud\Vendor\phpseclib\Crypt\Hash;
use MediaCloud\Vendor\phpseclib\Crypt\Random;
use MediaCloud\Vendor\phpseclib\Crypt\RC4;
use MediaCloud\Vendor\phpseclib\Crypt\Rijndael;
use MediaCloud\Vendor\phpseclib\Crypt\RSA;
use MediaCloud\Vendor\phpseclib\Crypt\TripleDES;
use MediaCloud\Vendor\phpseclib\Crypt\Twofish;
use MediaCloud\Vendor\phpseclib\Math\BigInteger; // Used to do Diffie-Hellman key exchange and DSA/RSA signature verification.
use MediaCloud\Vendor\phpseclib\System\SSH\Agent;
...
class SSH2
{
     ...
     *
     * @see \MediaCloud\Vendor\phpseclib\Net\SSH2::bitmap
     * @access private
     */
     ...
     *     the other side.
     *
     * @see \MediaCloud\Vendor\phpseclib\Net\SSH2::_send_channel_packet()
     * @see \MediaCloud\Vendor\phpseclib\Net\SSH2::_get_channel_packet()
     * @access private
    */
    ...
    /**#@+
     * @access public
     * @see \MediaCloud\Vendor\phpseclib\Net\SSH2::getLog()
    */
    /**
    ...
    /**#@+
     * @access public
     * @see \MediaCloud\Vendor\phpseclib\Net\SSH2::read()
    */
    /**
     ...
     * @param int $timeout
     * @see self::login()
     * @return \MediaCloud\Vendor\phpseclib\Net\SSH2
     * @access public
     */
     ...
     *
     * @param string $algorithm Name of the encryption algorithm
     * @return mixed Instance of \MediaCloud\Vendor\phpseclib\Crypt\Base or null for unknown
     * @access private
     */
     ...
     * Login
     *
     * The $password parameter can be a plaintext password, a \MediaCloud\Vendor\phpseclib\Crypt\RSA object or an array
     *
     ...
     *
     * @param string $username
     * @param \MediaCloud\Vendor\phpseclib\System\SSH\Agent $agent
     * @return bool
     * @access private
     */
     ...
     *
     * @param string $username
     * @param \MediaCloud\Vendor\phpseclib\Crypt\RSA $privatekey
     * @return bool
     * @access private
     * @internal It might be worthwhile, at some point, to protect against {@link http://tools.ietf.org/html/rfc4251#section-9.3.9 traffic analysis}
     *           by sending dummy SSH_MSG_IGNORE messages.
     ...
     * Execute Command
     *
     * If $callback is set to false then \MediaCloud\Vendor\phpseclib\Net\SSH2::_get_channel_packet(self::CHANNEL_EXEC) will need to be called manually.
    ...
    function exec($command, $callback = null)
    {
        ...
        // down.  the one place where it might be desirable is if you're doing something like \MediaCloud\Vendor\phpseclib\Net\SSH2::exec('ping localhost &').
     ...
     *
     * \MediaCloud\Vendor\phpseclib\Net\SSH2 doesn't properly close most channels.  For exec() channels are normally closed by the server
