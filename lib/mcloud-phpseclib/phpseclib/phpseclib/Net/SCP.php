 ...
 *        exit('bad login');
 *    }
 *    $scp = new \MediaCloud\Vendor\phpseclib\Net\SCP($ssh);
 *
...
class SCP
{
    /**#@+
     * @access public
     * @see \MediaCloud\Vendor\phpseclib\Net\SCP::put()
     */
    /**
    ...
    /**#@+
     * @access private
     * @see \MediaCloud\Vendor\phpseclib\Net\SCP::_send()
     * @see \MediaCloud\Vendor\phpseclib\Net\SCP::_receive()
    */
    /**
     * SSH1 is being used.
     */
     ...
     *
     * @param \MediaCloud\Vendor\phpseclib\Net\SSH1|\phpseclib\Net\SSH2 $ssh
     * @return \MediaCloud\Vendor\phpseclib\Net\SCP
     * @access public
     */
     ...
     *
     * By default, \MediaCloud\Vendor\phpseclib\Net\SCP::put() does not read from the local filesystem.  $data is dumped directly into $remote_file.
     * So, for example, if you set $data to 'filename.ext' and then do \MediaCloud\Vendor\phpseclib\Net\SCP::get(), you will get a file, twelve bytes
