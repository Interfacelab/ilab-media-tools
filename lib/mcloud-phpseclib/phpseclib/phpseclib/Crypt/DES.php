 ...
 *
 *    $des = new \MediaCloud\Vendor\phpseclib\Crypt\DES();
 *
 *    $des->setKey('abcdefgh');
 *
 *    $size = 10 * 1024;
...
class DES extends Base
{
     ...
     * @see \MediaCloud\Vendor\phpseclib\Crypt\DES::_processBlock()
     */
    /**
     ...
     *
     * @see \MediaCloud\Vendor\phpseclib\Crypt\Base::openssl_mode_names
     * @var array
     * @access private
     */
     ...
     *
     * @see \MediaCloud\Vendor\phpseclib\Crypt\Base::isValidEngine()
     * @param int $engine
     * @access public
     * @return bool
     */
