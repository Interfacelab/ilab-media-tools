...
/**
 * Base Class for all \MediaCloud\Vendor\phpseclib\Crypt\* cipher classes
 *
 * PHP version 5
 *
 ...
 *
 *  - The new \MediaCloud\Vendor\phpseclib\Crypt\* cipher class should extend \MediaCloud\Vendor\phpseclib\Crypt\Base
 *
 ...
 *
 *  - Look at the source code of the current ciphers how they extend \MediaCloud\Vendor\phpseclib\Crypt\Base
...
abstract class Base
{
     ...
     *
     * @see \MediaCloud\Vendor\phpseclib\Crypt\Base::_hashInlineCryptFunction()
     * @var bool
     * @access private
     */
     ...
     *
     * @see \MediaCloud\Vendor\phpseclib\Crypt\Twofish::setKey()
     * @see \MediaCloud\Vendor\phpseclib\Crypt\Twofish::setIV()
     * @var bool
     * @access private
     */
    var $enchanged = true;
     ...
     *
     * SetIV is not required when self::MODE_ECB (or ie for AES: \MediaCloud\Vendor\phpseclib\Crypt\AES::MODE_ECB) is being used.  If not explicitly set, it'll be assumed
     * to be all zero's.
     *
     * @access public
     * @param string $iv
     ...
     *
     * Put another way, when the continuous buffer is enabled, the state of the \MediaCloud\Vendor\phpseclib\Crypt\*() object changes after each
     ...
     *
     * - \MediaCloud\Vendor\phpseclib\Crypt\Base::ENGINE_OPENSSL  [very fast]
     *
     * - \MediaCloud\Vendor\phpseclib\Crypt\Base::ENGINE_MCRYPT   [fast]
     *
     * - \MediaCloud\Vendor\phpseclib\Crypt\Base::ENGINE_INTERNAL [slow]
     *
     ...
     * Encrypts a block
     *
     * Note: Must be extended by the child \MediaCloud\Vendor\phpseclib\Crypt\* class
     *
     * @access private
     * @param string $in
     * @return string
     ...
     *
     * Note: Must extend by the child \MediaCloud\Vendor\phpseclib\Crypt\* class
     *
     * @see self::_setup()
     * @access private
     */
     ...
     *       - In case of using inline crypting, _setupInlineCrypt() must extend by the child \MediaCloud\Vendor\phpseclib\Crypt\* class.
    ...
    {
        // If, for any reason, an extending \MediaCloud\Vendor\phpseclib\Crypt\Base() \MediaCloud\Vendor\phpseclib\Crypt\* class
        // not using inline crypting then it must be ensured that: $this->use_inline_crypt = false
        // ie in the class var declaration of $use_inline_crypt in general for the \MediaCloud\Vendor\phpseclib\Crypt\* class,
     ...
     *    </code>
     *
     *    See also the \MediaCloud\Vendor\phpseclib\Crypt\*::_setupInlineCrypt()'s for
