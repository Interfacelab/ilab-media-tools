 ...
 *
 *    $rsa = new \MediaCloud\Vendor\phpseclib\Crypt\RSA();
...
class RSA
{
    ...
    */
    ...
    /**#@+
     * @access private
     * @see \MediaCloud\Vendor\phpseclib\Crypt\RSA::createKey()
    */
    /**
     * ASN1 Integer
     */
    ...
    /**#@+
     * @access private
     * @see \MediaCloud\Vendor\phpseclib\Crypt\RSA::__construct()
    */
    /**
     ...
     * @access public
     * @see \MediaCloud\Vendor\phpseclib\Crypt\RSA::createKey()
     * @see \MediaCloud\Vendor\phpseclib\Crypt\RSA::setPrivateKeyFormat()
    */
    /**
     ...
     * @access public
     * @see \MediaCloud\Vendor\phpseclib\Crypt\RSA::createKey()
     * @see \MediaCloud\Vendor\phpseclib\Crypt\RSA::setPublicKeyFormat()
    */
    /**
     * Raw public key
     *
     * An array containing two \MediaCloud\Vendor\phpseclib\Math\BigInteger objects.
     *
     ...
     * Precomputed Zero
     *
     * @var \MediaCloud\Vendor\phpseclib\Math\BigInteger
     * @access private
     */
    var $zero;
     ...
     * Hash function
     *
     * @var \MediaCloud\Vendor\phpseclib\Crypt\Hash
     * @access private
     */
    var $hash;
     ...
     * \MediaCloud\Vendor\phpseclib\Crypt\RSA doesn't do it is because OpenSSL doesn't fail gracefully.  openssl_pkey_new(), in particular, requires
     * openssl.cnf be present somewhere and, unfortunately, the only real way to find out is too late.
     *
     * @return \MediaCloud\Vendor\phpseclib\Crypt\RSA
     * @access public
     */
     ...
     *                  Will need to be passed back to \MediaCloud\Vendor\phpseclib\Crypt\RSA::createKey() as the third parameter for further processing.
     *
     * @access public
     * @param int $bits
     * @param int $timeout
    ...
    {
        // \MediaCloud\Vendor\phpseclib\Crypt\Hash supports algorithms that PKCS#1 doesn't support.  md5-96 and sha1-96, for example.
        switch ($hash) {
            case 'md2':
            case 'md5':
            case 'sha1':
     ...
     * @access private
     * @param \MediaCloud\Vendor\phpseclib\Math\BigInteger $x
     * @param \MediaCloud\Vendor\phpseclib\Math\BigInteger $r
     * @param int $i
     * @return \MediaCloud\Vendor\phpseclib\Math\BigInteger
     */
     ...
     *
     * @access private
     * @param \MediaCloud\Vendor\phpseclib\Math\BigInteger $m
     * @return \MediaCloud\Vendor\phpseclib\Math\BigInteger
     */
    function _rsaep($m)
    {
     ...
     *
     * @access private
     * @param \MediaCloud\Vendor\phpseclib\Math\BigInteger $c
     * @return \MediaCloud\Vendor\phpseclib\Math\BigInteger
     */
    function _rsadp($c)
    {
     ...
     *
     * @access private
     * @param \MediaCloud\Vendor\phpseclib\Math\BigInteger $s
     * @return \MediaCloud\Vendor\phpseclib\Math\BigInteger
     */
    function _rsavp1($s)
    {
     ...
     *
     * As a consequence of this, a private key encrypted ciphertext produced with \MediaCloud\Vendor\phpseclib\Crypt\RSA may not decrypt
