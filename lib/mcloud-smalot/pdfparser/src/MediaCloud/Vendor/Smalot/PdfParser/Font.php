...
use MediaCloud\Vendor\Smalot\PdfParser\Encoding\WinAnsiEncoding;
...
class Font extends PDFObject
{
     ...
     * \MediaCloud\Vendor\Smalot\PdfParser\PDFObject::factory() during file parsing (they would be just PDFObject).
     *
