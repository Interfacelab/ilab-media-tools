 ...
 *
 *      $logger = new \MediaCloud\Vendor\Monolog\Logger('all', array(new \MediaCloud\Vendor\Monolog\Handler\PHPConsoleHandler()));
 * \MediaCloud\Vendor\Monolog\ErrorHandler::register($logger);
 *      echo $undefinedVar;
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    private $options = [
        ...
        'classesPartialsTraceIgnore' => ['MediaCloud\\Vendor\\Monolog\\'], // array Hide calls of classes started with...
    ...
    /**
     * @param  array<string, mixed> $options   See \MediaCloud\Vendor\Monolog\Handler\PHPConsoleHandler::$options for more details
