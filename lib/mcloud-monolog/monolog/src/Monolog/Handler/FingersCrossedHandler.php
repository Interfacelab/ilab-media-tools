...
use MediaCloud\Vendor\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy;
use MediaCloud\Vendor\Monolog\Handler\FingersCrossed\ActivationStrategyInterface;
 ...
 * MediaCloud\Vendor\Monolog\Handler\FingersCrossed\ namespace.
 *
...
class FingersCrossedHandler extends Handler implements ProcessableHandlerInterface, ResettableInterface, FormattableHandlerInterface
{
    ...
    public function __construct($handler, $activationStrategy = null, int $bufferSize = 0, bool $bubble = true, bool $stopBuffering = true, $passthruLevel = null)
    {
        ...
        if (!$this->handler instanceof HandlerInterface && !is_callable($this->handler)) {
            throw new \RuntimeException("The given handler (".json_encode($this->handler).") is not a callable nor a MediaCloud\Vendor\Monolog\Handler\HandlerInterface object");
        }
    }
