...
use MediaCloud\Vendor\Monolog\Formatter\MongoDBFormatter;
 ...
 * Usage example:
 *
 *   $log = new \MediaCloud\Vendor\Monolog\Logger('application');
 *   $client = new \MongoDB\Client('mongodb://localhost:27017');
 *   $mongodb = new \MediaCloud\Vendor\Monolog\Handler\MongoDBHandler($client, 'logs', 'prod');
