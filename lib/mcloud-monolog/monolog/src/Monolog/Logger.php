...
use MediaCloud\Vendor\Psr\Log\InvalidArgumentException;
...
class Logger implements LoggerInterface, ResettableInterface
{
        ...
        foreach ($this->handlers as $handler) {
            if (null === $record) {
                ...
                $record = [
                    ...
                    'channel' => $this->name,
                    'datetime' => null,// new DateTimeImmutable($this->microsecondTimestamps, $this->timezone),
                    'extra' => [],
                ];
     ...
     *
     * @throws \MediaCloud\Vendor\Psr\Log\InvalidArgumentException If level is not defined
     *
     * @phpstan-param  Level     $level
