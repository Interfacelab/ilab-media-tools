...
namespace MediaCloud\Vendor\MuxPhp;
use MediaCloud\Vendor\MuxPhp\Models\ModelInterface;
...
class ObjectSerializer
{
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        if (null === $data) {
            ...
            /** @var \MediaCloud\Vendor\Psr\Http\Message\StreamInterface $data */
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\MediaCloud\Vendor\MuxPhp\Model\\' . $data->{$discriminator};
