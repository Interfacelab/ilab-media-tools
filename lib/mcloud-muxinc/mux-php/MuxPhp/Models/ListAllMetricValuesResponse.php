...
/**
 * ListAllMetricValuesResponse Class Doc Comment
 *
 * @category Class
 * @package  MuxPhp
 */
class ListAllMetricValuesResponse implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ListAllMetricValuesResponse';
    ...
    protected static $openAPITypes = [
        'data' => '\MediaCloud\Vendor\MuxPhp\Models\Score[]',
        'total_row_count' => 'int',
        'timeframe' => 'int[]'
    ];
     ...
     * Gets data
     *
     * @return \MediaCloud\Vendor\MuxPhp\Models\Score[]|null
     */
     ...
     * Sets data
     *
     * @param \MediaCloud\Vendor\MuxPhp\Models\Score[]|null $data data
     *
     * @return $this
     */
