...
/**
 * GetOverallValuesResponse Class Doc Comment
 *
 * @category Class
 * @package  MuxPhp
 */
class GetOverallValuesResponse implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GetOverallValuesResponse';
    ...
    protected static $openAPITypes = [
        'data' => '\MediaCloud\Vendor\MuxPhp\Models\OverallValues',
        'total_row_count' => 'int',
        'timeframe' => 'int[]'
    ];
     ...
     * Gets data
     *
     * @return \MediaCloud\Vendor\MuxPhp\Models\OverallValues|null
     */
     ...
     * Sets data
     *
     * @param \MediaCloud\Vendor\MuxPhp\Models\OverallValues|null $data data
     *
     * @return $this
     */
