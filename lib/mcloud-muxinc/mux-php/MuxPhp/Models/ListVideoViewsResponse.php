...
/**
 * ListVideoViewsResponse Class Doc Comment
 *
 * @category Class
 * @package  MuxPhp
 */
class ListVideoViewsResponse implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ListVideoViewsResponse';
    ...
    protected static $openAPITypes = [
        'data' => '\MediaCloud\Vendor\MuxPhp\Models\AbridgedVideoView[]',
        'total_row_count' => 'int',
        'timeframe' => 'int[]'
    ];
     ...
     * Gets data
     *
     * @return \MediaCloud\Vendor\MuxPhp\Models\AbridgedVideoView[]|null
     */
     ...
     * Sets data
     *
     * @param \MediaCloud\Vendor\MuxPhp\Models\AbridgedVideoView[]|null $data data
     *
     * @return $this
     */
