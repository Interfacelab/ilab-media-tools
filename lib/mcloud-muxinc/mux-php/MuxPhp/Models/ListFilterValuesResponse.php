...
/**
 * ListFilterValuesResponse Class Doc Comment
 *
 * @category Class
 * @package  MuxPhp
 */
class ListFilterValuesResponse implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ListFilterValuesResponse';
    ...
    protected static $openAPITypes = [
        'data' => '\MediaCloud\Vendor\MuxPhp\Models\FilterValue[]',
        'total_row_count' => 'int',
        'timeframe' => 'int[]'
    ];
     ...
     * Gets data
     *
     * @return \MediaCloud\Vendor\MuxPhp\Models\FilterValue[]|null
     */
     ...
     * Sets data
     *
     * @param \MediaCloud\Vendor\MuxPhp\Models\FilterValue[]|null $data data
     *
     * @return $this
     */
