...
/**
 * ListExportsResponse Class Doc Comment
 *
 * @category Class
 * @package  MuxPhp
 */
class ListExportsResponse implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ListExportsResponse';
