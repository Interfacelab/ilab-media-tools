...
/**
 * ListDeliveryUsageResponse Class Doc Comment
 *
 * @category Class
 * @package  MuxPhp
 */
class ListDeliveryUsageResponse implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ListDeliveryUsageResponse';
    ...
    protected static $openAPITypes = [
        'data' => '\MediaCloud\Vendor\MuxPhp\Models\DeliveryReport[]',
        'total_row_count' => 'int',
        'timeframe' => 'int[]',
        'limit' => 'int'
    ];
     ...
     * Gets data
     *
     * @return \MediaCloud\Vendor\MuxPhp\Models\DeliveryReport[]|null
     */
     ...
     * Sets data
     *
     * @param \MediaCloud\Vendor\MuxPhp\Models\DeliveryReport[]|null $data data
     *
     * @return $this
     */
     ...
     * Sets limit
     *
     * @param int|null $limit Number of assets returned in this response. Default value is 100.
     *
     * @return $this
     */
