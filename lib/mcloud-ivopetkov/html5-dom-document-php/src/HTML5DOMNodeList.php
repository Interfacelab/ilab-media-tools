...
class HTML5DOMNodeList extends \ArrayObject
{
     ...
     * @return \MediaCloud\Vendor\IvoPetkov\HTML5DOMElement|null The item at the specified index or null if not existent.
     */
    ...
    public function __get(string $name)
    {
        ...
        throw new \Exception('Undefined property: \MediaCloud\Vendor\IvoPetkov\HTML5DOMNodeList::$' . $name);
    }
}
