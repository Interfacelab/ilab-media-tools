...
namespace MediaCloud\Vendor\Aws\EndpointDiscovery;
...
use MediaCloud\Vendor\Aws\EndpointDiscovery\Exception\ConfigurationException;
use MediaCloud\Vendor\GuzzleHttp\Promise;
use MediaCloud\Vendor\GuzzleHttp\Promise\PromiseInterface;

/**
 * A configuration provider is a function that returns a promise that is
 * fulfilled with a {@see \MediaCloud\Vendor\Aws\EndpointDiscovery\ConfigurationInterface}
 * or rejected with an {@see \MediaCloud\Vendor\Aws\EndpointDiscovery\Exception\ConfigurationException}.
 *
 * <code>
 ...
 * {@see MediaCloud\Vendor\Aws\EndpointDiscovery\ConfigurationProvider::chain}. This function
