...
class PartitionEndpointProvider
{
    ...
    {
        $data = \MediaCloud\Vendor\Aws\load_compiled_json(__DIR__ . '/../data/endpoints.json');
        $prefixData = \MediaCloud\Vendor\Aws\load_compiled_json(__DIR__ . '/../data/endpoints_prefix_history.json');
