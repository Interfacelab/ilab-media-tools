...
namespace MediaCloud\Vendor\Aws\Endpoint\UseDualstackEndpoint;
use MediaCloud\Vendor\Aws\AbstractConfigurationProvider;
use MediaCloud\Vendor\Aws\CacheInterface;
use MediaCloud\Vendor\Aws\ConfigurationProviderInterface;
use MediaCloud\Vendor\Aws\Endpoint\UseDualstackEndpoint\Exception\ConfigurationException;
use MediaCloud\Vendor\GuzzleHttp\Promise;

/**
 * A configuration provider is a function that returns a promise that is
 * fulfilled with a {@see \MediaCloud\Vendor\Aws\Endpoint\UseDualstackEndpoint\onfigurationInterface}
 * or rejected with an {@see \MediaCloud\Vendor\Aws\Endpoint\UseDualstackEndpoint\ConfigurationException}.
 *
 * <code>
 * use MediaCloud\Vendor\Aws\Endpoint\UseDualstackEndpoint\ConfigurationProvider;
 ...
 * {@see MediaCloud\Vendor\Aws\Endpoint\UseDualstackEndpoint\ConfigurationProvider::chain}. This function
