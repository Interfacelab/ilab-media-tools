...
interface AwsClientInterface
{
     ...
     * {@see \MediaCloud\Vendor\Aws\Credentials\CredentialsInterface} object.
     *
     ...
     *
     * @return \MediaCloud\Vendor\Aws\Api\Service
     */
     ...
     *
     * @return \MediaCloud\Vendor\Aws\ResultPaginator
     * @throws \UnexpectedValueException if the iterator config is invalid.
     */
     ...
     *                              can be provided in an associative array in
     *                              the @waiter key.
     * @return \MediaCloud\Vendor\Aws\Waiter
     * @throws \UnexpectedValueException if the waiter is invalid.
     */
