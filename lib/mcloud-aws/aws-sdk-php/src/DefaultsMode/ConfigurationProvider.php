...
namespace MediaCloud\Vendor\Aws\DefaultsMode;
...
use MediaCloud\Vendor\Aws\DefaultsMode\Exception\ConfigurationException;
use MediaCloud\Vendor\GuzzleHttp\Promise;
use MediaCloud\Vendor\GuzzleHttp\Promise\PromiseInterface;

/**
 * A configuration provider is a function that returns a promise that is
 * fulfilled with a {@see \MediaCloud\Vendor\Aws\DefaultsMode\ConfigurationInterface}
 * or rejected with an {@see \MediaCloud\Vendor\Aws\DefaultsMode\Exception\ConfigurationException}.
 *
 * <code>
 ...
 * {@see \MediaCloud\Vendor\Aws\DefaultsMode\ConfigurationProvider::chain}. This function
