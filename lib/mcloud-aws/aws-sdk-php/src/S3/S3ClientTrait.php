...
use MediaCloud\Vendor\Aws\Api\Parser\PayloadParserTrait;
 ...
 * classes implementing \MediaCloud\Vendor\Aws\S3\S3ClientInterface
 */
trait S3ClientTrait
{
    ...
    public function deleteMatchingObjectsAsync(
        ...
        if ($regex) {
            $iter = \MediaCloud\Vendor\Aws\filter($iter, function ($c) use ($regex) {
