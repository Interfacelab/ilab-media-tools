...
use MediaCloud\Vendor\Aws\Crypto\DecryptionTraitV2;
...
use MediaCloud\Vendor\Aws\Crypto\AbstractCryptoClientV2;
use MediaCloud\Vendor\Aws\Crypto\EncryptionTraitV2;
use MediaCloud\Vendor\Aws\Crypto\MetadataEnvelope;
use MediaCloud\Vendor\Aws\Crypto\MaterialsProvider;
use MediaCloud\Vendor\Aws\Crypto\Cipher\CipherBuilderTrait;
 ...
 *
 * <code>
 * use MediaCloud\Vendor\Aws\Crypto\KmsMaterialsProviderV2;
 * use MediaCloud\Vendor\Aws\S3\Crypto\S3EncryptionClientV2;
 * use MediaCloud\Vendor\Aws\S3\S3Client;
 *
...
class S3EncryptionClientV2 extends AbstractCryptoClientV2
{
     ...
     *   determined.
     *
     * @return \MediaCloud\Vendor\Aws\Result PutObject call result with the details of uploading
     *                     the encrypted file.
     *
     * @throws \InvalidArgumentException Thrown when arguments above are not
     *                                   passed or are passed incorrectly.
     ...
     *   materials providers. Defaults to false.
     *
     * @return \MediaCloud\Vendor\Aws\Result GetObject call result with the 'Body' field
