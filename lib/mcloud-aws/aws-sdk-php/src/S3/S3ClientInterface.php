...
interface S3ClientInterface extends AwsClientInterface
{
     ...
     * @param array  $options MediaCloud\Vendor\Aws\S3\BatchDelete options array.
     *
     * @see MediaCloud\Vendor\Aws\S3\S3Client::listObjects
     ...
     *
     * @see MediaCloud\Vendor\Aws\S3\MultipartUploader for more info about multipart uploads.
     ...
     * @param array  $options       Options used to configure the upload process.
     *
     * @see MediaCloud\Vendor\Aws\S3\MultipartCopy for more info about multipart uploads.
     ...
     * @param array  $options   Options available in MediaCloud\Vendor\Aws\S3\Transfer::__construct
     *
     * @see MediaCloud\Vendor\Aws\S3\Transfer for more options and customization
     */
