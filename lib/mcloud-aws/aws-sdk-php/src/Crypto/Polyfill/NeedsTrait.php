...
namespace MediaCloud\Vendor\Aws\Crypto\Polyfill;
use MediaCloud\Vendor\Aws\Exception\CryptoPolyfillException;

/**
 * Trait NeedsTrait
 * @package MediaCloud\Vendor\Aws\Crypto\Polyfill
 */
trait NeedsTrait
{
    /**
