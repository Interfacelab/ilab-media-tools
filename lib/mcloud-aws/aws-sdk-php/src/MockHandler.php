 ...
 * MediaCloud\Vendor\Aws\ResultInterface and MediaCloud\Vendor\Aws\Exception\AwsException objects.
 */
class MockHandler implements \Countable
{
    ...
    /**
     * The passed in value must be an array of {@see MediaCloud\Vendor\Aws\ResultInterface} or
    ...
    public function append()
    {
        foreach (func_get_args() as $value) {
            if ($value instanceof ResultInterface
                ...
                throw new \InvalidArgumentException('Expected an MediaCloud\Vendor\Aws\ResultInterface or MediaCloud\Vendor\Aws\Exception\AwsException.');
            }
        }
    }
