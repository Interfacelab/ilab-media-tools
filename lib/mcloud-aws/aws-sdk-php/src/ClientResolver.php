...
use MediaCloud\Vendor\Aws\Api\Validator;
use MediaCloud\Vendor\Aws\Api\ApiProvider;
use MediaCloud\Vendor\Aws\Api\Service;
use MediaCloud\Vendor\Aws\ClientSideMonitoring\ApiCallAttemptMonitoringMiddleware;
use MediaCloud\Vendor\Aws\ClientSideMonitoring\ApiCallMonitoringMiddleware;
use MediaCloud\Vendor\Aws\ClientSideMonitoring\Configuration;
use MediaCloud\Vendor\Aws\Credentials\Credentials;
use MediaCloud\Vendor\Aws\Credentials\CredentialsInterface;
use MediaCloud\Vendor\Aws\Endpoint\PartitionEndpointProvider;
use MediaCloud\Vendor\Aws\Endpoint\UseFipsEndpoint\Configuration as UseFipsEndpointConfiguration;
use MediaCloud\Vendor\Aws\Endpoint\UseFipsEndpoint\ConfigurationProvider as UseFipsConfigProvider;
use MediaCloud\Vendor\Aws\Endpoint\UseFipsEndpoint\ConfigurationInterface as UseFipsEndpointConfigurationInterface;
use MediaCloud\Vendor\Aws\Endpoint\UseDualstackEndpoint\Configuration as UseDualStackEndpointConfiguration;
use MediaCloud\Vendor\Aws\Endpoint\UseDualstackEndpoint\ConfigurationProvider as UseDualStackConfigProvider;
use MediaCloud\Vendor\Aws\Endpoint\UseDualstackEndpoint\ConfigurationInterface as UseDualStackEndpointConfigurationInterface;
use MediaCloud\Vendor\Aws\EndpointDiscovery\ConfigurationInterface;
use MediaCloud\Vendor\Aws\EndpointDiscovery\ConfigurationProvider;
use MediaCloud\Vendor\Aws\Exception\InvalidRegionException;
use MediaCloud\Vendor\Aws\Retry\ConfigurationInterface as RetryConfigInterface;
use MediaCloud\Vendor\Aws\Retry\ConfigurationProvider as RetryConfigProvider;
use MediaCloud\Vendor\Aws\DefaultsMode\ConfigurationInterface as ConfigModeInterface;
use MediaCloud\Vendor\Aws\DefaultsMode\ConfigurationProvider as ConfigModeProvider;
use MediaCloud\Vendor\Aws\Signature\SignatureProvider;
use MediaCloud\Vendor\Aws\Endpoint\EndpointProvider;
...
class ClientResolver
{
    ...
    private static $defaultArgs = [
        'service' => [
            'type'     => 'value',
            'valid'    => ['string'],
            'doc'      => 'Name of the service to utilize. This value will be supplied by default when using one of the SDK clients (e.g., MediaCloud\\Vendor\\Aws\\S3\\S3Client).',
            'required' => true,
            'internal' => true
        ],
        'exception_class' => [
            ...
            'default'  => 'MediaCloud\Vendor\Aws\Exception\AwsException',
            'internal' => true
        ],
        'scheme' => [
            'type'     => 'value',
        ...
        'signature_provider' => [
            'type'    => 'value',
            'valid'   => ['callable'],
            'doc'     => 'A callable that accepts a signature version name (e.g., "v4"), a service name, and region, and  returns a SignatureInterface object or null. This provider is used to create signers utilized by the client. See MediaCloud\\Vendor\\Aws\\Signature\\SignatureProvider for a list of built-in providers',
        ...
        'configuration_mode' => [
            ...
            'doc'     => "Sets the default configuration mode. Otherwise provide an instance of MediaCloud\Vendor\Aws\DefaultsMode\ConfigurationInterface, an instance of MediaCloud\Vendor\Aws\CacheInterface, or a string containing a valid mode",
        ...
        'endpoint_provider' => [
            ...
            'doc'      => 'An optional PHP callable that accepts a hash of options including a "service" and "region" key and returns NULL or a hash of endpoint data, of which the "endpoint" key is required. See MediaCloud\\Vendor\\Aws\\Endpoint\\EndpointProvider for a list of built-in providers.',
        ...
        'credentials' => [
            ...
            'doc'     => 'Specifies the credentials used to sign requests. Provide an MediaCloud\Vendor\Aws\Credentials\CredentialsInterface object, an associative array of "key", "secret", and an optional "token" key, `false` to use null credentials, or a callable credentials provider used to create credentials or return null. See MediaCloud\\Vendor\\Aws\\Credentials\\CredentialProvider for a list of built-in credentials providers. If no credentials are provided, the SDK will attempt to load them from the environment.',
        ...
        'endpoint_discovery' => [
            ...
            'doc'      => 'Specifies settings for endpoint discovery. Provide an instance of \MediaCloud\Vendor\Aws\EndpointDiscovery\ConfigurationInterface, an instance \MediaCloud\Vendor\Aws\CacheInterface, a callable that provides a promise for a Configuration object, or an associative array with the following keys: enabled: (bool) Set to true to enable endpoint discovery, false to explicitly disable it. Defaults to false; cache_limit: (int) The maximum number of keys in the endpoints cache. Defaults to 1000.',
        ...
        'stats' => [
            ...
            'valid' => ['bool', 'array'],
            'default' => false,
            'doc'   => 'Set to true to gather transfer statistics on requests sent. Alternatively, you can provide an associative array with the following keys: retries: (bool) Set to false to disable reporting on retries attempted; http: (bool) Set to true to enable collecting statistics from lower level HTTP adapters (e.g., values returned in \MediaCloud\Vendor\GuzzleHttp\TransferStats). HTTP handlers must support an http_stats_receiver option for this to have an effect; timer: (bool) Set to true to enable a command timer that reports the total wall clock time spent on an operation in seconds.',
            'fn'    => [__CLASS__, '_apply_stats'],
        ],
        'retries' => [
            'type'    => 'value',
            'valid'   => ['int', RetryConfigInterface::class, CacheInterface::class, 'callable', 'array'],
            'doc'     => "Configures the retry mode and maximum number of allowed retries for a client (pass 0 to disable retries). Provide an integer for 'legacy' mode with the specified number of retries. Otherwise provide an instance of \MediaCloud\Vendor\Aws\Retry\ConfigurationInterface, an instance of \MediaCloud\Vendor\Aws\CacheInterface, a callable function, or an array with the following keys: mode: (string) Set to 'legacy', 'standard' (uses retry quota management), or 'adapative' (an experimental mode that adds client-side rate limiting to standard mode); max_attempts: (int) The maximum number of attempts for a given request. ",
        ...
        'handler' => [
            'type'     => 'value',
            'valid'    => ['callable'],
            'doc'      => 'A handler that accepts a command object, request object and returns a promise that is fulfilled with an MediaCloud\Vendor\Aws\ResultInterface object or rejected with an MediaCloud\Vendor\Aws\Exception\AwsException. A handler does not accept a next handler as it is terminal and expected to fulfill a command. If no handler is provided, a default Guzzle handler will be utilized.',
    ...
    public static function _apply_credentials($value, array &$args)
    {
        ...
        if ($value instanceof CredentialsInterface) {
            ...
            throw new IAE('Credentials must be an instance of '
                . 'MediaCloud\Vendor\Aws\Credentials\CredentialsInterface, an associative '
    ...
    public static function _apply_csm($value, array &$args, HandlerList $list)
    {
        if ($value === false) {
            $value = new Configuration(
                false, \MediaCloud\Vendor\Aws\ClientSideMonitoring\ConfigurationProvider::DEFAULT_HOST, \MediaCloud\Vendor\Aws\ClientSideMonitoring\ConfigurationProvider::DEFAULT_PORT, \MediaCloud\Vendor\Aws\ClientSideMonitoring\ConfigurationProvider::DEFAULT_CLIENT_ID
            );
            $args['csm'] = $value;
        }
    ...
    public static function _apply_endpoint_provider(callable $value, array &$args)
    {
        if (!isset($args['endpoint'])) {
            ...
            $args['region'] = \MediaCloud\Vendor\Aws\strip_fips_pseudo_regions($args['region']);
