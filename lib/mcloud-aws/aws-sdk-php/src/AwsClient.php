...
use MediaCloud\Vendor\Aws\ClientSideMonitoring\ConfigurationProvider;
...
class AwsClient implements AwsClientInterface
{
     ...
     * MediaCloud\Vendor\Aws\Credentials\CredentialsInterface object, an associative array of
     *   "key", "secret", and an optional "token" key, `false` to use null
     *   credentials, or a callable credentials provider used to create
     *   credentials or return null. See MediaCloud\Vendor\Aws\Credentials\CredentialProvider for
     *   a list of built-in credentials providers. If no credentials are
     *   provided, the SDK will attempt to load them from the environment.
     * - csm:
     *   (Aws\ClientSideMonitoring\ConfigurationInterface|array|callable) Specifies
     *   the credentials used to sign requests. Provide an
     * MediaCloud\Vendor\Aws\ClientSideMonitoring\ConfigurationInterface object, a callable
     ...
     * MediaCloud\Vendor\GuzzleHttp\TransferStats). HTTP handlers must support an
     ...
     * MediaCloud\Vendor\Aws\CacheInterface, array, callable) Settings for endpoint discovery.
     *   Provide an instance of MediaCloud\Vendor\Aws\EndpointDiscovery\ConfigurationInterface,
     *   an instance MediaCloud\Vendor\Aws\CacheInterface, a callable that provides a promise for
     ...
     *   is required. See MediaCloud\Vendor\Aws\Endpoint\EndpointProvider for a list of built-in
     *   providers.
     * - handler: (callable) A handler that accepts a command object,
     *   request object and returns a promise that is fulfilled with an
     * MediaCloud\Vendor\Aws\ResultInterface object or rejected with an
     * MediaCloud\Vendor\Aws\Exception\AwsException. A handler does not accept a next handler
     ...
     *   available regions.
     * - retries: (int, MediaCloud\Vendor\Aws\Retry\ConfigurationInterface, MediaCloud\Vendor\Aws\CacheInterface,
     *   array, callable) Configures the retry mode and maximum number of
     *   allowed retries for a client (pass 0 to disable retries). Provide an
     *   integer for 'legacy' mode with the specified number of retries.
     *   Otherwise provide an instance of MediaCloud\Vendor\Aws\Retry\ConfigurationInterface, an
     *   instance of MediaCloud\Vendor\Aws\CacheInterface, a callable function, or an array with
     ...
     * MediaCloud\Vendor\Aws\Signature\SignatureProvider for a list of built-in providers
    ...
    private function parseClass()
    {
        ...
        if ($klass === __CLASS__) {
            return ['', 'MediaCloud\Vendor\Aws\Exception\AwsException'];
        }
        ...
        return [
            strtolower($service),
            "MediaCloud\\Vendor\\Aws\\{$service}\\Exception\\{$service}Exception"
        ];
    }
    ...
    private function loadAliases($file = null)
    {
        if (!isset($this->aliases)) {
            ...
            $aliases = \MediaCloud\Vendor\Aws\load_compiled_json($file);
    ...
    {
        $aliases = \MediaCloud\Vendor\Aws\load_compiled_json(__DIR__ . '/data/aliases.json');
