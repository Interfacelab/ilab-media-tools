...
use MediaCloud\Vendor\Aws\Exception\UnresolvedApiException;
 ...
 * {@see MediaCloud\Vendor\Aws\Exception\UnresolvedApiException}.
 *
 ...
 * {@see MediaCloud\Vendor\Aws\or_chain}. This method accepts providers as arguments and
...
class ApiProvider
{
    ...
    {
        return new self(__DIR__ . '/../data', \MediaCloud\Vendor\Aws\manifest());
    }
    ...
    public function __invoke($type, $service, $version)
    {
        ...
        try {
            return \MediaCloud\Vendor\Aws\load_compiled_json($path);
