...
use MediaCloud\Vendor\Aws\Api\Serializer\QuerySerializer;
use MediaCloud\Vendor\Aws\Api\Serializer\Ec2ParamBuilder;
use MediaCloud\Vendor\Aws\Api\Parser\QueryParser;
...
class Service extends AbstractModel
{
    ...
    {
        static $mapping = [
            'json'      => 'MediaCloud\Vendor\Aws\Api\Serializer\JsonRpcSerializer',
            'query'     => 'MediaCloud\Vendor\Aws\Api\Serializer\QuerySerializer',
            'rest-json' => 'MediaCloud\Vendor\Aws\Api\Serializer\RestJsonSerializer',
            'rest-xml'  => 'MediaCloud\Vendor\Aws\Api\Serializer\RestXmlSerializer'
        ];
    ...
    {
        static $mapping = [
            'json'      => 'MediaCloud\Vendor\Aws\Api\ErrorParser\JsonRpcErrorParser',
            'query'     => 'MediaCloud\Vendor\Aws\Api\ErrorParser\XmlErrorParser',
            'rest-json' => 'MediaCloud\Vendor\Aws\Api\ErrorParser\RestJsonErrorParser',
            'rest-xml'  => 'MediaCloud\Vendor\Aws\Api\ErrorParser\XmlErrorParser',
            'ec2'       => 'MediaCloud\Vendor\Aws\Api\ErrorParser\XmlErrorParser'
        ];
    ...
    {
        static $mapping = [
            'json'      => 'MediaCloud\Vendor\Aws\Api\Parser\JsonRpcParser',
            'query'     => 'MediaCloud\Vendor\Aws\Api\Parser\QueryParser',
            'rest-json' => 'MediaCloud\Vendor\Aws\Api\Parser\RestJsonParser',
            'rest-xml'  => 'MediaCloud\Vendor\Aws\Api\Parser\RestXmlParser'
        ];
