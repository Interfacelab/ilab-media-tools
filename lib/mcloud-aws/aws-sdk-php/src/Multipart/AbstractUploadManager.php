...
namespace MediaCloud\Vendor\Aws\Multipart;
use MediaCloud\Vendor\Aws\AwsClientInterface as Client;
use MediaCloud\Vendor\Aws\CommandInterface;
use MediaCloud\Vendor\Aws\CommandPool;
...
abstract class AbstractUploadManager implements Promise\PromisorInterface
{
    ...
    private static $defaultConfig = [
        ...
        'exception_class'     => 'MediaCloud\Vendor\Aws\Exception\MultipartUploadException',
    ];
