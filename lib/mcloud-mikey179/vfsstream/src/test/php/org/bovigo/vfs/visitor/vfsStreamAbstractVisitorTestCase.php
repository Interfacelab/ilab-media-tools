...
namespace MediaCloud\Vendor\org\bovigo\vfs\visitor;
use MediaCloud\Vendor\org\bovigo\vfs\vfsStreamDirectory;
use MediaCloud\Vendor\org\bovigo\vfs\vfsStreamFile;
use MediaCloud\Vendor\org\bovigo\vfs\vfsStreamBlock;
/**
 * Test for MediaCloud\Vendor\org\bovigo\vfs\visitor\vfsStreamAbstractVisitor.
 *
 * @since  0.10.0
...
class vfsStreamAbstractVisitorTestCase extends \BC_PHPUnit_Framework_TestCase
{
    ...
    {
        $this->abstractVisitor = $this->bc_getMock('MediaCloud\\Vendor\\org\bovigo\vfs\\visitor\\vfsStreamAbstractVisitor',
