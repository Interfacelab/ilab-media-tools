...
/**
 * Test for MediaCloud\Vendor\org\bovigo\vfs\vfsStreamContainerIterator.
 */
class vfsStreamContainerIteratorTestCase extends \BC_PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->mockChild1 = $this->bc_getMock('MediaCloud\\Vendor\\org\bovigo\vfs\\vfsStreamContent');
        $this->mockChild1->expects($this->any())
                         ->method('getName')
                         ->will($this->returnValue('bar'));
        $this->dir->addChild($this->mockChild1);
        $this->mockChild2 = $this->bc_getMock('MediaCloud\\Vendor\\org\bovigo\vfs\\vfsStreamContent');
