...
use MediaCloud\Vendor\org\bovigo\vfs\content\LargeFileContent;

/**
 * Test for MediaCloud\Vendor\org\bovigo\vfs\vfsStream.
 */
class vfsStreamTestCase extends \BC_PHPUnit_Framework_TestCase
{
    ...
    public function newFile()
    {
        ...
        $this->assertInstanceOf('MediaCloud\\Vendor\\org\bovigo\vfs\\vfsStreamFile', $file);
    ...
    public function setupArraysAreTurnedIntoSubdirectories()
    {
        ...
        $this->assertInstanceOf('MediaCloud\\Vendor\\org\bovigo\vfs\\vfsStreamDirectory',
                                $root->getChild('test')
        );
    ...
    public function setupWorksRecursively()
    {
        ...
        $this->assertInstanceOf('MediaCloud\\Vendor\\org\bovigo\vfs\\vfsStreamDirectory', $test);
        ...
        $this->assertInstanceOf('MediaCloud\\Vendor\\org\bovigo\vfs\\vfsStreamDirectory', $foo);
    ...
    */
    ...
    {
        $this->assertInstanceOf('MediaCloud\\Vendor\\org\bovigo\vfs\\vfsStreamFile',
                                $file
        );
    ...
    {
        $mockContent = $this->bc_getMock('MediaCloud\\Vendor\\org\bovigo\vfs\\vfsStreamContent');
        $mockVisitor = $this->bc_getMock('MediaCloud\\Vendor\\org\bovigo\vfs\\visitor\\vfsStreamVisitor');
