...
/**
 * Test for MediaCloud\Vendor\org\bovigo\vfs\vfsStreamDirectory.
 */
class vfsStreamDirectoryTestCase extends \BC_PHPUnit_Framework_TestCase
{
    ...
    {
        $mockChild = $this->bc_getMock('MediaCloud\\Vendor\\org\bovigo\vfs\\vfsStreamContent');
    ...
    {
        $mockChild1 = $this->bc_getMock('MediaCloud\\Vendor\\org\bovigo\vfs\\vfsStreamContent');
        ...
        $mockChild1->expects($this->any())
                   ->method('getName')
                   ->will($this->returnValue('bar'));
        $mockChild2 = $this->bc_getMock('MediaCloud\\Vendor\\org\bovigo\vfs\\vfsStreamContent');
