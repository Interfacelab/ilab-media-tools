...
use MediaCloud\Vendor\org\bovigo\vfs\content\FileContent;
use MediaCloud\Vendor\org\bovigo\vfs\content\StringBasedFileContent;
/**
 * File container.
 *
 * @api
...
class vfsStreamFile extends vfsStreamAbstractContent
{
    ...
    public function withContent($content)
    {
        if (is_string($content)) {
            ...
            throw new \InvalidArgumentException('Given content must either be a string or an instance of MediaCloud\Vendor\org\bovigo\vfs\content\FileContent');
        }
