...
namespace MediaCloud\Vendor\FasterImage;
use MediaCloud\Vendor\WillWashburn\Stream\Exception\StreamBufferTooSmallException;
use MediaCloud\Vendor\WillWashburn\Stream\Stream;
use MediaCloud\Vendor\WillWashburn\Stream\StreamableInterface;
...
class ImageParser
{
    ...
    /**
     * @return array|bool
     * @throws \MediaCloud\Vendor\FasterImage\Exception\InvalidImageException
