...
use MediaCloud\Vendor\Carbon\Exceptions\BadFluentConstructorException;
use MediaCloud\Vendor\Carbon\Exceptions\BadFluentSetterException;
use MediaCloud\Vendor\Carbon\Exceptions\InvalidCastException;
use MediaCloud\Vendor\Carbon\Exceptions\InvalidIntervalException;
use MediaCloud\Vendor\Carbon\Exceptions\ParseErrorException;
use MediaCloud\Vendor\Carbon\Exceptions\UnitNotConfiguredException;
use MediaCloud\Vendor\Carbon\Exceptions\UnknownGetterException;
use MediaCloud\Vendor\Carbon\Exceptions\UnknownSetterException;
use MediaCloud\Vendor\Carbon\Exceptions\UnknownUnitException;
use MediaCloud\Vendor\Carbon\Traits\IntervalRounding;
use MediaCloud\Vendor\Carbon\Traits\IntervalStep;
use MediaCloud\Vendor\Carbon\Traits\Mixin;
use MediaCloud\Vendor\Carbon\Traits\Options;
use Closure;
use DateInterval;
...
class CarbonInterval extends DateInterval implements CarbonConverterInterface
{
     ...
     *
     * @throws \MediaCloud\Vendor\Carbon\Exceptions\ParseErrorException when the $interval cannot be parsed as an interval.
     *
     * @return static
     */
    ...
    public function forHumans($syntax = null, $short = false, $parts = -1, $options = null)
    {
        ...
        /** @var \MediaCloud\Vendor\Symfony\Component\Translation\Translator $translator */
