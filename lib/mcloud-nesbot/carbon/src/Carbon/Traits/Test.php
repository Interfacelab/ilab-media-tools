...
use MediaCloud\Vendor\Carbon\CarbonTimeZone;
use Closure;
...
trait Test
{
     ...
     *
     * @return \MediaCloud\Vendor\Carbon\CarbonImmutable|\Carbon\Carbon|null
     */
    protected static function getMockedTestNow($tz)
    {
        ...
        /* @var \MediaCloud\Vendor\Carbon\CarbonImmutable|\Carbon\Carbon|null $testNow */
    ...
    {
        /** @var \MediaCloud\Vendor\Carbon\CarbonImmutable|\Carbon\Carbon $testInstance */
