...
use MediaCloud\Vendor\Carbon\Exceptions\BadComparisonUnitException;
...
trait Comparison
{
     ...
     * @param \MediaCloud\Vendor\Carbon\Carbon|\DateTimeInterface|string|null $date   instance to compare with or null to use current day.
     *
     * @return bool
     */
     ...
     * @param \MediaCloud\Vendor\Carbon\Carbon|\DateTimeInterface|null $date instance to compare with or null to use current day.
     *
     ...
     * ```
     *
     * @param \MediaCloud\Vendor\Carbon\Carbon|\DateTimeInterface|string|null $date       The instance to compare with or null to use current day.
