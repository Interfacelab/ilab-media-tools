...
use MediaCloud\Vendor\Carbon\Exceptions\InvalidFormatException;
use MediaCloud\Vendor\Carbon\Exceptions\OutOfRangeException;
...
trait Creator
{
    ...
    public static function rawCreateFromFormat($format, $time, $tz = null)
    {
        ...
        /** @var \MediaCloud\Vendor\Carbon\CarbonImmutable|\Carbon\Carbon|null $mock */
     ...
     * @param \MediaCloud\Vendor\Symfony\Component\Translation\TranslatorInterface $translator optional custom translator to use for macro-formats
     *
     * @throws InvalidFormatException
     *
     * @return static|false
