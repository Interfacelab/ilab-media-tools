...
namespace MediaCloud\Vendor\Carbon\Traits;
use MediaCloud\Vendor\Carbon\CarbonInterface;
use MediaCloud\Vendor\Carbon\Exceptions\InvalidTypeException;
use MediaCloud\Vendor\Carbon\Exceptions\NotLocaleAwareException;
use MediaCloud\Vendor\Carbon\Language;
use MediaCloud\Vendor\Carbon\Translator;
use MediaCloud\Vendor\Carbon\TranslatorStrongTypeInterface;
use Closure;
use MediaCloud\Vendor\Symfony\Component\Translation\TranslatorBagInterface;
use MediaCloud\Vendor\Symfony\Component\Translation\TranslatorInterface;
use MediaCloud\Vendor\Symfony\Contracts\Translation\LocaleAwareInterface;
use MediaCloud\Vendor\Symfony\Contracts\Translation\TranslatorInterface as ContractsTranslatorInterface;

if (!interface_exists('MediaCloud\\Vendor\\Symfony\Component\Translation\\TranslatorInterface')) {
    class_alias(
        'MediaCloud\\Vendor\\Symfony\Contracts\Translation\\TranslatorInterface',
        'MediaCloud\\Vendor\\Symfony\Component\Translation\\TranslatorInterface'
    );
}
...
trait Localization
{
     ...
     * Default translator.
     *
     * @var \MediaCloud\Vendor\Symfony\Component\Translation\TranslatorInterface
     */
     ...
     *
     * @return \MediaCloud\Vendor\Symfony\Component\Translation\TranslatorInterface
     */
     ...
     *
     * @param \MediaCloud\Vendor\Symfony\Component\Translation\TranslatorInterface $translator
     *
     * @return void
     */
     ...
     *
     * @param \MediaCloud\Vendor\Symfony\Component\Translation\TranslatorInterface $translator the translator to use
     ...
     * @param string|null                                        $locale     current locale used if null
     * @param string|null                                        $default    default value if translation returns the key
     * @param \MediaCloud\Vendor\Symfony\Component\Translation\TranslatorInterface $translator an optional translator to use
     *
     * @return string
     */
     ...
     * @param \MediaCloud\Vendor\Symfony\Component\Translation\TranslatorInterface|null $translator
     ...
     * @param \MediaCloud\Vendor\Symfony\Component\Translation\MessageCatalogueInterface $catalogue
     *
     * @return mixed
     */
