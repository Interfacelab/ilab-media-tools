...
use MediaCloud\Vendor\Symfony\Component\Translation\PluralizationRules;

if (class_exists('MediaCloud\\Vendor\\Symfony\Component\Translation\\PluralizationRules')) {
