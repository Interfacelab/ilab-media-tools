...
class CarbonPeriod implements Iterator, Countable
{
     ...
     * @var string
     */
    const RECURRENCES_FILTER = 'MediaCloud\Vendor\Carbon\CarbonPeriod::filterRecurrences';
    const END_DATE_FILTER = 'MediaCloud\Vendor\Carbon\CarbonPeriod::filterEndDate';
     ...
     * @var string
     */
    const END_ITERATION = 'MediaCloud\Vendor\Carbon\CarbonPeriod::endIteration';
    ...
    {
        return is_string($callable) && substr($callable, 0, 2) === 'is' && (method_exists('MediaCloud\Vendor\Carbon\Carbon', $callable) || Carbon::hasMacro($callable));
    }
