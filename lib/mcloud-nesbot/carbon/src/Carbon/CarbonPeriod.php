...
use MediaCloud\Vendor\Carbon\Exceptions\InvalidPeriodDateException;
use MediaCloud\Vendor\Carbon\Exceptions\InvalidPeriodParameterException;
use MediaCloud\Vendor\Carbon\Exceptions\NotACarbonClassException;
use MediaCloud\Vendor\Carbon\Exceptions\NotAPeriodException;
use MediaCloud\Vendor\Carbon\Exceptions\UnknownGetterException;
use MediaCloud\Vendor\Carbon\Exceptions\UnknownMethodException;
use MediaCloud\Vendor\Carbon\Exceptions\UnreachableException;
...
class CarbonPeriod implements Iterator, Countable, JsonSerializable
{
     ...
     *
     * @param \MediaCloud\Vendor\Carbon\Carbon|\Carbon\CarbonPeriod|\Carbon\CarbonInterval|\DateInterval|\DatePeriod|\DateTimeInterface|string|null $date
     *
     * @return bool
     */
     ...
     *
     * @param \MediaCloud\Vendor\Carbon\CarbonPeriod|\DatePeriod|string $period
     *
     * @return bool
     */
     ...
     * @SuppressWarnings(PHPMD.UnusedFormalParameter)
     *
     * @param \MediaCloud\Vendor\Carbon\Carbon $current
     * @param int            $key
     *
     * @return bool|string
     */
     ...
     * @param \MediaCloud\Vendor\Carbon\Carbon|\Carbon\CarbonPeriod|\Carbon\CarbonInterval|\DateInterval|\DatePeriod|\DateTimeInterface|string|null $date
     *
     * @return \MediaCloud\Vendor\Carbon\CarbonInterface
     */
