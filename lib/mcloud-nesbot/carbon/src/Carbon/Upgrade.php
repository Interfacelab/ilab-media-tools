...
use MediaCloud\Vendor\UpdateHelper\UpdateHelper;
use MediaCloud\Vendor\UpdateHelper\UpdateHelperInterface;
...
class Upgrade implements UpdateHelperInterface
{
    ...
    /**
     * @param \MediaCloud\Vendor\UpdateHelper\UpdateHelper $helper
     */
