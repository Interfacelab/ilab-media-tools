...
use MediaCloud\Vendor\Carbon\Exceptions\InvalidDateException;
use Closure;
use DateInterval;
use DatePeriod;
use DateTime;
...
class Carbon extends DateTime implements JsonSerializable
{
     ...
     *
     * @var \MediaCloud\Vendor\Carbon\Carbon
     */
     ...
     * @param \DateTimeZone|string|null $tz
     *
     * @throws \MediaCloud\Vendor\Carbon\Exceptions\InvalidDateException|\InvalidArgumentException
     *
     * @return static
     */
     ...
     *
     * @param \MediaCloud\Vendor\Carbon\Carbon|\DateTimeInterface|string|null $date
     *
     * @return static
     */
     ...
     *
     * @param \MediaCloud\Vendor\Carbon\Carbon|\DateTimeInterface $date
     *
     * @return static
     */
     ...
     * parameter of null.
     *
     * @param \MediaCloud\Vendor\Carbon\Carbon|null        $testNow real or mock Carbon instance
     * @param \MediaCloud\Vendor\Carbon\Carbon|string|null $testNow
     */
     ...
     *
     * @param \MediaCloud\Vendor\Carbon\Carbon|\DateTimeInterface|mixed $date
     *
     * @return bool
     */
     ...
     *
     * @param \MediaCloud\Vendor\Carbon\Carbon|\DateTimeInterface|mixed $date1
     * @param \MediaCloud\Vendor\Carbon\Carbon|\DateTimeInterface|mixed $date2
     ...
     * @param \MediaCloud\Vendor\Carbon\Carbon|\DateTimeInterface|null $date   The instance to compare with or null to use current day.
     *
     * @throws \InvalidArgumentException
     *
     * @return bool
     ...
     *
     * @param \MediaCloud\Vendor\Carbon\Carbon|\DateTimeInterface|null $date       The instance to compare with or null to use the current date.
     * @param bool                                   $ofSameYear Check if it is the same month in the same year.
     *
     * @return bool
     */
