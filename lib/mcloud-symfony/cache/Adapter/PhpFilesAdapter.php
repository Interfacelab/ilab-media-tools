...
use MediaCloud\Vendor\Symfony\Component\Cache\Exception\CacheException;
...
use MediaCloud\Vendor\Symfony\Component\Cache\Traits\FilesystemCommonTrait;
    ...
    protected function doSave(array $values, int $lifetime)
    {
        ...
        foreach ($values as $key => $value) {
            ...
            if ($isStaticValue) {
                ...
                $value = str_replace('\MediaCloud\Vendor\Symfony\Component\VarExporter\Internal\\', '', $value);
                $value = "namespace MediaCloud\Vendor\Symfony\Component\VarExporter\Internal;\n\nreturn \$getExpiry ? {$expiry} : {$value};";
            }
