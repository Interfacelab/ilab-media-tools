...
namespace MediaCloud\Vendor\Symfony\Component\Debug\Tests\Exception;
...
class FlattenExceptionTest extends TestCase
{
    ...
    public function testPreviousError()
    {
        ...
        $this->assertEquals('MediaCloud\Vendor\Symfony\Component\Debug\Exception\FatalThrowableError', $flattened->getClass(), 'The class is set to the class of the original exception');
    }
