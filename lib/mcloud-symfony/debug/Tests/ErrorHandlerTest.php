...
use MediaCloud\Vendor\Psr\Log\NullLogger;
...
use MediaCloud\Vendor\Symfony\Component\Debug\Tests\Fixtures\ErrorHandlerThatUsesThePreviousOne;
use MediaCloud\Vendor\Symfony\Component\Debug\Tests\Fixtures\LoggerThatSetAnErrorHandler;
...
class ErrorHandlerTest extends TestCase
{
    public function testRegister()
    {
        ...
        try {
            $this->assertInstanceOf('MediaCloud\Vendor\Symfony\Component\Debug\ErrorHandler', $handler);
    ...
    {
        $logger = $this->getMockBuilder('MediaCloud\Vendor\Psr\Log\LoggerInterface')->getMock();
        $handler = ErrorHandler::register();
    ...
    public function testBootstrappingLogger()
    {
        ...
        $mockLogger = $this->getMockBuilder('MediaCloud\Vendor\Psr\Log\LoggerInterface')->getMock();
    ...
    public function testHandleErrorException()
    {
        ...
        $this->assertInstanceOf('MediaCloud\Vendor\Symfony\Component\Debug\Exception\ClassNotFoundException', $args[0]);
