...
@trigger_error(sprintf('The "%s" class is deprecated since Symfony 4.4, use "%s" instead.', ExceptionHandler::class, \MediaCloud\Vendor\Symfony\Component\ErrorHandler\ErrorHandler::class), \E_USER_DEPRECATED);
