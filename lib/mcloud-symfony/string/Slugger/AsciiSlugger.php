...
namespace MediaCloud\Vendor\Symfony\Component\String\Slugger;
use MediaCloud\Vendor\Symfony\Component\String\AbstractUnicodeString;
use MediaCloud\Vendor\Symfony\Component\String\UnicodeString;
use MediaCloud\Vendor\Symfony\Contracts\Translation\LocaleAwareInterface;

if (!interface_exists(LocaleAwareInterface::class)) {
    throw new \LogicException('You cannot use the "MediaCloud\Vendor\Symfony\Component\String\Slugger\AsciiSlugger" as the "symfony/translation-contracts" package is not installed. Try running "composer require symfony/translation-contracts".');
}
