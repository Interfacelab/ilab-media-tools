...
namespace MediaCloud\Vendor\Symfony\Component\HttpFoundation;
use MediaCloud\Vendor\Symfony\Component\HttpFoundation\Exception\ConflictingHeadersException;
use MediaCloud\Vendor\Symfony\Component\HttpFoundation\Exception\JsonException;
use MediaCloud\Vendor\Symfony\Component\HttpFoundation\Exception\SessionNotFoundException;
use MediaCloud\Vendor\Symfony\Component\HttpFoundation\Exception\SuspiciousOperationException;
    ...
    private static function createRequestFromFactory(array $query = [], array $request = [], array $attributes = [], array $cookies = [], array $files = [], array $server = [], $content = null): self
    {
        if (self::$requestFactory) {
            ...
            if (!$request instanceof self) {
                throw new \LogicException('The Request factory must return an instance of MediaCloud\Vendor\Symfony\Component\HttpFoundation\Request.');
            }
