...
use MediaCloud\Vendor\Symfony\Component\HttpFoundation\File\File;
use MediaCloud\Vendor\Symfony\Component\Mime\MimeTypeGuesserInterface;
...
class DataUriNormalizer implements NormalizerInterface, DenormalizerInterface, CacheableSupportsMethodInterface
{
    ...
    public function denormalize($data, string $type, string $format = null, array $context = [])
    {
        ...
        throw new InvalidArgumentException(sprintf('The class parameter "%s" is not supported. It must be one of "SplFileInfo", "SplFileObject" or "MediaCloud\Vendor\Symfony\Component\HttpFoundation\File\File".', $type));
    }
