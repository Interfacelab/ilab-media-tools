...
use MediaCloud\Vendor\Symfony\Component\Serializer\Exception\CircularReferenceException;
...
use MediaCloud\Vendor\Symfony\Component\Serializer\Exception\MissingConstructorArgumentsException;
use MediaCloud\Vendor\Symfony\Component\Serializer\Exception\NotNormalizableValueException;
use MediaCloud\Vendor\Symfony\Component\Serializer\Exception\RuntimeException;
...
use MediaCloud\Vendor\Symfony\Component\Serializer\SerializerAwareInterface;
use MediaCloud\Vendor\Symfony\Component\Serializer\SerializerAwareTrait;
...
abstract class AbstractNormalizer implements NormalizerInterface, DenormalizerInterface, SerializerAwareInterface, CacheableSupportsMethodInterface
{
    ...
    protected function getAllowedAttributes($classOrObject, array $context, bool $attributesAsString = false)
    {
        ...
        foreach ($this->classMetadataFactory->getMetadataFor($classOrObject)->getAttributesMetadata() as $attributeMetadata) {
            ...
            // If you update this check, update accordingly the one in \MediaCloud\Vendor\Symfony\Component\PropertyInfo\Extractor\SerializerExtractor::getProperties()
            if (
                !$ignore &&
