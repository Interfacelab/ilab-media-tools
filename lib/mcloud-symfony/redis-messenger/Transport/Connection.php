...
if (!class_exists(\MediaCloud\Vendor\Symfony\Component\Messenger\Transport\RedisExt\Connection::class, false)) {
    class_alias(Connection::class, \MediaCloud\Vendor\Symfony\Component\Messenger\Transport\RedisExt\Connection::class);
}
