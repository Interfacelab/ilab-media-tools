...
if (!class_exists(\MediaCloud\Vendor\Symfony\Component\Messenger\Transport\RedisExt\RedisReceiver::class, false)) {
    class_alias(RedisReceiver::class, \MediaCloud\Vendor\Symfony\Component\Messenger\Transport\RedisExt\RedisReceiver::class);
}
