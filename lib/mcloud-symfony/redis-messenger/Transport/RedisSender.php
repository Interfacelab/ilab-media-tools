...
if (!class_exists(\MediaCloud\Vendor\Symfony\Component\Messenger\Transport\RedisExt\RedisSender::class, false)) {
    class_alias(RedisSender::class, \MediaCloud\Vendor\Symfony\Component\Messenger\Transport\RedisExt\RedisSender::class);
}
