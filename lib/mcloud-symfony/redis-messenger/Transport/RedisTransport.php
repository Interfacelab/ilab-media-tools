...
if (!class_exists(\MediaCloud\Vendor\Symfony\Component\Messenger\Transport\RedisExt\RedisTransport::class, false)) {
    class_alias(RedisTransport::class, \MediaCloud\Vendor\Symfony\Component\Messenger\Transport\RedisExt\RedisTransport::class);
}
