...
namespace MediaCloud\Vendor\Symfony\Component\ExpressionLanguage\Node;
use MediaCloud\Vendor\Symfony\Component\ExpressionLanguage\Compiler;
...
class Node
{
    ...
    public function __toString()
    {
        ...
        $repr = [str_replace('MediaCloud\Vendor\Symfony\Component\ExpressionLanguage\Node\\', '', static::class).'('.implode(', ', $attributes)];
