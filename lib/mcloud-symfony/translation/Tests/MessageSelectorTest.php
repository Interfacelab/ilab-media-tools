...
use MediaCloud\Vendor\Symfony\Component\Translation\MessageSelector;
...
class MessageSelectorTest extends TestCase
{
    ...
    {
        $this->expectException('MediaCloud\Vendor\Symfony\Component\Translation\Exception\InvalidArgumentException');
        $selector = new MessageSelector();
