...
namespace MediaCloud\Vendor\Symfony\Component\HttpClient\Internal;

use Http\Client\Exception\NetworkException;
use Http\Promise\Promise;
use MediaCloud\Vendor\Psr\Http\Message\RequestInterface as Psr7RequestInterface;
...
final class HttplugWaitLoop
{
    ...
    public function wait(?ResponseInterface $pendingResponse, float $maxDuration = null, float $idleTimeout = null): int
    {
        ...
        $guzzleQueue = \MediaCloud\Vendor\GuzzleHttp\Promise\Utils::queue();
