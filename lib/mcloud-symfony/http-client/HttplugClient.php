...
use MediaCloud\Vendor\GuzzleHttp\Promise\Promise as GuzzlePromise;
use MediaCloud\Vendor\GuzzleHttp\Promise\RejectedPromise;
use MediaCloud\Vendor\GuzzleHttp\Promise\Utils;
...
use Nyholm\Psr7\Uri;
use MediaCloud\Vendor\Psr\Http\Message\RequestFactoryInterface;
use MediaCloud\Vendor\Psr\Http\Message\RequestInterface;
use MediaCloud\Vendor\Psr\Http\Message\ResponseFactoryInterface;
use MediaCloud\Vendor\Psr\Http\Message\ResponseInterface as Psr7ResponseInterface;
use MediaCloud\Vendor\Psr\Http\Message\StreamFactoryInterface;
use MediaCloud\Vendor\Psr\Http\Message\StreamInterface;
use MediaCloud\Vendor\Psr\Http\Message\UriFactoryInterface;
use MediaCloud\Vendor\Psr\Http\Message\UriInterface;
use MediaCloud\Vendor\Symfony\Component\HttpClient\Internal\HttplugWaitLoop;
use MediaCloud\Vendor\Symfony\Component\HttpClient\Response\HttplugPromise;
...
if (!interface_exists(HttplugInterface::class)) {
    throw new \LogicException('You cannot use "MediaCloud\Vendor\Symfony\Component\HttpClient\HttplugClient" as the "php-http/httplug" package is not installed. Try running "composer require php-http/httplug".');
}

if (!interface_exists(RequestFactory::class)) {
    throw new \LogicException('You cannot use "MediaCloud\Vendor\Symfony\Component\HttpClient\HttplugClient" as the "php-http/message-factory" package is not installed. Try running "composer require nyholm/psr7".');
}
    ...
    public function __construct(HttpClientInterface $client = null, ResponseFactoryInterface $responseFactory = null, StreamFactoryInterface $streamFactory = null)
    {
        ...
        if (null === $this->responseFactory || null === $this->streamFactory) {
            if (!class_exists(Psr17Factory::class) && !class_exists(Psr17FactoryDiscovery::class)) {
                throw new \LogicException('You cannot use the "MediaCloud\Vendor\Symfony\Component\HttpClient\HttplugClient" as no PSR-17 factories have been provided. Try running "composer require nyholm/psr7".');
            }
            ...
            try {
                ...
                throw new \LogicException('You cannot use the "MediaCloud\Vendor\Symfony\Component\HttpClient\HttplugClient" as no PSR-17 factories have been found. Try running "composer require nyholm/psr7".', 0, $e);
            }
        }
