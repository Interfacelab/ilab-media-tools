...
use MediaCloud\Vendor\Symfony\Component\HttpClient\Response\AmpResponse;
...
if (!interface_exists(DelegateHttpClient::class)) {
    throw new \LogicException('You cannot use "MediaCloud\Vendor\Symfony\Component\HttpClient\AmpHttpClient" as the "amphp/http-client" package is not installed. Try running "composer require amphp/http-client".');
}
