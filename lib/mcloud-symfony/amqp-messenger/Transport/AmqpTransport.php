...
use MediaCloud\Vendor\Symfony\Component\Messenger\Transport\SetupableTransportInterface;
...
if (!class_exists(\MediaCloud\Vendor\Symfony\Component\Messenger\Transport\AmqpExt\AmqpTransport::class, false)) {
    class_alias(AmqpTransport::class, \MediaCloud\Vendor\Symfony\Component\Messenger\Transport\AmqpExt\AmqpTransport::class);
}
