...
if (!class_exists(\MediaCloud\Vendor\Symfony\Component\Messenger\Transport\AmqpExt\AmqpReceiver::class, false)) {
    class_alias(AmqpReceiver::class, \MediaCloud\Vendor\Symfony\Component\Messenger\Transport\AmqpExt\AmqpReceiver::class);
}
