...
if (!class_exists(\MediaCloud\Vendor\Symfony\Component\Messenger\Transport\AmqpExt\AmqpFactory::class, false)) {
    class_alias(AmqpFactory::class, \MediaCloud\Vendor\Symfony\Component\Messenger\Transport\AmqpExt\AmqpFactory::class);
}
