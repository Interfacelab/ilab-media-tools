...
if (!class_exists(\MediaCloud\Vendor\Symfony\Component\Messenger\Transport\AmqpExt\AmqpReceivedStamp::class, false)) {
    class_alias(AmqpReceivedStamp::class, \MediaCloud\Vendor\Symfony\Component\Messenger\Transport\AmqpExt\AmqpReceivedStamp::class);
}
