...
if (!class_exists(\MediaCloud\Vendor\Symfony\Component\Messenger\Transport\AmqpExt\AmqpStamp::class, false)) {
    class_alias(AmqpStamp::class, \MediaCloud\Vendor\Symfony\Component\Messenger\Transport\AmqpExt\AmqpStamp::class);
}
