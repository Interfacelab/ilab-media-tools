...
namespace MediaCloud\Vendor\Symfony\Component\Config\Definition\Dumper;
                ...
                if ($prototype instanceof PrototypedArrayNode) {
                    ...
                    if ($prototype->hasDefaultValue()) {
                        ...
                        switch (\get_class($prototype)) {
                            case 'MediaCloud\Vendor\Symfony\Component\Config\Definition\ScalarNode':
                                $prototypeValue = 'scalar value';
                                break;

                            case 'MediaCloud\Vendor\Symfony\Component\Config\Definition\FloatNode':
                            case 'MediaCloud\Vendor\Symfony\Component\Config\Definition\IntegerNode':
                                $prototypeValue = 'numeric value';
                                break;

                            case 'MediaCloud\Vendor\Symfony\Component\Config\Definition\BooleanNode':
                                $prototypeValue = 'true|false';
                                break;

                            case 'MediaCloud\Vendor\Symfony\Component\Config\Definition\EnumNode':
