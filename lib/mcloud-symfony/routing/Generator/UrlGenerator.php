...
namespace MediaCloud\Vendor\Symfony\Component\Routing\Generator;
use MediaCloud\Vendor\Psr\Log\LoggerInterface;
use MediaCloud\Vendor\Symfony\Component\Routing\Exception\InvalidParameterException;
use MediaCloud\Vendor\Symfony\Component\Routing\Exception\MissingMandatoryParametersException;
...
class UrlGenerator implements UrlGeneratorInterface, ConfigurableRequirementsInterface
{
    ...
    protected function doGenerate(array $variables, array $defaults, array $requirements, array $tokens, array $parameters, string $name, int $referenceType, array $hostTokens, array $requiredSchemes = [])
    {
        ...
        // the contexts base URL is already encoded (see MediaCloud\Vendor\Symfony\Component\HttpFoundation\Request)
