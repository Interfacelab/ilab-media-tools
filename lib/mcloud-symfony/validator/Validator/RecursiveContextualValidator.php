...
namespace MediaCloud\Vendor\Symfony\Component\Validator\Validator;
use MediaCloud\Vendor\Symfony\Component\Validator\Constraint;
use MediaCloud\Vendor\Symfony\Component\Validator\Constraints\Composite;
use MediaCloud\Vendor\Symfony\Component\Validator\Constraints\Existence;
use MediaCloud\Vendor\Symfony\Component\Validator\Constraints\GroupSequence;
use MediaCloud\Vendor\Symfony\Component\Validator\Constraints\Valid;
use MediaCloud\Vendor\Symfony\Component\Validator\ConstraintValidatorFactoryInterface;
use MediaCloud\Vendor\Symfony\Component\Validator\Context\ExecutionContext;
use MediaCloud\Vendor\Symfony\Component\Validator\Context\ExecutionContextInterface;
use MediaCloud\Vendor\Symfony\Component\Validator\Exception\ConstraintDefinitionException;
use MediaCloud\Vendor\Symfony\Component\Validator\Exception\NoSuchMetadataException;
use MediaCloud\Vendor\Symfony\Component\Validator\Exception\RuntimeException;
use MediaCloud\Vendor\Symfony\Component\Validator\Exception\UnexpectedValueException;
use MediaCloud\Vendor\Symfony\Component\Validator\Exception\UnsupportedMetadataException;
use MediaCloud\Vendor\Symfony\Component\Validator\Exception\ValidatorException;
use MediaCloud\Vendor\Symfony\Component\Validator\Mapping\CascadingStrategy;
use MediaCloud\Vendor\Symfony\Component\Validator\Mapping\ClassMetadataInterface;
use MediaCloud\Vendor\Symfony\Component\Validator\Mapping\Factory\MetadataFactoryInterface;
use MediaCloud\Vendor\Symfony\Component\Validator\Mapping\GenericMetadata;
use MediaCloud\Vendor\Symfony\Component\Validator\Mapping\GetterMetadata;
use MediaCloud\Vendor\Symfony\Component\Validator\Mapping\MetadataInterface;
use MediaCloud\Vendor\Symfony\Component\Validator\Mapping\PropertyMetadataInterface;
use MediaCloud\Vendor\Symfony\Component\Validator\Mapping\TraversalStrategy;
use MediaCloud\Vendor\Symfony\Component\Validator\ObjectInitializerInterface;
use MediaCloud\Vendor\Symfony\Component\Validator\Util\PropertyPath;
...
class RecursiveContextualValidator implements ContextualValidatorInterface
{
    ...
    private function validateObject(object $object, string $propertyPath, array $groups, int $traversalStrategy, ExecutionContextInterface $context)
    {
        try {
            ...
            if (!$classMetadata instanceof ClassMetadataInterface) {
                throw new UnsupportedMetadataException(sprintf('The metadata factory should return instances of "MediaCloud\Vendor\Symfony\Component\Validator\Mapping\ClassMetadataInterface", got: "%s".', get_debug_type($classMetadata)));
            }
        ...
        foreach ($groups as $key => $group) {
            ...
            if (Constraint::DEFAULT_GROUP === $group) {
                if ($metadata->hasGroupSequence()) {
                    ...
                    // object
                    /* @var \MediaCloud\Vendor\Symfony\Component\Validator\GroupSequenceProviderInterface $object */
        ...
        foreach ($metadata->getConstrainedProperties() as $propertyName) {
            ...
            foreach ($metadata->getPropertyMetadata($propertyName) as $propertyMetadata) {
                if (!$propertyMetadata instanceof PropertyMetadataInterface) {
                    throw new UnsupportedMetadataException(sprintf('The property metadata instances should implement "MediaCloud\Vendor\Symfony\Component\Validator\Mapping\PropertyMetadataInterface", got: "%s".', get_debug_type($propertyMetadata)));
                }
