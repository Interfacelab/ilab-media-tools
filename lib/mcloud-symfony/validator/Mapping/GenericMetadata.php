...
namespace MediaCloud\Vendor\Symfony\Component\Validator\Mapping;
use MediaCloud\Vendor\Symfony\Component\Validator\Constraint;
use MediaCloud\Vendor\Symfony\Component\Validator\Constraints\Cascade;
use MediaCloud\Vendor\Symfony\Component\Validator\Constraints\DisableAutoMapping;
use MediaCloud\Vendor\Symfony\Component\Validator\Constraints\EnableAutoMapping;
use MediaCloud\Vendor\Symfony\Component\Validator\Constraints\Traverse;
...
class GenericMetadata implements MetadataInterface
{
    ...
    public function addConstraint(Constraint $constraint)
    {
        if ($constraint instanceof Traverse || $constraint instanceof Cascade) {
            throw new ConstraintDefinitionException(sprintf('The constraint "%s" can only be put on classes. Please use "MediaCloud\Vendor\Symfony\Component\Validator\Constraints\Valid" instead.', get_debug_type($constraint)));
        }
