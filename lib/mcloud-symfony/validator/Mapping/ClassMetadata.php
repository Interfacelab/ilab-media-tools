...
use MediaCloud\Vendor\Symfony\Component\Validator\Exception\GroupDefinitionException;
...
class ClassMetadata extends GenericMetadata implements ClassMetadataInterface
{
    ...
    public function setGroupSequenceProvider(bool $active)
    {
        ...
        if (!$this->getReflectionClass()->implementsInterface('MediaCloud\Vendor\Symfony\Component\Validator\GroupSequenceProviderInterface')) {
