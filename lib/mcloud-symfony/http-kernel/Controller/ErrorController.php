...
use MediaCloud\Vendor\Symfony\Component\ErrorHandler\ErrorRenderer\ErrorRendererInterface;
...
class ErrorController
{
    ...
    public function preview(Request $request, int $code): Response
    {
         ...
         * \MediaCloud\Vendor\Symfony\Component\HttpKernel\EventListener\ErrorListener::duplicateRequest, with
