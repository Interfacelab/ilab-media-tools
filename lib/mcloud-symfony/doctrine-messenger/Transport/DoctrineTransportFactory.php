...
use MediaCloud\Vendor\Symfony\Bridge\Doctrine\RegistryInterface;
...
if (!class_exists(\MediaCloud\Vendor\Symfony\Component\Messenger\Transport\Doctrine\DoctrineTransportFactory::class, false)) {
    class_alias(DoctrineTransportFactory::class, \MediaCloud\Vendor\Symfony\Component\Messenger\Transport\Doctrine\DoctrineTransportFactory::class);
}
