...
if (!class_exists(\MediaCloud\Vendor\Symfony\Component\Messenger\Transport\Doctrine\DoctrineTransport::class, false)) {
    class_alias(DoctrineTransport::class, \MediaCloud\Vendor\Symfony\Component\Messenger\Transport\Doctrine\DoctrineTransport::class);
}
