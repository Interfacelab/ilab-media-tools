...
namespace MediaCloud\Vendor\Symfony\Component\Finder\Tests;
...
class FinderTest extends Iterator\RealIteratorTestCase
{
    ...
    {
        $this->assertInstanceOf('MediaCloud\Vendor\Symfony\Component\Finder\Finder', Finder::create());
    }
    ...
    {
        $this->assertInstanceOf('MediaCloud\\Vendor\\Symfony\Component\Finder\\Finder', Finder::create()->append([]));
    }
    ...
    public function testAccessDeniedException()
    {
        ...
        if (false === $couldRead = is_readable($testDir)) {
            try {
                ...
                $expectedExceptionClass = 'MediaCloud\\Vendor\\Symfony\Component\Finder\\Exception\\AccessDeniedException';
