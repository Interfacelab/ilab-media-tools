...
use MediaCloud\Vendor\Illuminate\Support\Testing\Fakes\QueueFake;

/**
 * @method static \MediaCloud\Vendor\Illuminate\Contracts\Queue\Job|null pop(string $queue = null)
 * @method static \MediaCloud\Vendor\Illuminate\Contracts\Queue\Queue setConnectionName(string $name)
...
class Queue extends Facade
{
     ...
     *
     * @return \MediaCloud\Vendor\Illuminate\Support\Testing\Fakes\QueueFake
     */
