...
use MediaCloud\Vendor\Illuminate\Contracts\Foundation\Application;
use MediaCloud\Vendor\Illuminate\Contracts\View\Factory;
use MediaCloud\Vendor\Illuminate\Filesystem\Filesystem;
use MediaCloud\Vendor\Illuminate\Support\Str;
use MediaCloud\Vendor\Illuminate\View\AnonymousComponent;
use MediaCloud\Vendor\Illuminate\View\ViewFinderInterface;
...
class ComponentTagCompiler
{
     ...
     *
     * @var \MediaCloud\Vendor\Illuminate\View\Compilers\BladeCompiler
     */
    protected $blade;
     ...
     *
     * @param  array  $aliases
     * @param \MediaCloud\Vendor\Illuminate\View\Compilers\BladeCompiler|null
     * @return void
     */
        ...
        return collect($attributes)
                ->map(function (string $value, string $attribute) use ($escapeBound) {
                    return $escapeBound && isset($this->boundAttributes[$attribute]) && $value !== 'true' && ! is_numeric($value)
                                ? "'{$attribute}' => \MediaCloud\Vendor\Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute({$value})"
                                : "'{$attribute}' => {$value}";
                })
                ->implode(',');
    }
