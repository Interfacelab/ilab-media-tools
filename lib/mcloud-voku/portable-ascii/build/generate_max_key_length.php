...
$languages = \MediaCloud\Vendor\voku\helper\ASCII::getAllLanguages();

$languagesKeyLengths = [];
foreach ($languages as $language) {
    $langSpecific = \MediaCloud\Vendor\voku\helper\ASCII::charsArrayWithOneLanguage($language, false, false);
