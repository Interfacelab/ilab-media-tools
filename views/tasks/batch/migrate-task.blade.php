...
@include('tasks.batch-info', [
    ...
    'commandLine' => 'wp mediacloud migrate [--limit=<number>] [--offset=<number>] [--page=<number>] [--path-handling=preserve|replace|prepend] [--skip-thumbnails] [--skip-imported] [--order-by=date|title|filename] [--order=asc|desc] [--delete-migrated]',
