<div class="ilab-imgix-parameter">
    <div class="ilab-imgix-param-title">
        ...
        <div class="ilab-imgix-param-title-right">
            <input class="imgix-param imgix-param-color" data-param-type="{{$paramInfo['type']}}" type="text" name="{{$param}}" id="imgix-param-{{$param}}" value="{{imgixCurrentColorValue($param,$current,'#FF0000')}}">
        </div>
    </div>
    <input class="imgix-param-alpha" id="imgix-param-alpha-{{$param}}" type="range" min="0" max="100" value="{{imgixCurrentAlphaValue($param,$current,0)}}" />
