	...
	"storageDrivers" => [
		's3' => [
			...
			'help' => [
				...
				[ 'title' => 'Read Documentation', 'url' => 'https://docs.mediacloud.press/articles/documentation/cloud-storage/setting-up-amazon-s3' ],
			]
		],
		'google' => [
			...
			'help' => [
				...
				[ 'title' => 'Read Documentation', 'url' => 'https://docs.mediacloud.press/articles/documentation/cloud-storage/setting-up-google-cloud-storage' ],
			]
		],
		'cloudflare' => [
	...
	"settings" => [
		...
		"groups" => [
			...
			"ilab-media-cloud-signed-urls" => [
				...
				"doc_link" => 'https://docs.mediacloud.press/articles/documentation/cloud-storage/pre-signed-url-settings',
				"dynamic" => true,
				"options" => [],
			],
            "ilab-media-cloud-cdn-settings" => [
                "title" => "CDN Settings",
	            "dynamic" => true,
	            "doc_link" => 'https://docs.mediacloud.press/articles/documentation/cloud-storage/cdn-settings',
			...
			"ilab-media-cloud-display-settings" => [
				...
				"doc_link" => 'https://docs.mediacloud.press/articles/documentation/cloud-storage/media-library-integration',
				"description" => "",
				"options" => [
